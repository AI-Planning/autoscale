(define (problem depot-73-3-3-110-81-21) (:domain depots)
(:objects
...
(:init
	...
	(at pallet99 depot18)
	(clear pallet99)
	(at pallet100 depot18)
	(clear pallet100)
	(at pallet101 depot12)
	(clear crate1)
	(at pallet102 depot8)
	(clear pallet102)
	(at pallet103 depot41)
	(clear pallet103)
	(at pallet104 depot1)
	(clear pallet104)
	(at pallet105 depot5)
	...
	(at pallet106 depot8)
	(clear pallet106)
	(at pallet107 depot15)
	(clear pallet107)
	(at pallet108 depot15)
	(clear pallet108)
	(at pallet109 distributor0)
	(clear pallet109)
	(at truck0 depot25)
	(at truck1 depot37)
	(at truck2 depot41)
