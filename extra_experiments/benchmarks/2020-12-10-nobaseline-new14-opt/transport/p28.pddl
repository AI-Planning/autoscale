; Transport city-sequential-2nodes-1000size-3degree-100mindistance-4trucks-19packages-2046seed

(define (problem transport-city-sequential-2nodes-1000size-3degree-100mindistance-4trucks-19packages-2046seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
