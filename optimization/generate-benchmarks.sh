...
for domain in barman blocksworld childsnack depots driverlog elevators floortile gripper hiking miconic-strips nomystery parking pathways rover satellite scanalyzer snake storage tpp transport trucks visitall woodworking zenotravel
do   
