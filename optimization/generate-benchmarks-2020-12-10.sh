...
do
    ...
    (time python3 benchmark-optimization.py  --generators-dir /home/alvaro/projects/benchmarks/code/pddl-generators/ --database $JSON_OPT_14 --output $OUTPUT_FOLDER_PREFIX-new14-opt opt 2014 $domain) &> $LOGS_FOLDER_PREFIX/log_opt14_$domain ;

    (time python3 benchmark-optimization.py    --generators-dir /home/alvaro/projects/benchmarks/code/pddl-generators/ --database $JSON_SAT_14 --output $OUTPUT_FOLDER_PREFIX-new14-sat  sat 2014 $domain) &> $LOGS_FOLDER_PREFIX/log_sat14_$domain  ;
