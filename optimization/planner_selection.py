...
PLANNER_SELECTION_OPT_2020 = {
    ...
    "gripper": ["ipc2018-opt-delfi-fd1906-blind.img", "ipc2018-opt-delfi-mas-sccdfp-60s.img"],
    ...
    "maintenance": ["ipc2018-opt-delfi-fd1906-blind.img"],
...
PLANNER_SELECTION_SAT_2020 = {
    "barman": ["ipc2018-agl-lapkt-bfws-pref.img"],
    "blocksworld": ["fd1906-lama-first.img", "ipc2018-agl-lapkt-bfws-pref.img"],
    "childsnack": ["ipc2018-agl-saarplan-dec-fallback.img"],
    "data-network": ["ipc2018-agl-saarplan-grey.img", "fd1906-lama-first.img",],
    "depots": ["ipc2014-agl-mpc.img"],
    "driverlog": ["ipc2018-agl-lapkt-bfws-pref.img", "fd1906-lama-first.img"],
    "elevators": ["ipc2018-agl-lapkt-dual-bfws.img", "ipc2014-agl-mpc.img"],
    "floortile": ["ipc2014-agl-mpc.img"],
    "gripper": ["ipc2014-agl-mpc.img", "fd1906-lama-first.img"],
    "hiking": ["fd1906-lama-first.img"],
    "maintenance": ["ipc2018-agl-lapkt-dual-bfws.img", "ipc2014-agl-mpc.img"],
    "miconic-strips": ["ipc2014-agl-mpc.img", "fd1906-lama-first.img"],
    "nomystery" : ["ipc2018-agl-saarplan-dec.img"],
