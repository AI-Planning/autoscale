...
PLANNER_SELECTION_OPT_2020 = {
    ...
    "childsnack": ["delfi-ipdb-60s.img"],
    "data-network": ["lmcut.img", "scorpion-nodiv.img", "symba1.img"],
    "depots": ["delfi-ipdb-60s.img", "scorpion-nodiv.img"],
    "driverlog": ["decstar-opt-star.img", "delfi-ipdb-60s.img", "symba1.img"],
    "elevators" : ["delfi-ipdb-60s.img", "scorpion-nodiv.img"],
    "floortile": ["delfi-celmcut.img", "symba1.img"],
    "grid": ["bjolp.img", "fdss-mas2.img", "delfi-ipdb-60s.img"],
    "gripper": ["delfi-blind.img", "delfi-mas-sccdfp-60s.img"],
    "hiking": ["delfi-ipdb-60s.img", "delfi-mas-miasm.img"],
    "logistics": ["bjolp.img", "decstar-opt-fork.img", "scorpion-nodiv.img"],
    "maintenance": ["delfi-blind.img"],
    "miconic-strips": ["bjolp.img", "delfi-celmcut.img", "scorpion-nodiv.img"],
    "nomystery" : ["complementary2-3584mb-180s.img", "decstar-opt-fork.img", "scorpion-nodiv.img"],
    "openstacks" : ["symba1.img"],
    "parking": ["delfi-ipdb-60s.img", "scorpion-nodiv.img"],
    "pathways": ["complementary2-3584mb-180s.img", "delfi-celmcut.img"],
    "rover": ["complementary2-3584mb-180s.img", "symba1.img"],
    "satellite": ["delfi-celmcut.img", "decstar-opt-star.img"],
    "scanalyzer": ["delfi-celmcut.img", "scorpion-nodiv.img"],
    "snake": ["bjolp.img", "complementary2-3584mb-180s.img", "scorpion-nodiv.img"],
    "sokoban": ["delfi-ipdb-60s.img"],
    "storage": ["delfi-celmcut.img", "delfi-ipdb-60s.img"],
    "termes": ["symba1.img"],
    "tetris": ["scorpion-nodiv.img"],
    "tpp": ["complementary2-3584mb-180s.img", "decstar-opt-star.img"],
    "transport" : ["delfi-ipdb-60s.img", "delfi-mas-miasm.img", "scorpion-nodiv.img"],
    "trucks": ["scorpion-nodiv.img", "symba1.img"],
    "visitall": ["delfi-ipdb-60s.img", "symba1.img", "scorpion-nodiv.img"],
    "woodworking": ["scorpion-nodiv.img", "delfi-celmcut.img", "delfi-mas-sccdfp-60s.img"],
    "zenotravel": ["decstar-opt-fork.img", "delfi-celmcut.img", "scorpion-nodiv.img"],
}
...
PLANNER_SELECTION_SAT_2014 = {
    ...
    "openstacks": ["lama-first.img", "mpc.img"],
...
PLANNER_SELECTION_SAT_2020 = {
    ...
    "openstacks": ["lama-first.img", "lapkt-dual-bfws.img"],
    ...
    "sokoban": ["saarplan-dec-fallback.img"],
