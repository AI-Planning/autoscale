...
def main(revisions=[]):
    ...
    exp.add_fetcher('data/2018-01-16-strips-h2-newsemantics-oss-configs-eval',merge=True)
    exp.add_fetcher('data/2018-01-16-strips-h2-oldsemantics-oss-configs-eval',merge=True)
