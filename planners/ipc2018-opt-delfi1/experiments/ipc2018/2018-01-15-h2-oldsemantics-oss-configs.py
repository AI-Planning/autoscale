...
def main(revisions=None):
    ...
    strips_suite = ['airport', 'barman-opt11-strips', 'barman-opt14-strips', 'blocks',
    ...
    conditional_effects = ['cavediving-14-adl', 'citycar-opt14-adl',
    'maintenance-opt14-adl', 'miconic-simpleadl', 'openstacks-opt08-adl',
    'pathways', 'schedule', 'trucks']

    if is_test_run():
        suite = ['gripper:prob01.pddl','gripper:prob02.pddl']
        environment = LocalEnvironment(processes=4)
    else:
        suite = list(strips_suite)
        suite.extend(conditional_effects)
