...
if REMOTE:
    ENV = BaselSlurmEnvironment(export=["PATH", "DOWNWARD_BENCHMARKS"])
else:
    ENV = LocalEnvironment(processes=4)

# ./suites.py optimal_strips (all IPCs up to 2014)
SUITE = [
...
IPC_CONFIGS = ['seq-opt-symba-1', 'seq-opt-symba-2', 'seq-opt-spmas']
...
planner = os.path.join(os.path.abspath(REPO_DIR), 'src', 'plan')
