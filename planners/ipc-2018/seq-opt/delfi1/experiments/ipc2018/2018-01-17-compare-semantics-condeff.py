...
def main(revisions=[]):
    ...
    exp.add_fetcher('data/2018-01-17-condeffects-h2-newsemantics-oss-configs-eval',merge=True)
    exp.add_fetcher('data/2018-01-17-condeffects-h2-oldsemantics-oss-configs-eval',merge=True)
    ...
    exp.add_report(
        ComparativeReport(
            algorithm_pairs=[
                ...
                ('{}-h2-simpless-oldsemantics-oss-masb50kmiasmdfp'.format(REVISION), '{}-h2-simpless-newsemantics-oss-masb50kmiasmdfp'.format(REVISION)),
