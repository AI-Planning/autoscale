...
PDBStateSpaceSample::PDBStateSpaceSample(StateRegistry &state_registry, int goal_depth, int probes = 10, int size = 100)
    : ProbeStateSpaceSample(state_registry, goal_depth, probes, size) {
