...
private:
    ...
    void add_conflicting_and_disabling(OperatorID op_no, const State &state);
    void compute_active_operators(const State &state);
    void mark_as_stubborn_and_remember_written_vars(OperatorID op_no, const State &state);
