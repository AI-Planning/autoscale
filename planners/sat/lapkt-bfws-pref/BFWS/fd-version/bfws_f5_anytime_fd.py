...
def main( domain_file, problem_file, output ) :
	...
	#	print >> sys.stderr, "An error occurred while translating google-perftools profiling information into valgrind format"
        ...
        fd_cmd =  "../../Fast-Downward-2018-2/fast-downward.py --build release32 --alias lazy-rwastar --plan-file {} --external-bound {} {} {}".format(output, int(task.plan_cost),domain_file, problem_file)
        os.system(fd_cmd)
