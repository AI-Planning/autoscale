...
GeneralTwoLevelMacroRwLazyBestFirstSearch::GeneralTwoLevelMacroRwLazyBestFirstSearch(
...
int GeneralTwoLevelMacroRwLazyBestFirstSearch::step()
{
...
int GeneralTwoLevelMacroRwLazyBestFirstSearch::local_search(unsigned int size, bool &improved)
{
...
int GeneralTwoLevelMacroRwLazyBestFirstSearch::add_path_step()
{
        // Invariants:
...
int GeneralTwoLevelMacroRwLazyBestFirstSearch::expand_the_path(vector<const Operator*> path)
{
/**
...
int GeneralTwoLevelMacroRwLazyBestFirstSearch::local_step()
{
    // Invariants:
    // - current_state is the next state for which we want to compute the heuristic.
    // - current_predecessor is a permanent pointer to the predecessor of that state.
...
void GeneralTwoLevelMacroRwLazyBestFirstSearch::set_mrw_heuristic(vector<Heuristic *> &heur)
{
    mrw_heuristics = heur;
}

SearchEngine *GeneralTwoLevelMacroRwLazyBestFirstSearch::create_greedy(
    ...
    GeneralTwoLevelMacroRwLazyBestFirstSearch *engine = 0;
    if (!dry_run) {
        OpenList<OpenListEntryLazy> *open;
        OpenList<OpenListEntryLazy> *local_open;
        ...
        engine = new GeneralTwoLevelMacroRwLazyBestFirstSearch(
...
SearchEngine *GeneralTwoLevelMacroRwLazyBestFirstSearch::create_type_greedy(
    const vector<string> &config, int start, int &end, bool dry_run) {
    if (config[start + 1] != "(")
        throw ParseError(start + 1);
...
void GeneralTwoLevelMacroRwLazyBestFirstSearch::set_mrw_walk_mode(int mode)
{
    m_mrwParam.walk_type = mode;
}

void GeneralTwoLevelMacroRwLazyBestFirstSearch::set_mrw_walk_len(int walk_len)
{
