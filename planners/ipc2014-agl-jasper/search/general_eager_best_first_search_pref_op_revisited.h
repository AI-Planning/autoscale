#ifndef GENERAL_EAGER_BEST_FIRST_SEARCH_PREF_OP_REVISTED_H
#define GENERAL_EAGER_BEST_FIRST_SEARCH_PREF_OP_REVISTED_H
...
class GeneralEagerBestFirstSearchPrefOpRevisited : public SearchEngine {
protected:
...
public:
    GeneralEagerBestFirstSearchPrefOpRevisited(
