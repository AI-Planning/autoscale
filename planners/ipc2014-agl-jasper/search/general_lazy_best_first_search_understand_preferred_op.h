#ifndef GENERAL_LAZY_BEST_FIRST_SEARCH_UNDERSTAND_PREFERRED_OP_H
#define GENERAL_LAZY_BEST_FIRST_SEARCH_UNDERSTAND_PREFERRED_OP_H
...
class GeneralLazyBestFirstSearchUnderstandPreferredOp : public SearchEngine {
protected:
...
public:
    ...
    GeneralLazyBestFirstSearchUnderstandPreferredOp(const SearchEngineOptions &options,
                               OpenList<OpenListEntryLazy> *open,
                               bool reopen_closed);
    virtual ~GeneralLazyBestFirstSearchUnderstandPreferredOp();
