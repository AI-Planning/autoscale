...
GeneralTwoLevelMacroLazyBestFirstSearchForVisitall::GeneralTwoLevelMacroLazyBestFirstSearchForVisitall(
...
int GeneralTwoLevelMacroLazyBestFirstSearchForVisitall::step()
{
...
int GeneralTwoLevelMacroLazyBestFirstSearchForVisitall::local_search()
{
...
void GeneralTwoLevelMacroLazyBestFirstSearchForVisitall::initialize_local_setting()
{
...
bool GeneralTwoLevelMacroLazyBestFirstSearchForVisitall::check_improvement()
{
    bool improved = false;
...
int GeneralTwoLevelMacroLazyBestFirstSearchForVisitall::fetch_local_next_state()
{
...
void GeneralTwoLevelMacroLazyBestFirstSearchForVisitall::generate_local_successors()
{
...
int GeneralTwoLevelMacroLazyBestFirstSearchForVisitall::local_step()
{
    // Invariants:
...
SearchEngine *GeneralTwoLevelMacroLazyBestFirstSearchForVisitall::create_greedy(
    ...
    if (!dry_run) {
        ...
        engine = new GeneralTwoLevelMacroLazyBestFirstSearchForVisitall(
...
SearchEngine *GeneralTwoLevelMacroLazyBestFirstSearchForVisitall::create_weighted_astar(
    const vector<string> &config, int start, int &end, bool dry_run) {
    if (config[start + 1] != "(")
        throw ParseError(start + 1);
...
const int GeneralTwoLevelMacroLazyBestFirstSearchForVisitall::MAX_STEP = 7;
const int GeneralTwoLevelMacroLazyBestFirstSearchForVisitall::STEP_SIZE = 100;
const bool GeneralTwoLevelMacroLazyBestFirstSearchForVisitall::WAIT_LOCAL_SEARCH = true;
