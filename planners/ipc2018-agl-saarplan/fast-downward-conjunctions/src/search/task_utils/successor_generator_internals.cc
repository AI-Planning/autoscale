...
GeneratorLeafVector::GeneratorLeafVector(vector<const GlobalOperator *> &&applicable_operators)
    : applicable_operators(move(applicable_operators)) {
}

void GeneratorLeafVector::generate_applicable_ops(
    const State &, vector<const GlobalOperator *> &applicable_ops) const {
    /*
...
GeneratorLeafSingle::GeneratorLeafSingle(const GlobalOperator * applicable_operator)
