DOMAIN_GROUPS = {
    ...
    "freecell": ["freecell", "freecell-exhaustive"],
    ...
    "storage": ["storage"],
    "tetris": ["tetris-opt14-strips", "tetris-sat14-strips", "tetris-hard", "tetris-exhaustive"],
    "thoughtful": ["thoughtful-sat14-strips"],
    "tidybot": ["tidybot-opt11-strips", "tidybot-opt14-strips", "tidybot-sat11-strips", "tidybot-sat14-strips", "tidybot-exhaustive"],
    "tpp": ["tpp"],
    ...
    # IPC 2018:
    "agricola": ["agricola", "agricola-hard", "agricola-opt18-strips", "agricola-sat18-strips"],
