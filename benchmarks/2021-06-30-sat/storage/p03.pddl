...
(:init
	...
	(available hoist10)
	(at hoist11 depot50-1-4)
	(available hoist11)
	(at hoist12 depot50-1-1)
	(available hoist12)
	(at hoist13 depot50-2-4)
	(available hoist13)
	(at hoist14 depot50-2-2)
	(available hoist14)
	(at hoist15 depot50-1-3)
	(available hoist15)
	(at hoist16 depot50-2-1)
	(available hoist16)
	(at hoist17 depot50-2-3)
	(available hoist17)
	(at hoist18 depot51-2-1)
	(available hoist18)
	(at hoist19 depot51-2-4)
	(available hoist19)
	(at hoist20 depot51-1-1)
	(available hoist20)
	(at hoist21 depot51-1-4)
	(available hoist21))
