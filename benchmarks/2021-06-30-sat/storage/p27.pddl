...
; 00*  111* 2*2  3*3  44*4 55*  66*  7*77 *888 99 * AA * BBB* C*C  DDD* E*EE FF*  *GG  HHHH                                                                  
;                                                                                      *HH                                                                   
;------------------------------------------------------------------------------------------                                                                  
; 48: depot48 area
; 49: depot49 area
...
(:init
	...
	(connected transit1 depot55-1-4)
	(connected transit1 depot56-1-1)
	(connected transit2 depot65-1-4)
	(connected transit2 depot66-1-1)
	(connected transit3 depot69-1-4)
	(connected transit3 depot70-1-1)
	(connected transit4 depot70-1-4)
	...
	(connected depot72-3-1 loadarea)
	(connected loadarea depot72-3-1)  
	(clear depot48-2-2)
	(clear depot48-1-2)
	(clear depot48-1-3)
	(clear depot49-2-4)
	...
	(available hoist13)
	(at hoist14 depot54-1-3)
	(available hoist14)
	(at hoist15 depot55-1-3)
	(available hoist15)
	(at hoist16 depot55-2-2)
	(available hoist16)
	(at hoist17 depot55-1-2)
	(available hoist17)
	(at hoist18 depot56-1-3)
	(available hoist18)
	(at hoist19 depot56-2-4)
	(available hoist19)
	(at hoist20 depot56-2-1)
	(available hoist20)
	(at hoist21 depot57-1-1)
	(available hoist21)
	(at hoist22 depot57-1-2)
	(available hoist22)
	...
	(available hoist27)
	(at hoist28 depot65-1-1)
	(available hoist28)
	(at hoist29 depot65-1-2)
	(available hoist29)
	(at hoist30 depot66-1-3)
	(available hoist30)
	(at hoist31 depot66-2-3)
	(available hoist31)
	(at hoist32 depot66-2-2)
	(available hoist32)
	(at hoist33 depot66-2-4)
	(available hoist33)
	(at hoist34 depot67-1-3)
	(available hoist34)
	(at hoist35 depot67-2-2)
	(available hoist35)
	(at hoist36 depot67-2-1)
	(available hoist36)
	(at hoist37 depot67-1-4)
	(available hoist37)
	(at hoist38 depot67-1-1)
	(available hoist38)
	(at hoist39 depot69-1-4)
	(available hoist39)
	(at hoist40 depot70-2-3)
	(available hoist40)
	(at hoist41 depot70-1-2)
	(available hoist41)
	(at hoist42 depot72-1-2)
	(available hoist42)
	(at hoist43 depot72-2-2)
	(available hoist43))
