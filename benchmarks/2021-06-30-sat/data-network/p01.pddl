(define (problem p7-3-11-ring-network-2019)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-4
    ...
    (:init
           ...
           (SCRIPT-IO script7 data-0-5 data-0-6 data-1-7)
           (SCRIPT-IO script8 data-1-7 data-0-5 data-2-3)
           ...
           (= (process-cost script11 server6) 8)
