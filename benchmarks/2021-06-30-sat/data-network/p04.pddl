(define (problem p17-3-33-ring-network-2022)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-4
    ...
    (:init
           (SCRIPT-IO script1 data-0-4 data-0-15 data-1-2)
           (SCRIPT-IO script2 data-0-1 data-0-6 data-1-8)
           (SCRIPT-IO script3 data-0-6 data-0-9 data-1-13)
           (SCRIPT-IO script4 data-0-15 data-0-4 data-1-16)
           (SCRIPT-IO script5 data-0-6 data-0-15 data-1-17)
           (SCRIPT-IO script6 data-1-2 data-1-17 data-2-3)
           (SCRIPT-IO script7 data-1-13 data-1-2 data-2-5)
           (SCRIPT-IO script8 data-1-2 data-1-16 data-2-7)
           (SCRIPT-IO script9 data-1-16 data-0-6 data-2-10)
           (SCRIPT-IO script10 data-1-17 data-0-4 data-2-11)
           (SCRIPT-IO script11 data-1-17 data-0-4 data-2-12)
           (SCRIPT-IO script12 data-1-2 data-0-9 data-2-14)
           (SCRIPT-IO script13 data-1-16 data-0-4 data-2-12)
           (SCRIPT-IO script14 data-1-8 data-1-17 data-2-7)
           (SCRIPT-IO script15 data-1-13 data-1-8 data-2-14)
           (SCRIPT-IO script16 data-0-15 data-0-9 data-1-8)
           (SCRIPT-IO script17 data-0-15 data-0-1 data-1-17)
           (SCRIPT-IO script18 data-1-13 data-0-15 data-2-5)
           (SCRIPT-IO script19 data-1-13 data-0-1 data-2-12)
           (SCRIPT-IO script20 data-0-1 data-0-9 data-1-2)
           (SCRIPT-IO script21 data-0-4 data-0-6 data-1-16)
           (SCRIPT-IO script22 data-0-6 data-0-9 data-1-16)
           (SCRIPT-IO script23 data-0-15 data-0-9 data-1-16)
           (SCRIPT-IO script24 data-1-16 data-0-9 data-2-14)
           (SCRIPT-IO script25 data-0-4 data-0-9 data-1-2)
           (SCRIPT-IO script26 data-0-4 data-0-6 data-1-16)
           (SCRIPT-IO script27 data-1-16 data-1-8 data-2-14)
           (SCRIPT-IO script28 data-0-9 data-0-6 data-1-17)
           (SCRIPT-IO script29 data-0-6 data-0-1 data-1-17)
           (SCRIPT-IO script30 data-0-9 data-0-1 data-1-17)
           (SCRIPT-IO script31 data-1-2 data-0-4 data-2-14)
           (SCRIPT-IO script32 data-1-17 data-1-13 data-2-10)
           (SCRIPT-IO script33 data-0-6 data-0-15 data-1-2)
