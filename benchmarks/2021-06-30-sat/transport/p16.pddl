; Transport city-sequential-9nodes-1000size-4degree-100mindistance-57trucks-152packages-2034seed

(define (problem transport-city-sequential-9nodes-1000size-4degree-100mindistance-57trucks-152packages-2034seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
 ...
 (:init
  ...
  (at package-139 city-loc-5)
  (at package-140 city-loc-7)
  (at package-141 city-loc-8)
  (at package-142 city-loc-6)
