; Transport city-sequential-9nodes-1000size-4degree-100mindistance-53trucks-142packages-2033seed

(define (problem transport-city-sequential-9nodes-1000size-4degree-100mindistance-53trucks-142packages-2033seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
 ...
 (:init
  ...
  (= (road-length city-loc-9 city-loc-3) 45)
  ; 401,580 -> 806,399
  (road city-loc-3 city-loc-9)
  (= (road-length city-loc-3 city-loc-9) 45)
  ; 806,399 -> 573,735
  ...
  (at package-140 city-loc-3)
  (at package-141 city-loc-7)
  (at package-142 city-loc-3)
  ...
  (at truck-19 city-loc-6)
  (capacity truck-19 capacity-4)
  (at truck-20 city-loc-8)
 ...
 (:goal (and
  ...
  (at package-128 city-loc-1)
  (at package-129 city-loc-4)
  (at package-130 city-loc-5)
