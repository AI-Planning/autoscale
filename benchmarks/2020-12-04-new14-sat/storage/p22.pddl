...
(:init
	...
	(connected depot48-5-2 loadarea)
	(connected loadarea depot48-5-2)  
	(clear depot48-4-1)
	(clear depot48-5-2)
	(clear depot48-5-5)
	(clear depot48-5-3)
	...
	(available hoist11)
	(at hoist12 depot48-1-1)
	(available hoist12)
	(at hoist13 depot48-3-3)
	(available hoist13)
	(at hoist14 depot48-1-3)
	(available hoist14)
	(at hoist15 depot48-1-2)
	(available hoist15)
	(at hoist16 depot48-3-5)
	(available hoist16)
	(at hoist17 depot48-1-4)
	(available hoist17)
	(at hoist18 depot48-4-2)
	(available hoist18)
	(at hoist19 depot48-5-6)
	(available hoist19)
	(at hoist20 depot48-2-6)
	(available hoist20)
	(at hoist21 depot48-2-4)
	(available hoist21)
