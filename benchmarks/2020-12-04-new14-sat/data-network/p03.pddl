(define (problem p10-2-21-ring-network-2021)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-3
    ...
    (:init
           ...
           (SCRIPT-IO script4 data-0-1 data-0-8 data-1-10)
           (SCRIPT-IO script5 data-0-4 data-0-8 data-1-5)
           (SCRIPT-IO script6 data-0-3 data-0-8 data-1-9)
           (SCRIPT-IO script7 data-0-3 data-0-4 data-1-9)
           (SCRIPT-IO script8 data-0-7 data-0-8 data-1-9)
           (SCRIPT-IO script9 data-0-6 data-0-3 data-1-9)
           (SCRIPT-IO script10 data-0-4 data-0-1 data-1-9)
           (SCRIPT-IO script11 data-0-7 data-0-8 data-1-9)
           (SCRIPT-IO script12 data-0-6 data-0-3 data-1-10)
           (SCRIPT-IO script13 data-0-3 data-0-4 data-1-9)
           (SCRIPT-IO script14 data-0-8 data-0-6 data-1-10)
           (SCRIPT-IO script15 data-0-7 data-0-6 data-1-10)
           (SCRIPT-IO script16 data-0-7 data-0-3 data-1-5)
           (SCRIPT-IO script17 data-0-3 data-0-7 data-1-10)
           (SCRIPT-IO script18 data-0-8 data-0-6 data-1-10)
