(define (problem p8-2-15-ring-network-2020)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-3
    ...
    (:init
           ...
           (= (process-cost script7 server5) 32)
           ...
           (= (process-cost script9 server3) 32)
