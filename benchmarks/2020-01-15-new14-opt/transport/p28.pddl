; Transport city-sequential-5nodes-1000size-3degree-100mindistance-5trucks-6packages-2046seed

(define (problem transport-city-sequential-5nodes-1000size-3degree-100mindistance-5trucks-6packages-2046seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
