; Transport city-sequential-5nodes-1000size-4degree-100mindistance-2trucks-11packages-2033seed

(define (problem transport-city-sequential-5nodes-1000size-4degree-100mindistance-2trucks-11packages-2033seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
