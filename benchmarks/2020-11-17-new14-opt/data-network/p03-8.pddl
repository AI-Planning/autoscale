(define (problem p10-5-20-tiny-network-2261)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           ...
           (SCRIPT-IO script4 data-1-2 data-0-10 data-2-9)
           (SCRIPT-IO script5 data-2-9 data-0-1 data-3-4)
           (SCRIPT-IO script6 data-2-3 data-0-1 data-3-8)
           (SCRIPT-IO script7 data-3-8 data-0-10 data-4-5)
           (SCRIPT-IO script8 data-2-3 data-2-7 data-3-4)
           (SCRIPT-IO script9 data-3-8 data-1-2 data-4-5)
           (SCRIPT-IO script10 data-2-3 data-1-2 data-3-4)
           (SCRIPT-IO script11 data-2-9 data-1-2 data-3-4)
           (SCRIPT-IO script12 data-2-7 data-2-3 data-3-8)
           (SCRIPT-IO script13 data-3-4 data-2-3 data-4-5)
           (SCRIPT-IO script14 data-3-8 data-2-9 data-4-5)
           (SCRIPT-IO script15 data-3-8 data-1-2 data-4-5)
           (SCRIPT-IO script16 data-3-8 data-0-6 data-4-5)
           (SCRIPT-IO script17 data-0-6 data-0-10 data-1-2)
           (SCRIPT-IO script18 data-0-1 data-0-10 data-1-2)
