(define (problem p11-5-21-tiny-network-2112)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           ...
           (SCRIPT-IO script6 data-2-3 data-1-9 data-3-7)
           (SCRIPT-IO script7 data-2-3 data-2-8 data-3-11)
           (SCRIPT-IO script8 data-3-7 data-0-6 data-4-5)
           (SCRIPT-IO script9 data-3-11 data-0-6 data-4-10)
           (SCRIPT-IO script10 data-1-2 data-0-6 data-2-8)
           (SCRIPT-IO script11 data-0-6 data-0-1 data-1-2)
           (SCRIPT-IO script12 data-0-6 data-0-1 data-1-2)
           (SCRIPT-IO script13 data-1-9 data-0-6 data-2-3)
           (SCRIPT-IO script14 data-2-8 data-2-3 data-3-11)
           (SCRIPT-IO script15 data-1-9 data-0-6 data-2-3)
           (SCRIPT-IO script16 data-3-11 data-2-3 data-4-10)
           (SCRIPT-IO script17 data-0-1 data-0-6 data-1-2)
           (SCRIPT-IO script18 data-1-9 data-1-2 data-2-3)
           (SCRIPT-IO script19 data-2-3 data-1-9 data-3-11)
           (SCRIPT-IO script20 data-2-3 data-2-8 data-3-4)
