(define (problem p21-2-64-tiny-network-2168)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-3
    ...
    (:init
           ...
           (SCRIPT-IO script64 data-0-20 data-0-3 data-1-17)
           ...
           (= (process-cost script47 server3) 4)
           ...
           (= (process-cost script52 server1) 28)
           ...
           (= (process-cost script64 server3) 5)
