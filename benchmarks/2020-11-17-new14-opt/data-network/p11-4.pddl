(define (problem p19-5-30-tiny-network-2149)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           ...
           (SCRIPT-IO script3 data-0-6 data-0-1 data-1-17)
           (SCRIPT-IO script4 data-0-6 data-0-1 data-1-18)
           (SCRIPT-IO script5 data-0-6 data-0-1 data-1-19)
           (SCRIPT-IO script6 data-1-7 data-1-2 data-2-3)
           (SCRIPT-IO script7 data-1-19 data-0-1 data-2-12)
           (SCRIPT-IO script8 data-1-19 data-0-6 data-2-13)
           (SCRIPT-IO script9 data-2-12 data-2-3 data-3-4)
           (SCRIPT-IO script10 data-2-3 data-0-6 data-3-11)
           (SCRIPT-IO script11 data-2-3 data-0-6 data-3-14)
           (SCRIPT-IO script12 data-3-4 data-0-6 data-4-5)
           (SCRIPT-IO script13 data-3-11 data-2-3 data-4-8)
           (SCRIPT-IO script14 data-3-14 data-3-11 data-4-9)
           (SCRIPT-IO script15 data-3-11 data-0-6 data-4-10)
           (SCRIPT-IO script16 data-3-11 data-0-6 data-4-15)
           (SCRIPT-IO script17 data-3-4 data-0-6 data-4-16)
           (SCRIPT-IO script18 data-0-6 data-0-1 data-1-17)
           (SCRIPT-IO script19 data-2-12 data-0-6 data-3-11)
           (SCRIPT-IO script20 data-1-18 data-0-6 data-2-13)
           (SCRIPT-IO script21 data-0-1 data-0-6 data-1-17)
           (SCRIPT-IO script22 data-2-13 data-0-6 data-3-4)
           (SCRIPT-IO script23 data-3-14 data-0-6 data-4-10)
           (SCRIPT-IO script24 data-1-18 data-0-1 data-2-12)
           (SCRIPT-IO script25 data-3-14 data-2-12 data-4-5)
           (SCRIPT-IO script26 data-3-11 data-2-12 data-4-10)
           (SCRIPT-IO script27 data-3-11 data-1-18 data-4-5)
           (SCRIPT-IO script28 data-3-14 data-3-11 data-4-9)
           (SCRIPT-IO script29 data-2-3 data-1-17 data-3-4)
           ...
           (= (process-cost script7 server1) 33)
           ...
           (= (process-cost script28 server1) 28)
