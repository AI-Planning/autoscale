(define (problem p22-5-33-tiny-network-2181)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           ...
           (SCRIPT-IO script2 data-0-11 data-0-14 data-1-18)
           (SCRIPT-IO script3 data-0-6 data-0-1 data-1-19)
           (SCRIPT-IO script4 data-1-18 data-0-1 data-2-3)
           (SCRIPT-IO script5 data-1-19 data-1-2 data-2-9)
           (SCRIPT-IO script6 data-1-19 data-0-14 data-2-10)
           (SCRIPT-IO script7 data-1-2 data-1-18 data-2-12)
           (SCRIPT-IO script8 data-1-2 data-0-1 data-2-15)
           (SCRIPT-IO script9 data-1-2 data-1-18 data-2-21)
           (SCRIPT-IO script10 data-2-15 data-0-1 data-3-4)
           (SCRIPT-IO script11 data-3-4 data-1-18 data-4-5)
           (SCRIPT-IO script12 data-3-4 data-2-15 data-4-8)
           (SCRIPT-IO script13 data-3-4 data-0-20 data-4-17)
           (SCRIPT-IO script14 data-3-4 data-1-18 data-4-22)
           (SCRIPT-IO script15 data-0-7 data-0-20 data-1-2)
           (SCRIPT-IO script16 data-3-4 data-1-19 data-4-17)
           (SCRIPT-IO script17 data-0-7 data-0-20 data-1-18)
           (SCRIPT-IO script18 data-0-14 data-0-6 data-1-2)
           (SCRIPT-IO script19 data-0-7 data-0-1 data-1-2)
           (SCRIPT-IO script20 data-1-19 data-0-13 data-2-10)
           (SCRIPT-IO script21 data-1-19 data-1-18 data-2-10)
           (SCRIPT-IO script22 data-1-19 data-0-6 data-2-10)
           (SCRIPT-IO script23 data-1-2 data-1-19 data-2-21)
           (SCRIPT-IO script24 data-3-4 data-0-13 data-4-17)
           (SCRIPT-IO script25 data-0-1 data-0-14 data-1-2)
           (SCRIPT-IO script26 data-3-4 data-1-2 data-4-17)
           (SCRIPT-IO script27 data-3-4 data-0-1 data-4-5)
           (SCRIPT-IO script28 data-2-10 data-1-19 data-3-4)
           (SCRIPT-IO script29 data-0-13 data-0-20 data-1-2)
           (SCRIPT-IO script30 data-3-4 data-1-2 data-4-17)
           (SCRIPT-IO script31 data-0-1 data-0-20 data-1-2)
           (SCRIPT-IO script32 data-3-4 data-0-7 data-4-22)
           (SCRIPT-IO script33 data-1-19 data-0-7 data-2-10)
