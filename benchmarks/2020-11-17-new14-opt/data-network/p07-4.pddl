(define (problem p15-5-25-tiny-network-2145)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           ...
           (SCRIPT-IO script5 data-1-11 data-1-12 data-2-3)
           (SCRIPT-IO script6 data-1-11 data-0-6 data-2-13)
           (SCRIPT-IO script7 data-1-10 data-1-2 data-2-15)
           (SCRIPT-IO script8 data-2-3 data-2-13 data-3-4)
           (SCRIPT-IO script9 data-2-3 data-2-13 data-3-7)
           (SCRIPT-IO script10 data-2-15 data-2-13 data-3-8)
           (SCRIPT-IO script11 data-3-8 data-3-7 data-4-5)
           (SCRIPT-IO script12 data-3-8 data-1-10 data-4-9)
           (SCRIPT-IO script13 data-2-15 data-0-1 data-3-7)
           (SCRIPT-IO script14 data-1-2 data-1-11 data-2-3)
           (SCRIPT-IO script15 data-2-13 data-1-12 data-3-7)
           (SCRIPT-IO script16 data-1-11 data-1-2 data-2-13)
           (SCRIPT-IO script17 data-1-11 data-1-2 data-2-15)
           (SCRIPT-IO script18 data-3-7 data-0-14 data-4-5)
           (SCRIPT-IO script19 data-2-15 data-1-2 data-3-8)
           (SCRIPT-IO script20 data-1-2 data-0-1 data-2-15)
           (SCRIPT-IO script21 data-2-3 data-1-2 data-3-4)
           (SCRIPT-IO script22 data-0-6 data-0-1 data-1-10)
           (SCRIPT-IO script23 data-0-14 data-0-1 data-1-12)
           (SCRIPT-IO script24 data-3-7 data-1-12 data-4-9)
           (SCRIPT-IO script25 data-1-12 data-0-6 data-2-3)
