(define (problem p8-5-18-tiny-network-2139)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           ...
           (SCRIPT-IO script3 data-1-2 data-0-8 data-2-7)
           (SCRIPT-IO script4 data-2-7 data-1-2 data-3-4)
           (SCRIPT-IO script5 data-3-4 data-0-1 data-4-5)
           (SCRIPT-IO script6 data-3-4 data-0-6 data-4-5)
           (SCRIPT-IO script7 data-3-4 data-0-8 data-4-5)
           (SCRIPT-IO script8 data-2-3 data-1-2 data-3-4)
           (SCRIPT-IO script9 data-3-4 data-2-7 data-4-5)
           (SCRIPT-IO script10 data-1-2 data-0-6 data-2-7)
           (SCRIPT-IO script11 data-0-1 data-0-8 data-1-2)
           (SCRIPT-IO script12 data-1-2 data-0-6 data-2-3)
           (SCRIPT-IO script13 data-0-6 data-0-1 data-1-2)
           (SCRIPT-IO script14 data-2-7 data-2-3 data-3-4)
           (SCRIPT-IO script15 data-3-4 data-0-8 data-4-5)
           (SCRIPT-IO script16 data-1-2 data-0-6 data-2-3)
           (SCRIPT-IO script17 data-3-4 data-1-2 data-4-5)
           (SCRIPT-IO script18 data-0-6 data-0-8 data-1-2)
