(define (problem p16-5-27-tiny-network-2296)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           ...
           (SCRIPT-IO script2 data-0-13 data-0-15 data-1-16)
           (SCRIPT-IO script3 data-1-2 data-0-15 data-2-3)
           (SCRIPT-IO script4 data-1-2 data-1-16 data-2-7)
           (SCRIPT-IO script5 data-1-2 data-1-16 data-2-8)
           (SCRIPT-IO script6 data-1-2 data-0-6 data-2-11)
           (SCRIPT-IO script7 data-1-2 data-1-16 data-2-12)
           (SCRIPT-IO script8 data-2-7 data-0-1 data-3-4)
           (SCRIPT-IO script9 data-2-11 data-1-16 data-3-9)
           (SCRIPT-IO script10 data-2-7 data-2-12 data-3-10)
           (SCRIPT-IO script11 data-3-10 data-3-9 data-4-5)
           (SCRIPT-IO script12 data-3-9 data-0-13 data-4-14)
           (SCRIPT-IO script13 data-1-16 data-0-13 data-2-7)
           (SCRIPT-IO script14 data-1-2 data-0-13 data-2-11)
           (SCRIPT-IO script15 data-1-16 data-1-2 data-2-8)
           (SCRIPT-IO script16 data-3-10 data-1-16 data-4-14)
           (SCRIPT-IO script17 data-1-16 data-0-1 data-2-11)
           (SCRIPT-IO script18 data-0-1 data-0-6 data-1-2)
           (SCRIPT-IO script19 data-3-4 data-3-10 data-4-5)
           (SCRIPT-IO script20 data-1-16 data-0-15 data-2-12)
           (SCRIPT-IO script21 data-1-16 data-1-2 data-2-11)
           (SCRIPT-IO script22 data-1-16 data-1-2 data-2-11)
           (SCRIPT-IO script23 data-2-8 data-1-16 data-3-9)
           (SCRIPT-IO script24 data-3-10 data-3-4 data-4-5)
           (SCRIPT-IO script25 data-3-4 data-2-11 data-4-5)
           (SCRIPT-IO script26 data-1-2 data-0-15 data-2-12)
           (SCRIPT-IO script27 data-1-2 data-0-6 data-2-7)
