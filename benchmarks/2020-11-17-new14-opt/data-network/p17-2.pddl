(define (problem p7-2-18-tiny-network-2095)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-3
    ...
    (:init
           ...
           (SCRIPT-IO script4 data-0-6 data-0-5 data-1-7)
           (SCRIPT-IO script5 data-0-1 data-0-5 data-1-4)
           (SCRIPT-IO script6 data-0-6 data-0-3 data-1-7)
           (SCRIPT-IO script7 data-0-6 data-0-3 data-1-7)
           (SCRIPT-IO script8 data-0-5 data-0-3 data-1-4)
           (SCRIPT-IO script9 data-0-6 data-0-1 data-1-2)
           (SCRIPT-IO script10 data-0-3 data-0-5 data-1-4)
