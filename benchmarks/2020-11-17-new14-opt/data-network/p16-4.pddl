(define (problem p6-2-14-tiny-network-2154)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-3
    ...
    (:init
           ...
           (SCRIPT-IO script3 data-0-3 data-0-6 data-1-4)
           ...
           (SCRIPT-IO script8 data-0-6 data-0-3 data-1-2)
           (SCRIPT-IO script9 data-0-6 data-0-5 data-1-4)
