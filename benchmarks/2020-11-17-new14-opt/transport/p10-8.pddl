; Transport city-sequential-2nodes-1000size-3degree-100mindistance-2trucks-23packages-2268seed

(define (problem transport-city-sequential-2nodes-1000size-3degree-100mindistance-2trucks-23packages-2268seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
 ...
 (:init
  ...
  (= (road-length city-loc-2 city-loc-1) 10)
  ; 173,756 -> 273,762
  (road city-loc-1 city-loc-2)
  (= (road-length city-loc-1 city-loc-2) 10)
