; Transport city-sequential-2nodes-1000size-3degree-100mindistance-2trucks-27packages-2300seed

(define (problem transport-city-sequential-2nodes-1000size-3degree-100mindistance-2trucks-27packages-2300seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
