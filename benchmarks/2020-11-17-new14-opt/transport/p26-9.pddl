; Transport city-sequential-2nodes-1000size-4degree-100mindistance-2trucks-40packages-2314seed

(define (problem transport-city-sequential-2nodes-1000size-4degree-100mindistance-2trucks-40packages-2314seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
 ...
 (:init
  ...
  (= (road-length city-loc-2 city-loc-1) 89)
  ; 198,1 -> 927,505
  (road city-loc-1 city-loc-2)
  (= (road-length city-loc-1 city-loc-2) 89)
