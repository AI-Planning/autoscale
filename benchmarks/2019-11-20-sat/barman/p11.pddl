(define (problem prob)
 ...
 (:goal
  (and
      ...
      (contains shot58 cocktail84)
      (contains shot59 cocktail22)
      (contains shot60 cocktail83)
      (contains shot61 cocktail63)
