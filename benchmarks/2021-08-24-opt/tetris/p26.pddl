(define (problem Tetris-32-3-8017029)
(:domain tetris)
(:objects  
...
nothing- one_square
nada- two_straight
rightl0 rightl1 rightl2 rightl3 rightl4 rightl5 rightl6 rightl7 rightl8 rightl9 - right_l
)
(:init
...
(at_right_l rightl4 f14-0f f15-0f f15-1f)
(at_right_l rightl5 f10-0f f11-0f f11-1f)
(at_right_l rightl6 f4-2f f5-2f f5-3f)
(at_right_l rightl7 f14-2f f15-2f f15-3f)
(at_right_l rightl8 f6-1f f7-1f f7-2f)
(at_right_l rightl9 f0-2f f1-2f f1-3f)
 )
(:goal
(and
(clear f0-0f)
