(define (problem Tetris-14-1-660665)
(:domain tetris)
(:objects  
...
(at_square square2 f7-3f)
(at_square square3 f4-3f)
(at_square square4 f5-1f)
(at_square square5 f2-2f)
(at_square square6 f2-0f)
(at_square square7 f4-1f)
(at_square square8 f4-0f)
(at_square square9 f1-2f)
(at_square square10 f7-0f)
(at_square square11 f5-3f)
(at_square square12 f0-0f)
(at_square square13 f6-0f)
(at_square square14 f7-2f)
(at_square square15 f3-2f)
(at_square square16 f1-1f)
(at_square square17 f3-1f)
(at_square square18 f2-3f)
(at_square square19 f1-0f)
(at_square square20 f1-3f)
(at_square square21 f3-3f)
(at_square square22 f3-0f)
(at_square square23 f0-1f)
(at_square square24 f7-1f)
(at_square square25 f4-2f)
(at_square square26 f6-1f)
(at_square square27 f0-3f)
 )
(:goal
(and
(clear f0-0f)
