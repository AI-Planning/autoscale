...
(:constants
    Wee1 SP1 SL1 Skp2 Skp1 RPA Raf1 pRbp2 pRbp1-E2F4p1-DP12 pRb-E2F4p1-DP12 pRb Plk1 PCNA p68 p57p1 p57 p53p1 p53 p27 p16 p130-E2F5p1-DP12 p130-E2F4p1-DP12 p130 Myt1 Max m1433 Jun HDAC1-pRbp1-E2F4-DP12 HDAC1-pRbp1-E2F13p1-DP12 HDAC1-pRbp1-E2F13-DP12 HDAC1-p130-E2F5p1-DP12 HDAC1-p130-E2F4p1-DP12 HDAC1-p107-E2F4p1-DP12 HDAC1 HBP1 gp19ARF gP gERCC1 gE-c gE2 gcdc25A E2F6-DP12p1 E2F6 E2F5-DP12p1 E2F5 E2F4-DP12p1 E2F4 E2F3 E2F2 E2F13p1-DP12p1 E2F13p1-DP12 E2F13-DP12p1 E2F13-DP12 E2F13 E2F1 DP12 DMP1 cycH cycB C-TAK1 cks1 Chk1 CEBP cdk7 cdk46p3-cycDp1 cdk46p3-cycD cdk46p1 cdk2p2-cycB cdk2p1 cdk2-cycB cdk2 cdk1p1p2 cdc25C c-Abl APC AP2 - simple
...
(:action DUMMY-STRIPS-ACTION-2
 :parameters ()
 :precondition (available cdk46p1p2)
 :effect (and (goal2)))
...
(:action DUMMY-STRIPS-ACTION-52
 :parameters ()
 :precondition (available c-Abl-pRbp1)
 :effect (and (goal27)))
...
(:action DUMMY-STRIPS-ACTION-108
 :parameters ()
 :precondition (available p57p1-cdk46p1-cycDp1)
 :effect (and (goal55)))
...
(:action DUMMY-STRIPS-ACTION-122
 :parameters ()
 :precondition (available Raf1-pRbp1-E2F13p1-DP12p1)
 :effect (and (goal62)))

(:action DUMMY-STRIPS-ACTION-123
 :parameters ()
 :precondition (available cdk1p2-Gadd45)
 :effect (and (goal62)))
...
(:action DUMMY-STRIPS-ACTION-140
 :parameters ()
 :precondition (available Raf1-pRb-E2F13p1-DP12p1-gE2)
 :effect (and (goal71)))
...
(:action DUMMY-STRIPS-ACTION-153
 :parameters ()
 :precondition (available p57p1-cdk46p1-cycD)
 :effect (and (goal77)))
...
(:action DUMMY-STRIPS-ACTION-174
 :parameters ()
 :precondition (available CEBP-pRbp1-gP)
 :effect (and (goal88)))
