; Transport city-sequential-3nodes-1000size-3degree-100mindistance-2trucks-20packages-2039seed

(define (problem transport-city-sequential-3nodes-1000size-3degree-100mindistance-2trucks-20packages-2039seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
