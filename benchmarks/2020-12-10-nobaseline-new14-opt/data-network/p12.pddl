(define (problem p20-4-74-tiny-network-2030)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-5
    ...
    (:init
           ...
           (= (process-cost script20 server1) 30)
           ...
           (= (process-cost script50 server2) 5)
           (= (process-cost script50 server3) 6)
           (= (process-cost script51 server1) 27)
           ...
           (= (process-cost script55 server1) 29)
           ...
           (= (process-cost script60 server3) 12)
           ...
           (= (process-cost script67 server1) 26)
