(define (problem p18-4-65-tiny-network-2028)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-5
    ...
    (:init
           ...
           (= (process-cost script18 server1) 27)
           ...
           (= (process-cost script28 server2) 3)
           ...
           (= (process-cost script57 server1) 29)
           ...
           (= (process-cost script63 server1) 28)
