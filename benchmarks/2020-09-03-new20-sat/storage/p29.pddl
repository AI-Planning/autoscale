...
;
; Map of the Depots:                                                                                                                          
; 0*0 11* *2 3*3 4*=5* *6=*7 8*=*99 AA* BB*=C*=DD* *E=*F=*GG=H*H *I *J=KK*=L*=MM*=N* *O=PP*=*Q=*R *S TT* U*U *VV WWWW     
;                                                                                                                WWW*     
;--------------------------------------------------------------------------------------------------------------------     
; 48: depot48 area
; 49: depot49 area
...
(:init
	...
	(connected transit2 depot56-1-2)
	(connected transit2 depot57-1-1)
	(connected transit3 depot66-1-3)
	...
	(connected depot87-2-4 loadarea)
	(connected loadarea depot87-2-4)  
	(clear depot48-1-1)
	(clear depot48-1-2)
	(clear depot48-1-3)
	(clear depot49-1-1)
