; Transport city-sequential-2nodes-1000size-5degree-100mindistance-2trucks-20packages-2023seed

(define (problem transport-city-sequential-2nodes-1000size-5degree-100mindistance-2trucks-20packages-2023seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
