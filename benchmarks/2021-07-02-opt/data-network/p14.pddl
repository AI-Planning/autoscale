(define (problem p21-6-66-tiny-network-2032)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-7
    ...
    (:init
           ...
           (SCRIPT-IO script2 data-0-1 data-0-21 data-1-18)
           (SCRIPT-IO script3 data-0-21 data-0-7 data-1-20)
           (SCRIPT-IO script4 data-1-18 data-1-2 data-2-3)
           (SCRIPT-IO script5 data-1-20 data-0-7 data-2-9)
           (SCRIPT-IO script6 data-1-18 data-0-1 data-2-11)
           (SCRIPT-IO script7 data-1-2 data-1-20 data-2-14)
           (SCRIPT-IO script8 data-1-20 data-0-21 data-2-17)
           (SCRIPT-IO script9 data-2-14 data-2-3 data-3-4)
           (SCRIPT-IO script10 data-2-3 data-2-11 data-3-15)
           (SCRIPT-IO script11 data-3-15 data-0-21 data-4-5)
           (SCRIPT-IO script12 data-3-15 data-1-20 data-4-8)
           (SCRIPT-IO script13 data-3-4 data-3-15 data-4-12)
           (SCRIPT-IO script14 data-4-5 data-4-8 data-5-6)
           (SCRIPT-IO script15 data-4-8 data-3-15 data-5-10)
           (SCRIPT-IO script16 data-4-5 data-1-18 data-5-13)
           (SCRIPT-IO script17 data-4-5 data-1-20 data-5-16)
           (SCRIPT-IO script18 data-4-8 data-4-5 data-5-19)
           (SCRIPT-IO script19 data-4-5 data-3-4 data-5-19)
           (SCRIPT-IO script20 data-4-5 data-3-15 data-5-16)
           (SCRIPT-IO script21 data-2-14 data-1-2 data-3-4)
           (SCRIPT-IO script22 data-1-2 data-0-21 data-2-9)
           (SCRIPT-IO script23 data-2-17 data-1-20 data-3-15)
           (SCRIPT-IO script24 data-4-12 data-3-15 data-5-10)
           (SCRIPT-IO script25 data-0-1 data-0-7 data-1-2)
           (SCRIPT-IO script26 data-4-8 data-3-15 data-5-16)
           (SCRIPT-IO script27 data-2-9 data-2-17 data-3-15)
           (SCRIPT-IO script28 data-1-18 data-1-20 data-2-9)
           (SCRIPT-IO script29 data-3-4 data-2-14 data-4-8)
           (SCRIPT-IO script30 data-0-7 data-0-1 data-1-18)
           (SCRIPT-IO script31 data-3-15 data-1-18 data-4-8)
           (SCRIPT-IO script32 data-1-20 data-0-21 data-2-9)
           (SCRIPT-IO script33 data-2-3 data-2-11 data-3-15)
           (SCRIPT-IO script34 data-0-7 data-0-1 data-1-18)
           (SCRIPT-IO script35 data-1-18 data-0-21 data-2-14)
           (SCRIPT-IO script36 data-4-5 data-3-4 data-5-16)
           (SCRIPT-IO script37 data-3-15 data-1-2 data-4-12)
           (SCRIPT-IO script38 data-4-8 data-4-12 data-5-16)
           (SCRIPT-IO script39 data-4-12 data-3-4 data-5-6)
           (SCRIPT-IO script40 data-3-4 data-2-17 data-4-12)
           (SCRIPT-IO script41 data-1-18 data-0-1 data-2-14)
           (SCRIPT-IO script42 data-2-11 data-0-21 data-3-15)
           (SCRIPT-IO script43 data-1-20 data-1-2 data-2-11)
           (SCRIPT-IO script44 data-4-8 data-0-21 data-5-6)
           (SCRIPT-IO script45 data-2-3 data-0-7 data-3-15)
           (SCRIPT-IO script46 data-0-1 data-0-21 data-1-2)
           (SCRIPT-IO script47 data-2-3 data-1-20 data-3-15)
           (SCRIPT-IO script48 data-0-21 data-0-1 data-1-20)
           (SCRIPT-IO script49 data-0-21 data-0-1 data-1-18)
           (SCRIPT-IO script50 data-1-2 data-0-21 data-2-17)
           (SCRIPT-IO script51 data-1-18 data-1-20 data-2-14)
           (SCRIPT-IO script52 data-0-7 data-0-1 data-1-2)
           (SCRIPT-IO script53 data-3-15 data-0-7 data-4-8)
           (SCRIPT-IO script54 data-4-8 data-2-11 data-5-13)
           (SCRIPT-IO script55 data-1-20 data-0-21 data-2-17)
           (SCRIPT-IO script56 data-0-7 data-0-1 data-1-18)
           (SCRIPT-IO script57 data-2-3 data-1-2 data-3-15)
           (SCRIPT-IO script58 data-0-7 data-0-21 data-1-18)
           (SCRIPT-IO script59 data-1-18 data-0-1 data-2-14)
           (SCRIPT-IO script60 data-4-12 data-4-8 data-5-6)
           (SCRIPT-IO script61 data-2-14 data-2-17 data-3-15)
           (SCRIPT-IO script62 data-0-21 data-0-1 data-1-2)
           (SCRIPT-IO script63 data-4-5 data-2-3 data-5-16)
           (SCRIPT-IO script64 data-0-1 data-0-7 data-1-2)
           (SCRIPT-IO script65 data-1-18 data-1-20 data-2-11)
           (SCRIPT-IO script66 data-3-4 data-0-1 data-4-8)
           ...
           (DATA-SIZE data-5-10 number3)
           (DATA-SIZE data-5-13 number3)
           (DATA-SIZE data-5-16 number2)
           (DATA-SIZE data-5-19 number3)
           ...
           (= (process-cost script56 server3) 14)
           (= (process-cost script57 server1) 18)
           (= (process-cost script57 server2) 5)
    ...
    (:goal
           (and
                ...
                (saved data-5-10 server3)
                (saved data-5-13 server1)
