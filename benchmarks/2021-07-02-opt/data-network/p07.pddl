(define (problem p14-6-35-tiny-network-2025)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-7
    ...
    (:init
           ...
           (SCRIPT-IO script3 data-0-7 data-0-13 data-1-12)
           (SCRIPT-IO script4 data-1-11 data-0-1 data-2-3)
           (SCRIPT-IO script5 data-2-3 data-0-13 data-3-4)
           (SCRIPT-IO script6 data-2-3 data-1-11 data-3-9)
           (SCRIPT-IO script7 data-2-3 data-0-1 data-3-14)
           (SCRIPT-IO script8 data-3-9 data-1-11 data-4-5)
           (SCRIPT-IO script9 data-3-4 data-0-7 data-4-10)
           (SCRIPT-IO script10 data-4-10 data-4-5 data-5-6)
           (SCRIPT-IO script11 data-4-10 data-0-7 data-5-8)
           (SCRIPT-IO script12 data-0-1 data-0-13 data-1-12)
           (SCRIPT-IO script13 data-1-11 data-1-12 data-2-3)
           (SCRIPT-IO script14 data-1-2 data-0-7 data-2-3)
           (SCRIPT-IO script15 data-4-10 data-2-3 data-5-6)
           (SCRIPT-IO script16 data-0-13 data-0-1 data-1-11)
           (SCRIPT-IO script17 data-4-10 data-3-14 data-5-6)
           (SCRIPT-IO script18 data-3-14 data-0-13 data-4-10)
           (SCRIPT-IO script19 data-0-1 data-0-7 data-1-2)
           (SCRIPT-IO script20 data-4-10 data-2-3 data-5-8)
           (SCRIPT-IO script21 data-0-7 data-0-13 data-1-2)
           (SCRIPT-IO script22 data-1-12 data-0-13 data-2-3)
           (SCRIPT-IO script23 data-4-5 data-3-9 data-5-6)
           (SCRIPT-IO script24 data-2-3 data-0-13 data-3-4)
           (SCRIPT-IO script25 data-0-13 data-0-7 data-1-2)
           (SCRIPT-IO script26 data-3-9 data-1-12 data-4-5)
           (SCRIPT-IO script27 data-0-1 data-0-7 data-1-11)
           (SCRIPT-IO script28 data-3-4 data-1-11 data-4-10)
           (SCRIPT-IO script29 data-2-3 data-1-11 data-3-9)
           (SCRIPT-IO script30 data-3-14 data-0-13 data-4-10)
           (SCRIPT-IO script31 data-0-7 data-0-13 data-1-2)
           (SCRIPT-IO script32 data-3-14 data-1-11 data-4-10)
           (SCRIPT-IO script33 data-4-10 data-0-7 data-5-6)
           (SCRIPT-IO script34 data-4-10 data-2-3 data-5-6)
           (SCRIPT-IO script35 data-1-12 data-0-7 data-2-3)
           ...
           (= (process-cost script16 server1) 32)
