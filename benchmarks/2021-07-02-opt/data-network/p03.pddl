(define (problem p10-6-17-tiny-network-2021)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-7
    ...
    (:init
           ...
           (SCRIPT-IO script3 data-1-2 data-0-7 data-2-10)
           (SCRIPT-IO script4 data-2-3 data-1-2 data-3-4)
           (SCRIPT-IO script5 data-3-4 data-0-7 data-4-5)
           (SCRIPT-IO script6 data-3-4 data-1-2 data-4-8)
           (SCRIPT-IO script7 data-4-5 data-2-3 data-5-6)
           (SCRIPT-IO script8 data-4-8 data-1-2 data-5-9)
           (SCRIPT-IO script9 data-1-2 data-0-1 data-2-3)
           (SCRIPT-IO script10 data-2-10 data-1-2 data-3-4)
           (SCRIPT-IO script11 data-2-3 data-0-1 data-3-4)
           (SCRIPT-IO script12 data-4-8 data-3-4 data-5-9)
           (SCRIPT-IO script13 data-1-2 data-0-7 data-2-3)
           (SCRIPT-IO script14 data-3-4 data-0-7 data-4-8)
           (SCRIPT-IO script15 data-3-4 data-0-7 data-4-8)
           (SCRIPT-IO script16 data-1-2 data-0-7 data-2-10)
           (SCRIPT-IO script17 data-3-4 data-2-3 data-4-8)
