(define (problem p9-6-12-tiny-network-2020)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-7
    ...
    (:init
           ...
           (SCRIPT-IO script3 data-1-2 data-0-1 data-2-9)
           (SCRIPT-IO script4 data-2-3 data-0-8 data-3-4)
           (SCRIPT-IO script5 data-3-4 data-0-7 data-4-5)
           (SCRIPT-IO script6 data-4-5 data-1-2 data-5-6)
           (SCRIPT-IO script7 data-2-9 data-1-2 data-3-4)
           (SCRIPT-IO script8 data-2-3 data-1-2 data-3-4)
           (SCRIPT-IO script9 data-4-5 data-2-9 data-5-6)
           (SCRIPT-IO script10 data-4-5 data-1-2 data-5-6)
           (SCRIPT-IO script11 data-4-5 data-1-2 data-5-6)
