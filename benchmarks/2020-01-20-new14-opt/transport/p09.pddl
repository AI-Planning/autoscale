; Transport city-sequential-2nodes-1000size-5degree-100mindistance-2trucks-21packages-2027seed

(define (problem transport-city-sequential-2nodes-1000size-5degree-100mindistance-2trucks-21packages-2027seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
 ...
 (:init
  ...
  (= (road-length city-loc-2 city-loc-1) 95)
  ; 110,949 -> 475,81
  (road city-loc-1 city-loc-2)
  (= (road-length city-loc-1 city-loc-2) 95)
