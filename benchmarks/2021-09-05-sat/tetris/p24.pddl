(define (problem Tetris-36-1-9548127)
(:domain tetris)
(:objects  
...
(at_square square18 f0-3f)
(at_square square19 f10-0f)
(at_square square20 f6-1f)
(at_square square21 f7-1f)
(at_square square22 f2-0f)
(at_square square23 f10-3f)
(at_square square24 f17-2f)
(at_square square25 f14-0f)
(at_square square26 f1-2f)
(at_square square27 f2-1f)
(at_square square28 f4-0f)
(at_square square29 f16-2f)
(at_square square30 f6-3f)
(at_square square31 f18-2f)
(at_square square32 f14-3f)
(at_square square33 f11-0f)
(at_square square34 f0-2f)
(at_square square35 f3-1f)
(at_square square36 f11-1f)
(at_square square37 f4-1f)
(at_square square38 f0-0f)
(at_square square39 f6-0f)
(at_square square40 f12-0f)
(at_square square41 f3-3f)
(at_square square42 f5-0f)
(at_square square43 f16-3f)
(at_square square44 f12-1f)
(at_square square45 f8-2f)
(at_square square46 f15-1f)
(at_square square47 f5-1f)
(at_square square48 f10-2f)
(at_square square49 f15-3f)
 )
(:goal
(and
(clear f0-0f)
