(define (problem Tetris-30-1-8144048)
(:domain tetris)
(:objects  
...
square0 square1 square2 square3 square4 square5 square6 square7 square8 square9 square10 square11 square12 square13 square14 square15 square16 square17 square18 square19 square20 square21 square22 square23 square24 square25 square26 square27 square28 square29 square30 square31 square32 square33 square34 square35 square36 square37 square38 square39 square40 square41 square42 square43 square44 square45 square46 square47 square48 square49 square50 square51 square52 square53 square54 square55 - one_square
nada- two_straight
nisba- right_l
)
(:init
...
(at_square square3 f8-1f)
(at_square square4 f1-1f)
(at_square square5 f13-3f)
(at_square square6 f11-3f)
(at_square square7 f8-0f)
(at_square square8 f0-2f)
(at_square square9 f14-2f)
(at_square square10 f12-3f)
(at_square square11 f5-1f)
(at_square square12 f7-1f)
(at_square square13 f0-1f)
(at_square square14 f10-1f)
(at_square square15 f4-2f)
(at_square square16 f5-3f)
(at_square square17 f13-2f)
(at_square square18 f11-2f)
(at_square square19 f14-1f)
(at_square square20 f7-3f)
(at_square square21 f8-3f)
(at_square square22 f14-3f)
(at_square square23 f7-2f)
(at_square square24 f15-2f)
(at_square square25 f9-3f)
(at_square square26 f9-1f)
(at_square square27 f3-0f)
(at_square square28 f1-2f)
(at_square square29 f7-0f)
(at_square square30 f1-3f)
(at_square square31 f0-0f)
(at_square square32 f0-3f)
(at_square square33 f4-0f)
(at_square square34 f3-2f)
(at_square square35 f10-3f)
(at_square square36 f14-0f)
(at_square square37 f4-3f)
(at_square square38 f10-0f)
(at_square square39 f8-2f)
(at_square square40 f13-0f)
(at_square square41 f4-1f)
(at_square square42 f5-0f)
(at_square square43 f2-1f)
(at_square square44 f13-1f)
(at_square square45 f3-1f)
(at_square square46 f12-1f)
(at_square square47 f6-3f)
(at_square square48 f15-3f)
(at_square square49 f6-0f)
(at_square square50 f9-0f)
(at_square square51 f15-0f)
(at_square square52 f2-0f)
(at_square square53 f11-1f)
(at_square square54 f15-1f)
(at_square square55 f11-0f)
 )
(:goal
(and
(clear f0-0f)
