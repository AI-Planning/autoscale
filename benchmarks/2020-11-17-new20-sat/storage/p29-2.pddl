...
;
; Map of the Depots:                                                                                                                          
; *00=1*1 2* *3=*4=5*5=6*=7*7=*8 99* A*=*B *CC=*DD=E*E FF* G*G=*H *II J*J=*KK L*=*M=N*N O*=*P=*QQ RR* S*S *TT=U*=*V WWW   
;                                                                                                                   *W    
;----------------------------------------------------------------------------------------------------------------------   
; 48: depot48 area
; 49: depot49 area
...
(:init
	...
	(connected transit10 depot74-1-3)
	(connected transit10 depot75-1-1)
	(connected transit11 depot76-1-2)
	...
	(connected transit15 depot84-1-3)
	(connected transit15 depot85-1-1)
	(connected transit16 depot85-1-2)
	...
	(available hoist14)
	(at hoist15 depot78-1-2)
	(available hoist15)
	(at hoist16 depot81-1-2)
	(available hoist16)
	(at hoist17 depot82-1-1)
	(available hoist17)
	(at hoist18 depot82-1-2)
	(available hoist18)
	(at hoist19 depot83-1-1)
	(available hoist19)
	(at hoist20 depot85-1-1)
	(available hoist20)
