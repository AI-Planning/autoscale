...
;
; Map of the Depots:                                                                                                                          
; *00=1*1 2*2 3* 4*4=*5=6*=7*7=8*=*9 *AA B* CC*=D*=E*E=FF*=G*G=*HH I*I=J* *K LL*=*MM=*NN *O=*PP=QQ* R*=*S=T* U*=VV*=WWW   
;                                                                                                                   W *   
;----------------------------------------------------------------------------------------------------------------------   
; 48: depot48 area
; 49: depot49 area
...
(:objects
	depot48-1-1 depot48-1-2 depot48-1-3 depot49-1-1 depot49-1-2 depot49-1-3 depot50-1-1 depot50-1-2 depot50-1-3 depot51-1-1 depot51-1-2 depot52-1-1 depot52-1-2 depot52-1-3 depot53-1-1 depot53-1-2 depot54-1-1 depot54-1-2 depot55-1-1 depot55-1-2 depot55-1-3 depot56-1-1 depot56-1-2 depot57-1-1 depot57-1-2 depot65-1-1 depot65-1-2 depot65-1-3 depot66-1-1 depot66-1-2 depot67-1-1 depot67-1-2 depot67-1-3 depot68-1-1 depot68-1-2 depot69-1-1 depot69-1-2 depot69-1-3 depot70-1-1 depot70-1-2 depot70-1-3 depot71-1-1 depot71-1-2 depot71-1-3 depot72-1-1 depot72-1-2 depot72-1-3 depot73-1-1 depot73-1-2 depot73-1-3 depot74-1-1 depot74-1-2 depot75-1-1 depot75-1-2 depot76-1-1 depot76-1-2 depot76-1-3 depot77-1-1 depot77-1-2 depot77-1-3 depot78-1-1 depot78-1-2 depot78-1-3 depot79-1-1 depot79-1-2 depot80-1-1 depot80-1-2 depot80-1-3 depot81-1-1 depot81-1-2 depot81-1-3 depot82-1-1 depot82-1-2 depot83-1-1 depot83-1-2 depot84-1-1 depot84-1-2 depot85-1-1 depot85-1-2 depot86-1-1 depot86-1-2 depot86-1-3 depot87-1-1 depot87-1-2 depot87-1-3 depot87-2-1 depot87-2-3 container-0-0 container-0-1 container-0-2 container-0-3 container-1-0 container-1-1 container-1-2 container-1-3 container-2-0 container-2-1 container-2-2 container-2-3 container-3-0 container-3-1 container-3-2 container-3-3 container-4-0 container-4-1 container-4-2 container-4-3 container-5-0 container-5-1 container-5-2 container-5-3 container-6-0 container-6-1 container-6-2 container-6-3 container-7-0 container-7-1 container-7-2 container-7-3 container-8-0 container-8-1 container-8-2 container-8-3 container-9-0 container-9-1 container-9-2 container-9-3 container-10-0 container-10-1 container-10-2 container-10-3 container-11-0 container-11-1 container-11-2 - storearea
...
(:init
	...
	(connected transit1 depot52-1-3)
	...
	(connected transit4 depot55-1-3)
	...
	(connected transit7 depot68-1-2)
	(connected transit7 depot69-1-1)
	(connected transit8 depot69-1-3)
	(connected transit8 depot70-1-1)
	(connected transit9 depot70-1-3)
	(connected transit9 depot71-1-1)
	(connected transit10 depot71-1-3)
	(connected transit10 depot72-1-1)
	(connected transit11 depot73-1-3)
	(connected transit11 depot74-1-1)
	(connected transit12 depot76-1-3)
	(connected transit12 depot77-1-1)
	(connected transit13 depot77-1-3)
	(connected transit13 depot78-1-1)
	(connected transit14 depot79-1-2)
	(connected transit14 depot80-1-1)
	(connected transit15 depot80-1-3)
	(connected transit15 depot81-1-1)
	(connected transit16 depot82-1-2)
	(connected transit16 depot83-1-1)
	(connected transit17 depot83-1-2)
	(connected transit17 depot84-1-1)
	...
	(connected depot70-1-3 loadarea)
	(connected loadarea depot70-1-3)
	...
	(connected depot76-1-3 loadarea)
	(connected loadarea depot76-1-3)
	...
	(connected depot81-1-3 loadarea)
	(connected loadarea depot81-1-3)
	...
	(available hoist1)
	(at hoist2 depot51-1-1)
	(available hoist2)
	(at hoist3 depot52-1-1)
	(available hoist3)
	...
	(available hoist6)
	(at hoist7 depot57-1-1)
	(available hoist7)
	(at hoist8 depot67-1-3)
	(available hoist8)
	(at hoist9 depot68-1-1)
	(available hoist9)
	(at hoist10 depot70-1-3)
	(available hoist10)
	(at hoist11 depot72-1-2)
	(available hoist11)
	(at hoist12 depot73-1-2)
	(available hoist12)
	(at hoist13 depot77-1-3)
	(available hoist13)
	(at hoist14 depot77-1-1)
	(available hoist14)
	(at hoist15 depot77-1-2)
	(available hoist15)
	(at hoist16 depot80-1-1)
	(available hoist16)
	(at hoist17 depot81-1-2)
	(available hoist17)
	(at hoist18 depot84-1-1)
	(available hoist18)
	(at hoist19 depot85-1-2)
	(available hoist19)
	(at hoist20 depot86-1-1)
	(available hoist20)
	(at hoist21 depot87-2-3)
	(available hoist21))
