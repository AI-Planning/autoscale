...
;
; Map of the Depots:                                                                                                                      
; 0*=*11=22*=*33 *4=*55=6*6=*77=*88=9* *A=B*B C*=D* E* F*=*G=*HH *I=*J *K=*LL=*M N* O* PP*=*QQ RR*=*SS T* *U=VVVV     
;                                                                                                            V*VV     
;----------------------------------------------------------------------------------------------------------------     
; 48: depot48 area
; 49: depot49 area
...
(:objects
	depot48-1-1 depot48-1-2 depot49-1-1 depot49-1-2 depot49-1-3 depot50-1-1 depot50-1-2 depot50-1-3 depot51-1-1 depot51-1-2 depot51-1-3 depot52-1-1 depot52-1-2 depot53-1-1 depot53-1-2 depot53-1-3 depot54-1-1 depot54-1-2 depot54-1-3 depot55-1-1 depot55-1-2 depot55-1-3 depot56-1-1 depot56-1-2 depot56-1-3 depot57-1-1 depot57-1-2 depot65-1-1 depot65-1-2 depot66-1-1 depot66-1-2 depot66-1-3 depot67-1-1 depot67-1-2 depot68-1-1 depot68-1-2 depot69-1-1 depot69-1-2 depot70-1-1 depot70-1-2 depot71-1-1 depot71-1-2 depot72-1-1 depot72-1-2 depot72-1-3 depot73-1-1 depot73-1-2 depot74-1-1 depot74-1-2 depot75-1-1 depot75-1-2 depot76-1-1 depot76-1-2 depot76-1-3 depot77-1-1 depot77-1-2 depot78-1-1 depot78-1-2 depot79-1-1 depot79-1-2 depot80-1-1 depot80-1-2 depot80-1-3 depot81-1-1 depot81-1-2 depot81-1-3 depot82-1-1 depot82-1-2 depot82-1-3 depot83-1-1 depot83-1-2 depot83-1-3 depot84-1-1 depot84-1-2 depot85-1-1 depot85-1-2 depot86-1-1 depot86-1-2 depot86-1-3 depot86-1-4 depot86-2-1 depot86-2-2 depot86-2-3 depot86-2-4 container-0-0 container-0-1 container-0-2 container-0-3 container-1-0 container-1-1 container-1-2 container-1-3 container-2-0 container-2-1 container-2-2 container-2-3 container-3-0 container-3-1 container-3-2 container-3-3 container-4-0 container-4-1 container-4-2 container-4-3 container-5-0 container-5-1 container-5-2 container-5-3 container-6-0 container-6-1 container-6-2 container-6-3 container-7-0 container-7-1 container-7-2 container-7-3 container-8-0 container-8-1 container-8-2 container-8-3 container-9-0 container-9-1 container-9-2 container-9-3 container-10-0 container-10-1 container-10-2 container-10-3 container-11-0 - storearea
	...
	depot48 depot49 depot50 depot51 depot52 depot53 depot54 depot55 depot56 depot57 depot65 depot66 depot67 depot68 depot69 depot70 depot71 depot72 depot73 depot74 depot75 depot76 depot77 depot78 depot79 depot80 depot81 depot82 depot83 depot84 depot85 depot86 - depot
...
(:init
	...
	(connected depot86-1-3 depot86-2-3)
	(connected depot86-1-3 depot86-1-4)
	(connected depot86-1-3 depot86-1-2)
	(connected depot86-1-4 depot86-2-4)
	(connected depot86-1-4 depot86-1-3)
	(connected depot86-2-1 depot86-1-1)
	(connected depot86-2-1 depot86-2-2)
	(connected depot86-2-2 depot86-1-2)
	(connected depot86-2-2 depot86-2-3)
	(connected depot86-2-2 depot86-2-1)
	(connected depot86-2-3 depot86-1-3)
	(connected depot86-2-3 depot86-2-4)
	(connected depot86-2-3 depot86-2-2)
	(connected depot86-2-4 depot86-1-4)
	(connected depot86-2-4 depot86-2-3)
	...
	(connected transit4 depot53-1-3)
	(connected transit4 depot54-1-1)
	(connected transit5 depot54-1-3)
	(connected transit5 depot55-1-1)
	(connected transit6 depot55-1-3)
	(connected transit6 depot56-1-1)
	(connected transit7 depot56-1-3)
	(connected transit7 depot57-1-1)
	(connected transit8 depot65-1-2)
	(connected transit8 depot66-1-1)
	(connected transit9 depot67-1-2)
	(connected transit9 depot68-1-1)
	(connected transit10 depot70-1-2)
	(connected transit10 depot71-1-1)
	(connected transit11 depot71-1-2)
	(connected transit11 depot72-1-1)
	(connected transit12 depot73-1-2)
	(connected transit12 depot74-1-1)
	(connected transit13 depot75-1-2)
	(connected transit13 depot76-1-1)
	(connected transit14 depot76-1-3)
	(connected transit14 depot77-1-1)
	(connected transit15 depot80-1-3)
	(connected transit15 depot81-1-1)
	(connected transit16 depot82-1-3)
	(connected transit16 depot83-1-1)
	(connected transit17 depot85-1-2)
	(connected transit17 depot86-1-1)
	...
	(in depot86-1-4 depot86)
	(in depot86-2-1 depot86)
	(in depot86-2-2 depot86)
	(in depot86-2-3 depot86)
	(in depot86-2-4 depot86)
	...
	(available hoist0)
	(at hoist1 depot53-1-3)
	(available hoist1)
	(at hoist2 depot54-1-1)
	(available hoist2)
	(at hoist3 depot54-1-2)
	(available hoist3)
	(at hoist4 depot55-1-3)
	(available hoist4)
	(at hoist5 depot56-1-1)
	(available hoist5)
	(at hoist6 depot56-1-2)
	(available hoist6)
	(at hoist7 depot56-1-3)
	(available hoist7)
	...
	(available hoist12)
	(at hoist13 depot75-1-1)
	(available hoist13)
	(at hoist14 depot76-1-3)
	(available hoist14)
	(at hoist15 depot77-1-2)
	(available hoist15)
	(at hoist16 depot79-1-1)
	(available hoist16)
	(at hoist17 depot83-1-2)
	(available hoist17)
	(at hoist18 depot84-1-1)
	(available hoist18)
	(at hoist19 depot86-2-2)
	(available hoist19)
	(at hoist20 depot86-1-2)
	(available hoist20)
	(at hoist21 depot86-1-4)
	(available hoist21))
