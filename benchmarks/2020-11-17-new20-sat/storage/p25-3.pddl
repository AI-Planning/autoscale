...
;
; Map of the Depots:                                                                                                           
; 0*0 1*1=2*2=*3 4*=*5=6*=77*=*88=9*9 *AA=BB*=CC*=D* *E F*F G* *H=*II=J*=K*K L*=M*=NN* OO*=P*=Q*=*R SSS    
;                                                                                                   SS*    
;------------------------------------------------------------------------------------------------------    
; 48: depot48 area
; 49: depot49 area
...
(:init
	...
	(connected transit13 depot76-1-2)
	...
	(available hoist7)
	(at hoist8 depot68-1-2)
	(available hoist8)
	(at hoist9 depot69-1-2)
	(available hoist9)
	(at hoist10 depot73-1-1)
	(available hoist10)
