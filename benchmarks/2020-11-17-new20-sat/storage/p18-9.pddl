...
;
; Map of the Depots:                                                                                
; 0* *11 2*=3* 4* 5* *6 *7=88*=9* *A=B* C*=D* E*=*F *G=*HH=*I *JJ *K=LLLL       
;                                                                    LLLL       
;                                                                    L  *       
;------------------------------------------------------------------------       
; 48: depot48 area
...
(:objects
	depot48-1-1 depot48-1-2 depot49-1-1 depot49-1-2 depot49-1-3 depot50-1-1 depot50-1-2 depot51-1-1 depot51-1-2 depot52-1-1 depot52-1-2 depot53-1-1 depot53-1-2 depot54-1-1 depot54-1-2 depot55-1-1 depot55-1-2 depot56-1-1 depot56-1-2 depot56-1-3 depot57-1-1 depot57-1-2 depot65-1-1 depot65-1-2 depot66-1-1 depot66-1-2 depot67-1-1 depot67-1-2 depot68-1-1 depot68-1-2 depot69-1-1 depot69-1-2 depot70-1-1 depot70-1-2 depot71-1-1 depot71-1-2 depot72-1-1 depot72-1-2 depot72-1-3 depot73-1-1 depot73-1-2 depot74-1-1 depot74-1-2 depot74-1-3 depot75-1-1 depot75-1-2 depot76-1-1 depot76-1-2 depot76-1-3 depot76-1-4 depot76-2-1 depot76-2-2 depot76-2-3 depot76-2-4 depot76-3-1 depot76-3-4 container-0-0 container-0-1 container-0-2 container-0-3 container-1-0 container-1-1 container-1-2 container-1-3 container-2-0 container-2-1 container-2-2 container-2-3 container-3-0 container-3-1 container-3-2 container-3-3 container-4-0 container-4-1 container-4-2 container-4-3 container-5-0 container-5-1 container-5-2 container-5-3 container-6-0 container-6-1 container-6-2 container-6-3 container-7-0 container-7-1 - storearea
	...
	depot48 depot49 depot50 depot51 depot52 depot53 depot54 depot55 depot56 depot57 depot65 depot66 depot67 depot68 depot69 depot70 depot71 depot72 depot73 depot74 depot75 depot76 - depot
...
(:init
	...
	(connected depot76-1-3 depot76-2-3)
	(connected depot76-1-3 depot76-1-4)
	(connected depot76-1-3 depot76-1-2)
	(connected depot76-1-4 depot76-2-4)
	(connected depot76-1-4 depot76-1-3)
	(connected depot76-2-1 depot76-1-1)
	(connected depot76-2-1 depot76-3-1)
	(connected depot76-2-1 depot76-2-2)
	(connected depot76-2-2 depot76-1-2)
	(connected depot76-2-2 depot76-2-3)
	(connected depot76-2-2 depot76-2-1)
	(connected depot76-2-3 depot76-1-3)
	(connected depot76-2-3 depot76-2-4)
	(connected depot76-2-3 depot76-2-2)
	(connected depot76-2-4 depot76-1-4)
	(connected depot76-2-4 depot76-3-4)
	(connected depot76-2-4 depot76-2-3)
	(connected depot76-3-1 depot76-2-1)
	(connected depot76-3-4 depot76-2-4)
	...
	(in depot76-1-4 depot76)
	(in depot76-2-1 depot76)
	(in depot76-2-2 depot76)
	(in depot76-2-3 depot76)
	(in depot76-2-4 depot76)
	(in depot76-3-1 depot76)
	(in depot76-3-4 depot76)
	...
	(connected depot76-3-4 loadarea)
	(connected loadarea depot76-3-4)  
	(clear depot48-1-1)
	(clear depot48-1-2)
	(clear depot49-1-1)
	(clear depot49-1-3)
