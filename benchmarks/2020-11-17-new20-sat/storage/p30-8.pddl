...
;
; Map of the Depots:                                                                                                                             
; 0*=11*=*2 3* *4 *5=6* 77* 8*8=*99 *A=B*B=*C=D*D=*E=*F=GG*=H*=*I J* *K *L MM*=N*N=O* P* *QQ=RR* S*=T* UU*=*V W*W=XXXX       
;                                                                                                                 XXXX       
;                                                                                                                 X *        
;---------------------------------------------------------------------------------------------------------------------       
; 48: depot48 area
...
(:objects
	depot48-1-1 depot48-1-2 depot49-1-1 depot49-1-2 depot49-1-3 depot50-1-1 depot50-1-2 depot51-1-1 depot51-1-2 depot52-1-1 depot52-1-2 depot53-1-1 depot53-1-2 depot54-1-1 depot54-1-2 depot55-1-1 depot55-1-2 depot55-1-3 depot56-1-1 depot56-1-2 depot56-1-3 depot57-1-1 depot57-1-2 depot57-1-3 depot65-1-1 depot65-1-2 depot66-1-1 depot66-1-2 depot66-1-3 depot67-1-1 depot67-1-2 depot68-1-1 depot68-1-2 depot68-1-3 depot69-1-1 depot69-1-2 depot70-1-1 depot70-1-2 depot71-1-1 depot71-1-2 depot71-1-3 depot72-1-1 depot72-1-2 depot73-1-1 depot73-1-2 depot74-1-1 depot74-1-2 depot75-1-1 depot75-1-2 depot76-1-1 depot76-1-2 depot77-1-1 depot77-1-2 depot77-1-3 depot78-1-1 depot78-1-2 depot78-1-3 depot79-1-1 depot79-1-2 depot80-1-1 depot80-1-2 depot81-1-1 depot81-1-2 depot81-1-3 depot82-1-1 depot82-1-2 depot82-1-3 depot83-1-1 depot83-1-2 depot84-1-1 depot84-1-2 depot85-1-1 depot85-1-2 depot85-1-3 depot86-1-1 depot86-1-2 depot87-1-1 depot87-1-2 depot87-1-3 depot88-1-1 depot88-1-2 depot88-1-3 depot88-1-4 depot88-2-1 depot88-2-2 depot88-2-3 depot88-2-4 depot88-3-1 depot88-3-3 container-0-0 container-0-1 container-0-2 container-0-3 container-1-0 container-1-1 container-1-2 container-1-3 container-2-0 container-2-1 container-2-2 container-2-3 container-3-0 container-3-1 container-3-2 container-3-3 container-4-0 container-4-1 container-4-2 container-4-3 container-5-0 container-5-1 container-5-2 container-5-3 container-6-0 container-6-1 container-6-2 container-6-3 container-7-0 container-7-1 container-7-2 container-7-3 container-8-0 container-8-1 container-8-2 container-8-3 container-9-0 container-9-1 container-9-2 container-9-3 container-10-0 container-10-1 container-10-2 container-10-3 container-11-0 container-11-1 container-11-2 container-11-3 - storearea
...
(:init
	...
	(connected depot77-1-2 depot77-1-3)
	(connected depot77-1-2 depot77-1-1)
	(connected depot77-1-3 depot77-1-2)
	...
	(connected depot88-2-3 depot88-3-3)
	...
	(connected depot88-3-3 depot88-2-3)
	...
	(connected transit15 depot83-1-2)
	(connected transit15 depot84-1-1)
	(connected transit16 depot85-1-3)
	(connected transit16 depot86-1-1)
	(connected transit17 depot87-1-3)
	...
	(connected depot55-1-3 loadarea)
	(connected loadarea depot55-1-3)
	(connected depot56-1-2 loadarea)
	(connected loadarea depot56-1-2)
	...
	(connected depot71-1-3 loadarea)
	(connected loadarea depot71-1-3)
	(connected depot72-1-2 loadarea)
	(connected loadarea depot72-1-2)
	(connected depot73-1-1 loadarea)
	(connected loadarea depot73-1-1)
	(connected depot74-1-2 loadarea)
	(connected loadarea depot74-1-2)
	(connected depot75-1-1 loadarea)
	(connected loadarea depot75-1-1)
	(connected depot76-1-1 loadarea)
	(connected loadarea depot76-1-1)
	(connected depot77-1-3 loadarea)
	(connected loadarea depot77-1-3)
	...
	(connected depot82-1-3 loadarea)
	(connected loadarea depot82-1-3)
	(connected depot83-1-2 loadarea)
	(connected loadarea depot83-1-2)
	(connected depot84-1-2 loadarea)
	(connected loadarea depot84-1-2)
	(connected depot85-1-3 loadarea)
	(connected loadarea depot85-1-3)
	(connected depot86-1-1 loadarea)
	(connected loadarea depot86-1-1)
	(connected depot87-1-2 loadarea)
	(connected loadarea depot87-1-2)
	(connected depot88-3-3 loadarea)
	(connected loadarea depot88-3-3)  
	(clear depot48-1-1)
	(clear depot48-1-2)
	(clear depot49-1-1)
	(clear depot49-1-2)
	...
	(clear depot88-2-4)
	(clear depot88-3-1)  
	(at hoist0 depot53-1-1)
	(available hoist0)
	(at hoist1 depot54-1-2)
	(available hoist1)
	(at hoist2 depot56-1-3)
	(available hoist2)
	(at hoist3 depot66-1-3)
	(available hoist3)
	(at hoist4 depot70-1-2)
	(available hoist4)
	(at hoist5 depot73-1-1)
	(available hoist5)
	(at hoist6 depot73-1-2)
	(available hoist6)
	(at hoist7 depot77-1-2)
	(available hoist7)
	(at hoist8 depot79-1-1)
	(available hoist8)
	(at hoist9 depot79-1-2)
	(available hoist9)
	(at hoist10 depot80-1-1)
	(available hoist10)
	(at hoist11 depot80-1-2)
	(available hoist11)
	(at hoist12 depot81-1-3)
	(available hoist12)
	(at hoist13 depot82-1-3)
	(available hoist13)
	(at hoist14 depot82-1-2)
	(available hoist14)
	(at hoist15 depot83-1-1)
	(available hoist15)
	(at hoist16 depot84-1-1)
	(available hoist16)
	(at hoist17 depot84-1-2)
	(available hoist17)
	(at hoist18 depot85-1-3)
	(available hoist18)
	(at hoist19 depot86-1-1)
	(available hoist19)
	(at hoist20 depot87-1-2)
	(available hoist20)
	(at hoist21 depot87-1-1)
	(available hoist21)
	(at hoist22 depot88-2-1)
	(available hoist22))
