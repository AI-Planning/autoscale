...
;
; Map of the Depots:                                                                                                                   
; 00* 1* 2* 3* *4 55* 6*6=*7 88* 99*=A* B*=*C=D* *EE *F G* *H=*I *JJ=*K LL*=*M=N*N O* *P=*QQ *RR=SS*=TT* UUU       
;                                                                                                        UUU       
;                                                                                                        UU*       
;-----------------------------------------------------------------------------------------------------------       
; 48: depot48 area
...
(:objects
	depot48-1-1 depot48-1-2 depot48-1-3 depot49-1-1 depot49-1-2 depot50-1-1 depot50-1-2 depot51-1-1 depot51-1-2 depot52-1-1 depot52-1-2 depot53-1-1 depot53-1-2 depot53-1-3 depot54-1-1 depot54-1-2 depot54-1-3 depot55-1-1 depot55-1-2 depot56-1-1 depot56-1-2 depot56-1-3 depot57-1-1 depot57-1-2 depot57-1-3 depot65-1-1 depot65-1-2 depot66-1-1 depot66-1-2 depot67-1-1 depot67-1-2 depot68-1-1 depot68-1-2 depot69-1-1 depot69-1-2 depot69-1-3 depot70-1-1 depot70-1-2 depot71-1-1 depot71-1-2 depot72-1-1 depot72-1-2 depot73-1-1 depot73-1-2 depot74-1-1 depot74-1-2 depot74-1-3 depot75-1-1 depot75-1-2 depot76-1-1 depot76-1-2 depot76-1-3 depot77-1-1 depot77-1-2 depot78-1-1 depot78-1-2 depot78-1-3 depot79-1-1 depot79-1-2 depot80-1-1 depot80-1-2 depot81-1-1 depot81-1-2 depot81-1-3 depot82-1-1 depot82-1-2 depot82-1-3 depot83-1-1 depot83-1-2 depot83-1-3 depot84-1-1 depot84-1-2 depot84-1-3 depot85-1-1 depot85-1-2 depot85-1-3 depot85-2-1 depot85-2-2 depot85-2-3 depot85-3-1 depot85-3-2 depot85-3-3 container-0-0 container-0-1 container-0-2 container-0-3 container-1-0 container-1-1 container-1-2 container-1-3 container-2-0 container-2-1 container-2-2 container-2-3 container-3-0 container-3-1 container-3-2 container-3-3 container-4-0 container-4-1 container-4-2 container-4-3 container-5-0 container-5-1 container-5-2 container-5-3 container-6-0 container-6-1 container-6-2 container-6-3 container-7-0 container-7-1 container-7-2 container-7-3 container-8-0 container-8-1 container-8-2 container-8-3 container-9-0 container-9-1 container-9-2 container-9-3 container-10-0 container-10-1 container-10-2 container-10-3 - storearea
...
(:init
	...
	(connected depot85-2-1 depot85-3-1)
	(connected depot85-2-1 depot85-2-2)
	(connected depot85-2-2 depot85-1-2)
	(connected depot85-2-2 depot85-3-2)
	(connected depot85-2-2 depot85-2-3)
	(connected depot85-2-2 depot85-2-1)
	(connected depot85-2-3 depot85-1-3)
	(connected depot85-2-3 depot85-3-3)
	(connected depot85-2-3 depot85-2-2)
	(connected depot85-3-1 depot85-2-1)
	(connected depot85-3-1 depot85-3-2)
	(connected depot85-3-2 depot85-2-2)
	(connected depot85-3-2 depot85-3-3)
	(connected depot85-3-2 depot85-3-1)
	(connected depot85-3-3 depot85-2-3)
	(connected depot85-3-3 depot85-3-2)
	(connected transit0 depot54-1-3)
	(connected transit0 depot55-1-1)
	(connected transit1 depot57-1-3)
	(connected transit1 depot65-1-1)
	(connected transit2 depot66-1-2)
	(connected transit2 depot67-1-1)
	(connected transit3 depot67-1-2)
	(connected transit3 depot68-1-1)
	(connected transit4 depot72-1-2)
	(connected transit4 depot73-1-1)
	(connected transit5 depot74-1-3)
	(connected transit5 depot75-1-1)
	(connected transit6 depot76-1-3)
	(connected transit6 depot77-1-1)
	(connected transit7 depot77-1-2)
	(connected transit7 depot78-1-1)
	(connected transit8 depot80-1-2)
	(connected transit8 depot81-1-1)
	(connected transit9 depot82-1-3)
	(connected transit9 depot83-1-1)
	(connected transit10 depot83-1-3)
	(connected transit10 depot84-1-1)
	...
	(in depot85-3-1 depot85)
	(in depot85-3-2 depot85)
	(in depot85-3-3 depot85)
	...
	(connected depot84-1-3 loadarea)
	(connected loadarea depot84-1-3)
	(connected depot85-3-3 loadarea)
	(connected loadarea depot85-3-3)  
	(clear depot48-1-1)
	(clear depot48-1-2)
	(clear depot48-1-3)
	(clear depot49-1-2)
	...
	(available hoist9)
	(at hoist10 depot72-1-1)
	(available hoist10)
	(at hoist11 depot75-1-2)
	(available hoist11)
	(at hoist12 depot77-1-2)
	(available hoist12)
	(at hoist13 depot79-1-1)
	(available hoist13)
	(at hoist14 depot79-1-2)
	(available hoist14)
	...
	(available hoist17)
	(at hoist18 depot83-1-3)
	(available hoist18)
	(at hoist19 depot83-1-1)
	(available hoist19)
	(at hoist20 depot85-3-1)
	(available hoist20))
