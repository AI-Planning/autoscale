...
;
; Map of the Depots:                                                                                
; *0 1*=*2 *3=4*4=*55=*6=7* *8 99*=A*A=B* *C DD*=E* FF* GG*=*H=*I=JJ*=*KK=LLL   
;                                                                         *L    
;----------------------------------------------------------------------------   
; 48: depot48 area
; 49: depot49 area
...
(:init
	...
	(available hoist2)
	(at hoist3 depot66-1-2)
	(available hoist3)
	(at hoist4 depot67-1-1)
	(available hoist4)
	(at hoist5 depot68-1-3)
	(available hoist5)
