...
;
; Map of the Depots:                                                                                                              
; 0*=1*=*2 *3 4*=55* 6* *7=88* *9 A*=B*=C*C=D*D E* *F G*=*HH=I*I *J=K* *L=MM*=N*N O* PP*=*QQ=R*=*S=TTTT       
;                                                                                                  TTTT       
;                                                                                                  *T         
;------------------------------------------------------------------------------------------------------       
; 48: depot48 area
...
(:objects
	depot48-1-1 depot48-1-2 depot49-1-1 depot49-1-2 depot50-1-1 depot50-1-2 depot51-1-1 depot51-1-2 depot52-1-1 depot52-1-2 depot53-1-1 depot53-1-2 depot53-1-3 depot54-1-1 depot54-1-2 depot55-1-1 depot55-1-2 depot56-1-1 depot56-1-2 depot56-1-3 depot57-1-1 depot57-1-2 depot65-1-1 depot65-1-2 depot66-1-1 depot66-1-2 depot67-1-1 depot67-1-2 depot67-1-3 depot68-1-1 depot68-1-2 depot68-1-3 depot69-1-1 depot69-1-2 depot70-1-1 depot70-1-2 depot71-1-1 depot71-1-2 depot72-1-1 depot72-1-2 depot72-1-3 depot73-1-1 depot73-1-2 depot73-1-3 depot74-1-1 depot74-1-2 depot75-1-1 depot75-1-2 depot76-1-1 depot76-1-2 depot77-1-1 depot77-1-2 depot77-1-3 depot78-1-1 depot78-1-2 depot78-1-3 depot79-1-1 depot79-1-2 depot80-1-1 depot80-1-2 depot80-1-3 depot81-1-1 depot81-1-2 depot81-1-3 depot82-1-1 depot82-1-2 depot83-1-1 depot83-1-2 depot84-1-1 depot84-1-2 depot84-1-3 depot84-1-4 depot84-2-1 depot84-2-2 depot84-2-3 depot84-2-4 depot84-3-1 depot84-3-2 container-0-0 container-0-1 container-0-2 container-0-3 container-1-0 container-1-1 container-1-2 container-1-3 container-2-0 container-2-1 container-2-2 container-2-3 container-3-0 container-3-1 container-3-2 container-3-3 container-4-0 container-4-1 container-4-2 container-4-3 container-5-0 container-5-1 container-5-2 container-5-3 container-6-0 container-6-1 container-6-2 container-6-3 container-7-0 container-7-1 container-7-2 container-7-3 container-8-0 container-8-1 container-8-2 container-8-3 container-9-0 container-9-1 container-9-2 container-9-3 container-10-0 container-10-1 - storearea
...
(:init
	...
	(connected depot84-2-1 depot84-3-1)
	(connected depot84-2-1 depot84-2-2)
	(connected depot84-2-2 depot84-1-2)
	(connected depot84-2-2 depot84-3-2)
	(connected depot84-2-2 depot84-2-3)
	(connected depot84-2-2 depot84-2-1)
	(connected depot84-2-3 depot84-1-3)
	(connected depot84-2-3 depot84-2-4)
	(connected depot84-2-3 depot84-2-2)
	(connected depot84-2-4 depot84-1-4)
	(connected depot84-2-4 depot84-2-3)
	(connected depot84-3-1 depot84-2-1)
	(connected depot84-3-1 depot84-3-2)
	(connected depot84-3-2 depot84-2-2)
	(connected depot84-3-2 depot84-3-1)
	...
	(connected transit3 depot55-1-2)
	(connected transit3 depot56-1-1)
	(connected transit4 depot65-1-2)
	(connected transit4 depot66-1-1)
	(connected transit5 depot66-1-2)
	(connected transit5 depot67-1-1)
	(connected transit6 depot67-1-3)
	(connected transit6 depot68-1-1)
	(connected transit7 depot71-1-2)
	(connected transit7 depot72-1-1)
	(connected transit8 depot72-1-3)
	(connected transit8 depot73-1-1)
	(connected transit9 depot74-1-2)
	(connected transit9 depot75-1-1)
	(connected transit10 depot76-1-2)
	(connected transit10 depot77-1-1)
	(connected transit11 depot77-1-3)
	(connected transit11 depot78-1-1)
	(connected transit12 depot80-1-3)
	(connected transit12 depot81-1-1)
	(connected transit13 depot81-1-3)
	(connected transit13 depot82-1-1)
	(connected transit14 depot82-1-2)
	(connected transit14 depot83-1-1)
	...
	(in depot84-3-1 depot84)
	(in depot84-3-2 depot84)
	...
	(connected depot53-1-3 loadarea)
	(connected loadarea depot53-1-3)
	...
	(connected depot73-1-2 loadarea)
	(connected loadarea depot73-1-2)
	...
	(connected depot80-1-3 loadarea)
	(connected loadarea depot80-1-3)
	...
	(connected depot84-3-1 loadarea)
	(connected loadarea depot84-3-1)  
	(clear depot48-1-1)
	(clear depot48-1-2)
	(clear depot49-1-1)
	(clear depot49-1-2)
	...
	(available hoist0)
	(at hoist1 depot53-1-2)
	(available hoist1)
	(at hoist2 depot53-1-3)
	(available hoist2)
	(at hoist3 depot54-1-2)
	(available hoist3)
	(at hoist4 depot54-1-1)
	(available hoist4)
	(at hoist5 depot55-1-1)
	(available hoist5)
	(at hoist6 depot55-1-2)
	(available hoist6)
	(at hoist7 depot69-1-2)
	(available hoist7)
	(at hoist8 depot71-1-2)
	(available hoist8)
	(at hoist9 depot74-1-1)
	(available hoist9)
	(at hoist10 depot75-1-1)
	(available hoist10)
	(at hoist11 depot75-1-2)
	(available hoist11)
	(at hoist12 depot76-1-1)
	(available hoist12)
	(at hoist13 depot77-1-2)
	(available hoist13)
	(at hoist14 depot78-1-2)
	(available hoist14)
	(at hoist15 depot80-1-2)
	(available hoist15)
	(at hoist16 depot80-1-1)
	(available hoist16)
	(at hoist17 depot80-1-3)
	(available hoist17)
	(at hoist18 depot81-1-1)
	(available hoist18)
	(at hoist19 depot83-1-2)
	(available hoist19))
