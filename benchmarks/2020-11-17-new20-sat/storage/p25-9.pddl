...
;
; Map of the Depots:                                                                                                           
; *0 1*1=*22=*33 *4 *5=6*6=*7=8*8 9*=A*=*B=*C DD* *E *F=GG*=*HH=I*I J*=K*=L* *MM=*N=*OO PP* *Q *RR SSSS    
;                                                                                                  *SS     
;------------------------------------------------------------------------------------------------------    
; 48: depot48 area
; 49: depot49 area
...
(:init
	...
	(available hoist4)
	(at hoist5 depot65-1-1)
	(available hoist5)
	(at hoist6 depot68-1-3)
	(available hoist6)
	(at hoist7 depot70-1-2)
	(available hoist7)
	(at hoist8 depot71-1-1)
	(available hoist8)
	(at hoist9 depot72-1-1)
	(available hoist9)
	(at hoist10 depot74-1-2)
	(available hoist10)
	(at hoist11 depot75-1-1)
	(available hoist11)
