...
;
; Map of the Depots:                                                                                                                             
; *0 1* *2=3*3=4*=*55=6* *7 8*8 99*=*A B*B C*=D* EE* *F=G*G H* I*I=*J=KK*=L*=M*=N*N=*O=*PP=*Q *R=S*S=T*T UU* *VV=*WW=XXXX    
;                                                                                                                    XX *    
;------------------------------------------------------------------------------------------------------------------------    
; 48: depot48 area
; 49: depot49 area
...
(:objects
	depot48-1-1 depot48-1-2 depot49-1-1 depot49-1-2 depot50-1-1 depot50-1-2 depot51-1-1 depot51-1-2 depot51-1-3 depot52-1-1 depot52-1-2 depot53-1-1 depot53-1-2 depot53-1-3 depot54-1-1 depot54-1-2 depot55-1-1 depot55-1-2 depot56-1-1 depot56-1-2 depot56-1-3 depot57-1-1 depot57-1-2 depot57-1-3 depot65-1-1 depot65-1-2 depot66-1-1 depot66-1-2 depot66-1-3 depot67-1-1 depot67-1-2 depot68-1-1 depot68-1-2 depot69-1-1 depot69-1-2 depot69-1-3 depot70-1-1 depot70-1-2 depot71-1-1 depot71-1-2 depot71-1-3 depot72-1-1 depot72-1-2 depot73-1-1 depot73-1-2 depot73-1-3 depot74-1-1 depot74-1-2 depot75-1-1 depot75-1-2 depot75-1-3 depot76-1-1 depot76-1-2 depot77-1-1 depot77-1-2 depot78-1-1 depot78-1-2 depot78-1-3 depot79-1-1 depot79-1-2 depot80-1-1 depot80-1-2 depot80-1-3 depot81-1-1 depot81-1-2 depot82-1-1 depot82-1-2 depot83-1-1 depot83-1-2 depot83-1-3 depot84-1-1 depot84-1-2 depot84-1-3 depot85-1-1 depot85-1-2 depot85-1-3 depot86-1-1 depot86-1-2 depot86-1-3 depot87-1-1 depot87-1-2 depot87-1-3 depot88-1-1 depot88-1-2 depot88-1-3 depot88-1-4 depot88-2-1 depot88-2-2 depot88-2-4 container-0-0 container-0-1 container-0-2 container-0-3 container-1-0 container-1-1 container-1-2 container-1-3 container-2-0 container-2-1 container-2-2 container-2-3 container-3-0 container-3-1 container-3-2 container-3-3 container-4-0 container-4-1 container-4-2 container-4-3 container-5-0 container-5-1 container-5-2 container-5-3 container-6-0 container-6-1 container-6-2 container-6-3 container-7-0 container-7-1 container-7-2 container-7-3 container-8-0 container-8-1 container-8-2 container-8-3 container-9-0 container-9-1 container-9-2 container-9-3 container-10-0 container-10-1 container-10-2 container-10-3 container-11-0 container-11-1 container-11-2 container-11-3 - storearea
	...
	loadarea transit0 transit1 transit2 transit3 transit4 transit5 transit6 transit7 transit8 transit9 transit10 transit11 transit12 transit13 transit14 transit15 transit16 transit17 transit18 - transitarea)
...
(:init
	...
	(connected transit12 depot78-1-3)
	(connected transit12 depot79-1-1)
	(connected transit13 depot79-1-2)
	(connected transit13 depot80-1-1)
	(connected transit14 depot80-1-3)
	(connected transit14 depot81-1-1)
	(connected transit15 depot82-1-2)
	(connected transit15 depot83-1-1)
	(connected transit16 depot83-1-3)
	(connected transit16 depot84-1-1)
	(connected transit17 depot86-1-3)
	(connected transit17 depot87-1-1)
	(connected transit18 depot87-1-3)
	(connected transit18 depot88-1-1)
	...
	(connected depot69-1-3 loadarea)
	(connected loadarea depot69-1-3)
	...
	(connected depot75-1-3 loadarea)
	(connected loadarea depot75-1-3)
	...
	(connected depot88-2-4 loadarea)
	(connected loadarea depot88-2-4)  
	(clear depot48-1-1)
	(clear depot49-1-1)
	(clear depot51-1-1)
	(clear depot51-1-2)
	...
	(available hoist3)
	(at hoist4 depot56-1-3)
	(available hoist4)
	(at hoist5 depot57-1-1)
	(available hoist5)
	(at hoist6 depot66-1-1)
	(available hoist6)
	(at hoist7 depot66-1-2)
	(available hoist7)
	(at hoist8 depot68-1-1)
	(available hoist8)
	(at hoist9 depot68-1-2)
	(available hoist9)
	(at hoist10 depot69-1-2)
	(available hoist10)
	(at hoist11 depot70-1-2)
	(available hoist11)
	(at hoist12 depot76-1-2)
	(available hoist12)
	(at hoist13 depot78-1-3)
	(available hoist13)
	(at hoist14 depot78-1-2)
	(available hoist14)
	(at hoist15 depot80-1-3)
	(available hoist15)
	(at hoist16 depot81-1-1)
	(available hoist16)
	(at hoist17 depot83-1-3)
	(available hoist17)
	(at hoist18 depot84-1-3)
	(available hoist18)
	(at hoist19 depot85-1-2)
	(available hoist19)
	(at hoist20 depot87-1-1)
	(available hoist20)
	(at hoist21 depot87-1-3)
	(available hoist21)
	(at hoist22 depot88-1-4)
	(available hoist22))
