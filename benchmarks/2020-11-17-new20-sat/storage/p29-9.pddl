...
;
; Map of the Depots:                                                                                                                          
; 0*0 1*=2*2=3* 4*4=*5 *6=7*=8* *99 *A=B*B=C*C *D=E*E=FF* *GG H* I*I *J *K LL*=*M NN* *O *PP=QQ*=*RR SS*=T*=U*U VV*=WWW   
;                                                                                                                   *W    
;----------------------------------------------------------------------------------------------------------------------   
; 48: depot48 area
; 49: depot49 area
...
(:init
	...
	(connected transit9 depot76-1-3)
	...
	(connected transit14 depot86-1-3)
	...
	(available hoist11)
	(at hoist12 depot71-1-3)
	(available hoist12)
	(at hoist13 depot71-1-1)
	(available hoist13)
	(at hoist14 depot73-1-3)
	(available hoist14)
	(at hoist15 depot74-1-2)
	(available hoist15)
