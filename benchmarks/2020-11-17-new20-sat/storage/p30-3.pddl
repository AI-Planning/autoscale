...
;
; Map of the Depots:                                                                                                                             
; *0 1* *2=*33 44* 55* 66*=7* 8*8=99*=A*=BB* *C *DD E* *F=G* H*H=II*=JJ*=*K=*L=*M=*N=*O=P*=Q*=*RR S* T* UU* VV* W* XXX       
;                                                                                                                  XXX       
;                                                                                                                  *XX       
;---------------------------------------------------------------------------------------------------------------------       
; 48: depot48 area
...
(:objects
	depot48-1-1 depot48-1-2 depot49-1-1 depot49-1-2 depot50-1-1 depot50-1-2 depot51-1-1 depot51-1-2 depot51-1-3 depot52-1-1 depot52-1-2 depot52-1-3 depot53-1-1 depot53-1-2 depot53-1-3 depot54-1-1 depot54-1-2 depot54-1-3 depot55-1-1 depot55-1-2 depot56-1-1 depot56-1-2 depot56-1-3 depot57-1-1 depot57-1-2 depot57-1-3 depot65-1-1 depot65-1-2 depot66-1-1 depot66-1-2 depot66-1-3 depot67-1-1 depot67-1-2 depot68-1-1 depot68-1-2 depot68-1-3 depot69-1-1 depot69-1-2 depot70-1-1 depot70-1-2 depot71-1-1 depot71-1-2 depot72-1-1 depot72-1-2 depot72-1-3 depot73-1-1 depot73-1-2 depot73-1-3 depot74-1-1 depot74-1-2 depot74-1-3 depot75-1-1 depot75-1-2 depot76-1-1 depot76-1-2 depot77-1-1 depot77-1-2 depot78-1-1 depot78-1-2 depot79-1-1 depot79-1-2 depot80-1-1 depot80-1-2 depot81-1-1 depot81-1-2 depot82-1-1 depot82-1-2 depot82-1-3 depot83-1-1 depot83-1-2 depot84-1-1 depot84-1-2 depot85-1-1 depot85-1-2 depot85-1-3 depot86-1-1 depot86-1-2 depot86-1-3 depot87-1-1 depot87-1-2 depot88-1-1 depot88-1-2 depot88-1-3 depot88-2-1 depot88-2-2 depot88-2-3 depot88-3-1 depot88-3-2 depot88-3-3 container-0-0 container-0-1 container-0-2 container-0-3 container-1-0 container-1-1 container-1-2 container-1-3 container-2-0 container-2-1 container-2-2 container-2-3 container-3-0 container-3-1 container-3-2 container-3-3 container-4-0 container-4-1 container-4-2 container-4-3 container-5-0 container-5-1 container-5-2 container-5-3 container-6-0 container-6-1 container-6-2 container-6-3 container-7-0 container-7-1 container-7-2 container-7-3 container-8-0 container-8-1 container-8-2 container-8-3 container-9-0 container-9-1 container-9-2 container-9-3 container-10-0 container-10-1 container-10-2 container-10-3 container-11-0 container-11-1 container-11-2 container-11-3 - storearea
...
(:init
	...
	(connected transit5 depot70-1-2)
	(connected transit5 depot71-1-1)
	(connected transit6 depot72-1-3)
	(connected transit6 depot73-1-1)
	(connected transit7 depot73-1-3)
	(connected transit7 depot74-1-1)
	...
	(connected transit15 depot81-1-2)
	(connected transit15 depot82-1-1)
	...
	(connected depot54-1-3 loadarea)
	(connected loadarea depot54-1-3)
	...
	(connected depot73-1-3 loadarea)
	(connected loadarea depot73-1-3)
	...
	(connected depot86-1-3 loadarea)
	(connected loadarea depot86-1-3)
	(connected depot87-1-2 loadarea)
	(connected loadarea depot87-1-2)
	(connected depot88-3-1 loadarea)
	(connected loadarea depot88-3-1)  
	(clear depot48-1-1)
	(clear depot48-1-2)
	(clear depot50-1-1)
	(clear depot50-1-2)
	...
	(available hoist2)
	(at hoist3 depot52-1-2)
	(available hoist3)
	(at hoist4 depot52-1-3)
	(available hoist4)
	(at hoist5 depot52-1-1)
	(available hoist5)
	(at hoist6 depot54-1-2)
	(available hoist6)
	(at hoist7 depot56-1-2)
	(available hoist7)
	(at hoist8 depot56-1-1)
	(available hoist8)
	(at hoist9 depot57-1-1)
	(available hoist9)
	(at hoist10 depot57-1-3)
	(available hoist10)
	(at hoist11 depot57-1-2)
	(available hoist11)
	(at hoist12 depot70-1-2)
	(available hoist12)
	(at hoist13 depot70-1-1)
	(available hoist13)
	(at hoist14 depot75-1-1)
	(available hoist14)
	(at hoist15 depot77-1-2)
	(available hoist15)
	(at hoist16 depot78-1-2)
	(available hoist16)
	(at hoist17 depot78-1-1)
	(available hoist17)
	(at hoist18 depot81-1-2)
	(available hoist18)
	(at hoist19 depot81-1-1)
	(available hoist19)
	(at hoist20 depot83-1-2)
	(available hoist20)
	(at hoist21 depot86-1-3)
	(available hoist21)
	(at hoist22 depot86-1-2)
	(available hoist22))
