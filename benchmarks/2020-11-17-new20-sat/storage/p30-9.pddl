...
;
; Map of the Depots:                                                                                                                             
; *00=1* 2*2 3*=*44 *5=6*=7* 88*=99* *A=B*B=C*=D* E*=*F G*G=*H=*I *J=K* L*L *M=*N *O=P*=Q* R* SS* T* U* V*=WW* XXXXX         
;                                                                                                              XXXXX         
;                                                                                                              XX  *         
;-------------------------------------------------------------------------------------------------------------------         
; 48: depot48 area
...
(:objects
	depot48-1-1 depot48-1-2 depot48-1-3 depot49-1-1 depot49-1-2 depot50-1-1 depot50-1-2 depot50-1-3 depot51-1-1 depot51-1-2 depot52-1-1 depot52-1-2 depot52-1-3 depot53-1-1 depot53-1-2 depot54-1-1 depot54-1-2 depot55-1-1 depot55-1-2 depot56-1-1 depot56-1-2 depot56-1-3 depot57-1-1 depot57-1-2 depot57-1-3 depot65-1-1 depot65-1-2 depot66-1-1 depot66-1-2 depot66-1-3 depot67-1-1 depot67-1-2 depot68-1-1 depot68-1-2 depot69-1-1 depot69-1-2 depot70-1-1 depot70-1-2 depot71-1-1 depot71-1-2 depot71-1-3 depot72-1-1 depot72-1-2 depot73-1-1 depot73-1-2 depot74-1-1 depot74-1-2 depot75-1-1 depot75-1-2 depot76-1-1 depot76-1-2 depot76-1-3 depot77-1-1 depot77-1-2 depot78-1-1 depot78-1-2 depot79-1-1 depot79-1-2 depot80-1-1 depot80-1-2 depot81-1-1 depot81-1-2 depot82-1-1 depot82-1-2 depot83-1-1 depot83-1-2 depot83-1-3 depot84-1-1 depot84-1-2 depot85-1-1 depot85-1-2 depot86-1-1 depot86-1-2 depot87-1-1 depot87-1-2 depot87-1-3 depot88-1-1 depot88-1-2 depot88-1-3 depot88-1-4 depot88-1-5 depot88-2-1 depot88-2-2 depot88-2-3 depot88-2-4 depot88-2-5 depot88-3-1 depot88-3-2 depot88-3-5 container-0-0 container-0-1 container-0-2 container-0-3 container-1-0 container-1-1 container-1-2 container-1-3 container-2-0 container-2-1 container-2-2 container-2-3 container-3-0 container-3-1 container-3-2 container-3-3 container-4-0 container-4-1 container-4-2 container-4-3 container-5-0 container-5-1 container-5-2 container-5-3 container-6-0 container-6-1 container-6-2 container-6-3 container-7-0 container-7-1 container-7-2 container-7-3 container-8-0 container-8-1 container-8-2 container-8-3 container-9-0 container-9-1 container-9-2 container-9-3 container-10-0 container-10-1 container-10-2 container-10-3 container-11-0 container-11-1 container-11-2 container-11-3 - storearea
...
(:init
	...
	(connected depot87-1-2 depot87-1-3)
	(connected depot87-1-2 depot87-1-1)
	(connected depot87-1-3 depot87-1-2)
	(connected depot88-1-1 depot88-2-1)
	(connected depot88-1-1 depot88-1-2)
	(connected depot88-1-2 depot88-2-2)
	(connected depot88-1-2 depot88-1-3)
	(connected depot88-1-2 depot88-1-1)
	(connected depot88-1-3 depot88-2-3)
	(connected depot88-1-3 depot88-1-4)
	(connected depot88-1-3 depot88-1-2)
	(connected depot88-1-4 depot88-2-4)
	(connected depot88-1-4 depot88-1-5)
	(connected depot88-1-4 depot88-1-3)
	(connected depot88-1-5 depot88-2-5)
	(connected depot88-1-5 depot88-1-4)
	(connected depot88-2-1 depot88-1-1)
	(connected depot88-2-1 depot88-3-1)
	(connected depot88-2-1 depot88-2-2)
	(connected depot88-2-2 depot88-1-2)
	(connected depot88-2-2 depot88-3-2)
	(connected depot88-2-2 depot88-2-3)
	(connected depot88-2-2 depot88-2-1)
	(connected depot88-2-3 depot88-1-3)
	(connected depot88-2-3 depot88-2-4)
	(connected depot88-2-3 depot88-2-2)
	(connected depot88-2-4 depot88-1-4)
	(connected depot88-2-4 depot88-2-5)
	(connected depot88-2-4 depot88-2-3)
	(connected depot88-2-5 depot88-1-5)
	(connected depot88-2-5 depot88-3-5)
	(connected depot88-2-5 depot88-2-4)
	(connected depot88-3-1 depot88-2-1)
	(connected depot88-3-1 depot88-3-2)
	(connected depot88-3-2 depot88-2-2)
	(connected depot88-3-2 depot88-3-1)
	(connected depot88-3-5 depot88-2-5)
	...
	(connected transit3 depot54-1-2)
	(connected transit3 depot55-1-1)
	(connected transit4 depot56-1-3)
	(connected transit4 depot57-1-1)
	(connected transit5 depot65-1-2)
	(connected transit5 depot66-1-1)
	(connected transit6 depot66-1-3)
	(connected transit6 depot67-1-1)
	(connected transit7 depot67-1-2)
	(connected transit7 depot68-1-1)
	(connected transit8 depot69-1-2)
	(connected transit8 depot70-1-1)
	(connected transit9 depot71-1-3)
	(connected transit9 depot72-1-1)
	(connected transit10 depot72-1-2)
	(connected transit10 depot73-1-1)
	(connected transit11 depot74-1-2)
	(connected transit11 depot75-1-1)
	(connected transit12 depot77-1-2)
	(connected transit12 depot78-1-1)
	(connected transit13 depot79-1-2)
	(connected transit13 depot80-1-1)
	(connected transit14 depot80-1-2)
	(connected transit14 depot81-1-1)
	(connected transit15 depot86-1-2)
	(connected transit15 depot87-1-1)
	...
	(in depot87-1-3 depot87)
	(in depot88-1-1 depot88)
	(in depot88-1-2 depot88)
	(in depot88-1-3 depot88)
	(in depot88-1-4 depot88)
	(in depot88-1-5 depot88)
	(in depot88-2-1 depot88)
	(in depot88-2-2 depot88)
	(in depot88-2-3 depot88)
	(in depot88-2-4 depot88)
	(in depot88-2-5 depot88)
	(in depot88-3-1 depot88)
	(in depot88-3-2 depot88)
	(in depot88-3-5 depot88)
	...
	(connected depot69-1-2 loadarea)
	(connected loadarea depot69-1-2)
	(connected depot70-1-1 loadarea)
	(connected loadarea depot70-1-1)
	(connected depot71-1-2 loadarea)
	(connected loadarea depot71-1-2)
	...
	(connected depot81-1-2 loadarea)
	(connected loadarea depot81-1-2)
	(connected depot82-1-2 loadarea)
	(connected loadarea depot82-1-2)
	(connected depot83-1-3 loadarea)
	(connected loadarea depot83-1-3)
	(connected depot84-1-2 loadarea)
	(connected loadarea depot84-1-2)
	(connected depot85-1-2 loadarea)
	(connected loadarea depot85-1-2)
	(connected depot86-1-2 loadarea)
	(connected loadarea depot86-1-2)
	(connected depot87-1-3 loadarea)
	(connected loadarea depot87-1-3)
	(connected depot88-3-5 loadarea)
	(connected loadarea depot88-3-5)  
	(clear depot48-1-1)
	(clear depot49-1-1)
	(clear depot49-1-2)
	(clear depot50-1-2)
	...
	(available hoist3)
	(at hoist4 depot55-1-1)
	(available hoist4)
	(at hoist5 depot66-1-2)
	(available hoist5)
	(at hoist6 depot69-1-1)
	(available hoist6)
	(at hoist7 depot69-1-2)
	(available hoist7)
	(at hoist8 depot72-1-2)
	(available hoist8)
	(at hoist9 depot75-1-1)
	(available hoist9)
	(at hoist10 depot76-1-3)
	(available hoist10)
	(at hoist11 depot77-1-2)
	(available hoist11)
	(at hoist12 depot77-1-1)
	(available hoist12)
	(at hoist13 depot78-1-2)
	(available hoist13)
	(at hoist14 depot79-1-1)
	(available hoist14)
	(at hoist15 depot81-1-2)
	(available hoist15)
	(at hoist16 depot83-1-3)
	(available hoist16)
	(at hoist17 depot83-1-1)
	(available hoist17)
	(at hoist18 depot84-1-2)
	(available hoist18)
	(at hoist19 depot84-1-1)
	(available hoist19)
	(at hoist20 depot85-1-2)
	(available hoist20)
	(at hoist21 depot86-1-2)
	(available hoist21)
	(at hoist22 depot87-1-2)
	(available hoist22))
