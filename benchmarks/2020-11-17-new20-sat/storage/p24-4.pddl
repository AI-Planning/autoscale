...
;
; Map of the Depots:                                                                                                       
; 0*=11*=2*2 *3 4*=55*=*6 7*7 8*=9*=A*A=B*=C*C *DD=*EE=F* *G=*H=I*=J*J=*K L*L=MM*=N* *O P*=*Q=RRRR     
;                                                                                             RRR*     
;-------------------------------------------------------------------------------------------------     
; 48: depot48 area
; 49: depot49 area
...
(:objects
	depot48-1-1 depot48-1-2 depot49-1-1 depot49-1-2 depot49-1-3 depot50-1-1 depot50-1-2 depot50-1-3 depot51-1-1 depot51-1-2 depot52-1-1 depot52-1-2 depot53-1-1 depot53-1-2 depot53-1-3 depot54-1-1 depot54-1-2 depot55-1-1 depot55-1-2 depot55-1-3 depot56-1-1 depot56-1-2 depot57-1-1 depot57-1-2 depot65-1-1 depot65-1-2 depot65-1-3 depot66-1-1 depot66-1-2 depot67-1-1 depot67-1-2 depot67-1-3 depot68-1-1 depot68-1-2 depot68-1-3 depot69-1-1 depot69-1-2 depot69-1-3 depot70-1-1 depot70-1-2 depot71-1-1 depot71-1-2 depot72-1-1 depot72-1-2 depot73-1-1 depot73-1-2 depot74-1-1 depot74-1-2 depot74-1-3 depot75-1-1 depot75-1-2 depot76-1-1 depot76-1-2 depot76-1-3 depot77-1-1 depot77-1-2 depot77-1-3 depot78-1-1 depot78-1-2 depot79-1-1 depot79-1-2 depot80-1-1 depot80-1-2 depot81-1-1 depot81-1-2 depot82-1-1 depot82-1-2 depot82-1-3 depot82-1-4 depot82-2-1 depot82-2-2 depot82-2-3 depot82-2-4 container-0-0 container-0-1 container-0-2 container-0-3 container-1-0 container-1-1 container-1-2 container-1-3 container-2-0 container-2-1 container-2-2 container-2-3 container-3-0 container-3-1 container-3-2 container-3-3 container-4-0 container-4-1 container-4-2 container-4-3 container-5-0 container-5-1 container-5-2 container-5-3 container-6-0 container-6-1 container-6-2 container-6-3 container-7-0 container-7-1 container-7-2 container-7-3 container-8-0 container-8-1 container-8-2 container-8-3 container-9-0 container-9-1 container-9-2 - storearea
	...
	container0 container1 container2 container3 container4 container5 container6 container7 container8 container9 - container
...
(:init
	...
	(connected depot82-1-3 depot82-2-3)
	(connected depot82-1-3 depot82-1-4)
	(connected depot82-1-3 depot82-1-2)
	(connected depot82-1-4 depot82-2-4)
	(connected depot82-1-4 depot82-1-3)
	(connected depot82-2-1 depot82-1-1)
	(connected depot82-2-1 depot82-2-2)
	(connected depot82-2-2 depot82-1-2)
	(connected depot82-2-2 depot82-2-3)
	(connected depot82-2-2 depot82-2-1)
	(connected depot82-2-3 depot82-1-3)
	(connected depot82-2-3 depot82-2-4)
	(connected depot82-2-3 depot82-2-2)
	(connected depot82-2-4 depot82-1-4)
	(connected depot82-2-4 depot82-2-3)
	...
	(connected transit4 depot56-1-2)
	(connected transit4 depot57-1-1)
	(connected transit5 depot57-1-2)
	(connected transit5 depot65-1-1)
	(connected transit6 depot65-1-3)
	(connected transit6 depot66-1-1)
	(connected transit7 depot66-1-2)
	(connected transit7 depot67-1-1)
	(connected transit8 depot68-1-3)
	(connected transit8 depot69-1-1)
	(connected transit9 depot69-1-3)
	(connected transit9 depot70-1-1)
	(connected transit10 depot71-1-2)
	...
	(connected transit13 depot74-1-3)
	(connected transit13 depot75-1-1)
	...
	(connected transit16 depot80-1-2)
	(connected transit16 depot81-1-1)
	(connected transit17 depot81-1-2)
	(connected transit17 depot82-1-1)
	...
	(in depot82-1-4 depot82)
	(in depot82-2-1 depot82)
	(in depot82-2-2 depot82)
	(in depot82-2-3 depot82)
	(in depot82-2-4 depot82)
	...
	(connected depot82-2-4 loadarea)
	(connected loadarea depot82-2-4)  
	(clear depot48-1-1)
	(clear depot48-1-2)
	(clear depot49-1-1)
	(clear depot49-1-3)
	...
	(available hoist3)
	(at hoist4 depot52-1-1)
	(available hoist4)
	(at hoist5 depot55-1-3)
	(available hoist5)
	(at hoist6 depot56-1-1)
	(available hoist6)
	(at hoist7 depot57-1-2)
	(available hoist7)
	(at hoist8 depot57-1-1)
	(available hoist8)
	(at hoist9 depot66-1-1)
	(available hoist9)
	(at hoist10 depot70-1-1)
	(available hoist10)
	(at hoist11 depot70-1-2)
	(available hoist11)
	(at hoist12 depot71-1-1)
	(available hoist12)
	(at hoist13 depot77-1-1)
	(available hoist13)
	(at hoist14 depot77-1-3)
	(available hoist14)
	(at hoist15 depot77-1-2)
	(available hoist15)
	(at hoist16 depot78-1-2)
	(available hoist16)
	(at hoist17 depot80-1-2)
	(available hoist17)
	(at hoist18 depot80-1-1)
	(available hoist18))
