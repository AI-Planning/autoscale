...
;
; Map of the Depots:                                                                                                                          
; 0*0 *11 2*2 *3=4*=5*=66* 77* 8*=9*=A*A BB* C*C *D=EE*=F*=*G=HH*=*II=JJ* *K *LL=M*=N*N O*=P* QQ*=*R *SS TT* UU* *V WWW   
;                                                                                                                   W *   
;----------------------------------------------------------------------------------------------------------------------   
; 48: depot48 area
; 49: depot49 area
...
(:init
	...
	(available hoist12)
	(at hoist13 depot73-1-3)
	(available hoist13)
	(at hoist14 depot73-1-2)
	(available hoist14)
	(at hoist15 depot74-1-3)
	(available hoist15)
	(at hoist16 depot75-1-2)
	(available hoist16)
	(at hoist17 depot75-1-1)
	(available hoist17)
