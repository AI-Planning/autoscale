...
;
; Map of the Depots:                                                                                                                          
; 0* *1=2*2=3*=44* *5 6*=*7=88* 99* *A=BB* C* D*D=E*E=F*F=G*G HH*=*I=*J K*=*LL=*MM N* *O=P*P *QQ=*RR=S*=*TT=U*=*VV=WWW    
;                                                                                                                  WW*    
;---------------------------------------------------------------------------------------------------------------------    
; 48: depot48 area
; 49: depot49 area
...
(:objects
	depot48-1-1 depot48-1-2 depot49-1-1 depot49-1-2 depot50-1-1 depot50-1-2 depot50-1-3 depot51-1-1 depot51-1-2 depot52-1-1 depot52-1-2 depot52-1-3 depot53-1-1 depot53-1-2 depot54-1-1 depot54-1-2 depot55-1-1 depot55-1-2 depot56-1-1 depot56-1-2 depot56-1-3 depot57-1-1 depot57-1-2 depot57-1-3 depot65-1-1 depot65-1-2 depot66-1-1 depot66-1-2 depot66-1-3 depot67-1-1 depot67-1-2 depot68-1-1 depot68-1-2 depot68-1-3 depot69-1-1 depot69-1-2 depot69-1-3 depot70-1-1 depot70-1-2 depot70-1-3 depot71-1-1 depot71-1-2 depot71-1-3 depot72-1-1 depot72-1-2 depot72-1-3 depot73-1-1 depot73-1-2 depot74-1-1 depot74-1-2 depot75-1-1 depot75-1-2 depot76-1-1 depot76-1-2 depot76-1-3 depot77-1-1 depot77-1-2 depot77-1-3 depot78-1-1 depot78-1-2 depot79-1-1 depot79-1-2 depot80-1-1 depot80-1-2 depot80-1-3 depot81-1-1 depot81-1-2 depot81-1-3 depot82-1-1 depot82-1-2 depot82-1-3 depot83-1-1 depot83-1-2 depot84-1-1 depot84-1-2 depot84-1-3 depot85-1-1 depot85-1-2 depot86-1-1 depot86-1-2 depot86-1-3 depot87-1-1 depot87-1-2 depot87-1-3 depot87-2-1 depot87-2-2 depot87-2-3 container-0-0 container-0-1 container-0-2 container-0-3 container-1-0 container-1-1 container-1-2 container-1-3 container-2-0 container-2-1 container-2-2 container-2-3 container-3-0 container-3-1 container-3-2 container-3-3 container-4-0 container-4-1 container-4-2 container-4-3 container-5-0 container-5-1 container-5-2 container-5-3 container-6-0 container-6-1 container-6-2 container-6-3 container-7-0 container-7-1 container-7-2 container-7-3 container-8-0 container-8-1 container-8-2 container-8-3 container-9-0 container-9-1 container-9-2 container-9-3 container-10-0 container-10-1 container-10-2 container-10-3 container-11-0 container-11-1 container-11-2 - storearea
	...
	depot48 depot49 depot50 depot51 depot52 depot53 depot54 depot55 depot56 depot57 depot65 depot66 depot67 depot68 depot69 depot70 depot71 depot72 depot73 depot74 depot75 depot76 depot77 depot78 depot79 depot80 depot81 depot82 depot83 depot84 depot85 depot86 depot87 - depot
	loadarea transit0 transit1 transit2 transit3 transit4 transit5 transit6 transit7 transit8 transit9 transit10 transit11 transit12 transit13 transit14 transit15 transit16 transit17 transit18 transit19 - transitarea)
...
(:init
	...
	(connected depot87-1-3 depot87-2-3)
	...
	(connected depot87-2-2 depot87-2-3)
	(connected depot87-2-2 depot87-2-1)
	(connected depot87-2-3 depot87-1-3)
	(connected depot87-2-3 depot87-2-2)
	(connected transit0 depot49-1-2)
	(connected transit0 depot50-1-1)
	(connected transit1 depot50-1-3)
	...
	(connected transit6 depot68-1-3)
	(connected transit6 depot69-1-1)
	(connected transit7 depot69-1-3)
	(connected transit7 depot70-1-1)
	(connected transit8 depot70-1-3)
	(connected transit8 depot71-1-1)
	(connected transit9 depot72-1-3)
	(connected transit9 depot73-1-1)
	(connected transit10 depot73-1-2)
	(connected transit10 depot74-1-1)
	(connected transit11 depot75-1-2)
	(connected transit11 depot76-1-1)
	(connected transit12 depot76-1-3)
	(connected transit12 depot77-1-1)
	...
	(connected transit15 depot82-1-3)
	(connected transit15 depot83-1-1)
	(connected transit16 depot83-1-2)
	(connected transit16 depot84-1-1)
	(connected transit17 depot84-1-3)
	(connected transit17 depot85-1-1)
	(connected transit18 depot85-1-2)
	(connected transit18 depot86-1-1)
	(connected transit19 depot86-1-3)
	(connected transit19 depot87-1-1)
	...
	(connected depot66-1-3 loadarea)
	(connected loadarea depot66-1-3)
	...
	(connected depot72-1-3 loadarea)
	(connected loadarea depot72-1-3)
	...
	(connected depot87-2-3 loadarea)
	(connected loadarea depot87-2-3)  
	(clear depot48-1-1)
	(clear depot48-1-2)
	(clear depot50-1-1)
	(clear depot50-1-2)
	...
	(available hoist1)
	(at hoist2 depot52-1-2)
	(available hoist2)
	(at hoist3 depot53-1-2)
	(available hoist3)
	(at hoist4 depot53-1-1)
	(available hoist4)
	(at hoist5 depot55-1-2)
	(available hoist5)
	(at hoist6 depot57-1-1)
	(available hoist6)
	(at hoist7 depot66-1-2)
	(available hoist7)
	(at hoist8 depot66-1-3)
	(available hoist8)
	(at hoist9 depot67-1-2)
	(available hoist9)
	(at hoist10 depot67-1-1)
	(available hoist10)
	(at hoist11 depot69-1-2)
	(available hoist11)
	(at hoist12 depot70-1-1)
	(available hoist12)
	(at hoist13 depot72-1-3)
	(available hoist13)
	(at hoist14 depot72-1-2)
	(available hoist14)
	(at hoist15 depot73-1-1)
	(available hoist15)
	(at hoist16 depot76-1-2)
	(available hoist16)
	(at hoist17 depot80-1-3)
	(available hoist17)
	(at hoist18 depot83-1-2)
	(available hoist18)
	(at hoist19 depot84-1-2)
	(available hoist19)
	(at hoist20 depot86-1-2)
	(available hoist20)
	(at hoist21 depot86-1-1)
	(available hoist21))
