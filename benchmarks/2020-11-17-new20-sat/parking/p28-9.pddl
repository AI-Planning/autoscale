(define   (problem parking)
  ...
  (:init
    ...
    (behind-car car_94 car_40)
    (car-clear car_94)
    (at-curb car_80)
    (at-curb-num car_80 curb_04)
    (behind-car car_19 car_80)
    (car-clear car_19)
    (at-curb car_51)
    (at-curb-num car_51 curb_05)
    (behind-car car_07 car_51)
    (car-clear car_07)
    (at-curb car_45)
    (at-curb-num car_45 curb_06)
    (behind-car car_87 car_45)
    (car-clear car_87)
    (at-curb car_65)
    (at-curb-num car_65 curb_07)
    (behind-car car_38 car_65)
    (car-clear car_38)
    (at-curb car_96)
    (at-curb-num car_96 curb_08)
    (behind-car car_60 car_96)
    (car-clear car_60)
    (at-curb car_49)
    ...
    (car-clear car_81)
    (at-curb car_88)
    (at-curb-num car_88 curb_13)
    (behind-car car_85 car_88)
    (car-clear car_85)
    (at-curb car_43)
    ...
    (car-clear car_00)
    (at-curb car_55)
    (at-curb-num car_55 curb_15)
    (behind-car car_53 car_55)
    (car-clear car_53)
    (at-curb car_52)
    (at-curb-num car_52 curb_16)
    (behind-car car_66 car_52)
    (car-clear car_66)
    (at-curb car_30)
    ...
    (behind-car car_74 car_18)
    (car-clear car_74)
    (at-curb car_95)
    (at-curb-num car_95 curb_20)
    (behind-car car_54 car_95)
    (car-clear car_54)
    (at-curb car_05)
    (at-curb-num car_05 curb_21)
    (behind-car car_69 car_05)
    (car-clear car_69)
    (at-curb car_44)
    ...
    (behind-car car_77 car_13)
    (car-clear car_77)
    (at-curb car_50)
    (at-curb-num car_50 curb_25)
    (behind-car car_91 car_50)
    (car-clear car_91)
    (at-curb car_09)
    ...
    (behind-car car_62 car_64)
    (car-clear car_62)
    (at-curb car_76)
    (at-curb-num car_76 curb_28)
    (behind-car car_58 car_76)
    (car-clear car_58)
    (at-curb car_78)
    (at-curb-num car_78 curb_29)
    (behind-car car_37 car_78)
    (car-clear car_37)
    (at-curb car_92)
    (at-curb-num car_92 curb_30)
    (behind-car car_59 car_92)
    (car-clear car_59)
    (at-curb car_83)
    ...
    (car-clear car_10)
    (at-curb car_84)
    (at-curb-num car_84 curb_34)
    (behind-car car_29 car_84)
    (car-clear car_29)
    (at-curb car_12)
    (at-curb-num car_12 curb_35)
    (behind-car car_11 car_12)
    (car-clear car_11)
    (at-curb car_61)
    (at-curb-num car_61 curb_36)
    (behind-car car_01 car_61)
    (car-clear car_01)
    (at-curb car_41)
    (at-curb-num car_41 curb_37)
    (behind-car car_93 car_41)
    (car-clear car_93)
    (at-curb car_48)
    (at-curb-num car_48 curb_38)
    (behind-car car_16 car_48)
    (car-clear car_16)
    (at-curb car_08)
    (at-curb-num car_08 curb_39)
    (behind-car car_42 car_08)
    (car-clear car_42)
    (at-curb car_71)
    (at-curb-num car_71 curb_40)
    (behind-car car_23 car_71)
    (car-clear car_23)
    (at-curb car_46)
    ...
    (car-clear car_97)
    (at-curb car_90)
    (at-curb-num car_90 curb_42)
    (behind-car car_68 car_90)
    (car-clear car_68)
    (at-curb car_03)
    (at-curb-num car_03 curb_43)
    ...
    (car-clear car_31)
    (at-curb car_72)
    (at-curb-num car_72 curb_45)
    (behind-car car_36 car_72)
    (car-clear car_36)
    (at-curb car_82)
    (at-curb-num car_82 curb_46)
    (behind-car car_28 car_82)
    (car-clear car_28)
    (at-curb car_63)
    (at-curb-num car_63 curb_47)
    (behind-car car_02 car_63)
    (car-clear car_02)
    (at-curb car_20)
    (at-curb-num car_20 curb_48)
    (behind-car car_79 car_20)
    (car-clear car_79)
    (curb-clear curb_49)
    (curb-clear curb_50)
  )
...
; =========== INIT =========== 
;  curb_00: car_67 car_17 
;  curb_01: car_35 car_15 
;  curb_02: car_04 car_56 
;  curb_03: car_40 car_94 
;  curb_04: car_80 car_19 
;  curb_05: car_51 car_07 
;  curb_06: car_45 car_87 
;  curb_07: car_65 car_38 
;  curb_08: car_96 car_60 
;  curb_09: car_49 car_33 
;  curb_10: car_47 car_26 
;  curb_11: car_21 car_89 
;  curb_12: car_34 car_81 
;  curb_13: car_88 car_85 
;  curb_14: car_43 car_00 
;  curb_15: car_55 car_53 
;  curb_16: car_52 car_66 
;  curb_17: car_30 car_70 
;  curb_18: car_57 car_39 
;  curb_19: car_18 car_74 
;  curb_20: car_95 car_54 
;  curb_21: car_05 car_69 
;  curb_22: car_44 car_86 
;  curb_23: car_06 car_24 
;  curb_24: car_13 car_77 
;  curb_25: car_50 car_91 
;  curb_26: car_09 car_25 
;  curb_27: car_64 car_62 
;  curb_28: car_76 car_58 
;  curb_29: car_78 car_37 
;  curb_30: car_92 car_59 
;  curb_31: car_83 car_75 
;  curb_32: car_27 car_73 
;  curb_33: car_32 car_10 
;  curb_34: car_84 car_29 
;  curb_35: car_12 car_11 
;  curb_36: car_61 car_01 
;  curb_37: car_41 car_93 
;  curb_38: car_48 car_16 
;  curb_39: car_08 car_42 
;  curb_40: car_71 car_23 
;  curb_41: car_46 car_97 
;  curb_42: car_90 car_68 
;  curb_43: car_03 car_22 
;  curb_44: car_14 car_31 
;  curb_45: car_72 car_36 
;  curb_46: car_82 car_28 
;  curb_47: car_63 car_02 
;  curb_48: car_20 car_79 
;  curb_49: 
;  curb_50: 
; ========== /INIT =========== 
