(define   (problem parking)
  ...
  (:init
    ...
    (behind-car car_30 car_83)
    (car-clear car_30)
    (at-curb car_80)
    (at-curb-num car_80 curb_02)
    (behind-car car_71 car_80)
    (car-clear car_71)
    (at-curb car_03)
    (at-curb-num car_03 curb_03)
    (behind-car car_90 car_03)
    (car-clear car_90)
    (at-curb car_97)
    (at-curb-num car_97 curb_04)
    (behind-car car_89 car_97)
    (car-clear car_89)
    (at-curb car_08)
    (at-curb-num car_08 curb_05)
    (behind-car car_76 car_08)
    (car-clear car_76)
    (at-curb car_18)
    ...
    (behind-car car_79 car_64)
    (car-clear car_79)
    (at-curb car_65)
    (at-curb-num car_65 curb_09)
    (behind-car car_73 car_65)
    (car-clear car_73)
    (at-curb car_75)
    ...
    (car-clear car_46)
    (at-curb car_96)
    (at-curb-num car_96 curb_11)
    (behind-car car_19 car_96)
    (car-clear car_19)
    (at-curb car_91)
    (at-curb-num car_91 curb_12)
    (behind-car car_78 car_91)
    (car-clear car_78)
    (at-curb car_59)
    (at-curb-num car_59 curb_13)
    (behind-car car_87 car_59)
    (car-clear car_87)
    (at-curb car_48)
    (at-curb-num car_48 curb_14)
    (behind-car car_20 car_48)
    (car-clear car_20)
    (at-curb car_28)
    ...
    (behind-car car_62 car_61)
    (car-clear car_62)
    (at-curb car_94)
    (at-curb-num car_94 curb_18)
    (behind-car car_07 car_94)
    (car-clear car_07)
    (at-curb car_10)
    ...
    (car-clear car_15)
    (at-curb car_26)
    (at-curb-num car_26 curb_21)
    (behind-car car_13 car_26)
    (car-clear car_13)
    (at-curb car_88)
    (at-curb-num car_88 curb_22)
    ...
    (car-clear car_56)
    (at-curb car_16)
    (at-curb-num car_16 curb_24)
    (behind-car car_33 car_16)
    (car-clear car_33)
    (at-curb car_52)
    (at-curb-num car_52 curb_25)
    (behind-car car_41 car_52)
    (car-clear car_41)
    (at-curb car_66)
    ...
    (car-clear car_49)
    (at-curb car_92)
    (at-curb-num car_92 curb_27)
    (behind-car car_74 car_92)
    (car-clear car_74)
    (at-curb car_42)
    (at-curb-num car_42 curb_28)
    ...
    (car-clear car_23)
    (at-curb car_70)
    (at-curb-num car_70 curb_33)
    (behind-car car_47 car_70)
    (car-clear car_47)
    (at-curb car_44)
    (at-curb-num car_44 curb_34)
    (behind-car car_01 car_44)
    (car-clear car_01)
    (at-curb car_02)
    (at-curb-num car_02 curb_35)
    (behind-car car_27 car_02)
    (car-clear car_27)
    (at-curb car_93)
    (at-curb-num car_93 curb_36)
    (behind-car car_37 car_93)
    (car-clear car_37)
    (at-curb car_40)
    (at-curb-num car_40 curb_37)
    (behind-car car_43 car_40)
    (car-clear car_43)
    (at-curb car_31)
    (at-curb-num car_31 curb_38)
    ...
    (car-clear car_45)
    (at-curb car_72)
    (at-curb-num car_72 curb_42)
    (behind-car car_69 car_72)
    (car-clear car_69)
    (at-curb car_53)
    (at-curb-num car_53 curb_43)
    (behind-car car_11 car_53)
    (car-clear car_11)
    (at-curb car_63)
    (at-curb-num car_63 curb_44)
    (behind-car car_57 car_63)
    (car-clear car_57)
    (at-curb car_54)
    (at-curb-num car_54 curb_45)
    (behind-car car_14 car_54)
    (car-clear car_14)
    (at-curb car_12)
    (at-curb-num car_12 curb_46)
    (behind-car car_58 car_12)
    (car-clear car_58)
    (at-curb car_21)
    (at-curb-num car_21 curb_47)
    (behind-car car_82 car_21)
    (car-clear car_82)
    (at-curb car_04)
    (at-curb-num car_04 curb_48)
    (car-clear car_04)
    (at-curb car_84)
    (at-curb-num car_84 curb_49)
    (car-clear car_84)
    (curb-clear curb_50)
  )
  (:goal
...
; =========== INIT =========== 
;  curb_00: car_25 car_35 
;  curb_01: car_83 car_30 
;  curb_02: car_80 car_71 
;  curb_03: car_03 car_90 
;  curb_04: car_97 car_89 
;  curb_05: car_08 car_76 
;  curb_06: car_18 car_09 
;  curb_07: car_86 car_81 
;  curb_08: car_64 car_79 
;  curb_09: car_65 car_73 
;  curb_10: car_75 car_46 
;  curb_11: car_96 car_19 
;  curb_12: car_91 car_78 
;  curb_13: car_59 car_87 
;  curb_14: car_48 car_20 
;  curb_15: car_28 car_68 
;  curb_16: car_39 car_29 
;  curb_17: car_61 car_62 
;  curb_18: car_94 car_07 
;  curb_19: car_10 car_24 
;  curb_20: car_85 car_15 
;  curb_21: car_26 car_13 
;  curb_22: car_88 car_36 
;  curb_23: car_60 car_56 
;  curb_24: car_16 car_33 
;  curb_25: car_52 car_41 
;  curb_26: car_66 car_49 
;  curb_27: car_92 car_74 
;  curb_28: car_42 car_51 
;  curb_29: car_55 car_50 
;  curb_30: car_00 car_38 
;  curb_31: car_34 car_67 
;  curb_32: car_77 car_23 
;  curb_33: car_70 car_47 
;  curb_34: car_44 car_01 
;  curb_35: car_02 car_27 
;  curb_36: car_93 car_37 
;  curb_37: car_40 car_43 
;  curb_38: car_31 car_32 
;  curb_39: car_05 car_95 
;  curb_40: car_06 car_22 
;  curb_41: car_17 car_45 
;  curb_42: car_72 car_69 
;  curb_43: car_53 car_11 
;  curb_44: car_63 car_57 
;  curb_45: car_54 car_14 
;  curb_46: car_12 car_58 
;  curb_47: car_21 car_82 
;  curb_48: car_04 
;  curb_49: car_84 
;  curb_50: 
; ========== /INIT =========== 
