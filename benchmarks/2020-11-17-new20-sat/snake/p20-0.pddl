(define (problem snake-empty-7x12-1-5-64-2038)
(:domain snake)
(:objects
...
(:init
 ...
 (isAdjacent pos6-11 pos6-10)
    (tailSnake pos3-5)
    (headSnake pos4-5)
    (nextSnake pos4-5 pos3-5)
    (blocked pos3-5)
 (blocked pos4-5)
    (spawn pos5-8)
 (nextSpawn pos1-8 dummyPoint)
 (nextSpawn pos5-8 pos5-6)
