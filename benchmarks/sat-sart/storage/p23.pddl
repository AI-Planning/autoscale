...
;
; Map of the Depots:                                                                                                
; 0000=11111=2222 3333=4444=5555=66666                                                          
; 0000 11111 2222 3333 4444 5555 66666                                                          
; 00*0 11*   22*2 33*  *44  55*  66666                                                          
;                                6*                                                             
;-------------------------------------                                                          
; 48: depot48 area
; 49: depot49 area
...
(:objects
	depot48-1-1 depot48-1-2 depot48-1-3 depot48-1-4 depot48-2-1 depot48-2-2 depot48-2-3 depot48-2-4 depot48-3-1 depot48-3-2 depot48-3-3 depot48-3-4 depot49-1-1 depot49-1-2 depot49-1-3 depot49-1-4 depot49-1-5 depot49-2-1 depot49-2-2 depot49-2-3 depot49-2-4 depot49-2-5 depot49-3-1 depot49-3-2 depot49-3-3 depot50-1-1 depot50-1-2 depot50-1-3 depot50-1-4 depot50-2-1 depot50-2-2 depot50-2-3 depot50-2-4 depot50-3-1 depot50-3-2 depot50-3-3 depot50-3-4 depot51-1-1 depot51-1-2 depot51-1-3 depot51-1-4 depot51-2-1 depot51-2-2 depot51-2-3 depot51-2-4 depot51-3-1 depot51-3-2 depot51-3-3 depot52-1-1 depot52-1-2 depot52-1-3 depot52-1-4 depot52-2-1 depot52-2-2 depot52-2-3 depot52-2-4 depot52-3-1 depot52-3-2 depot52-3-3 depot53-1-1 depot53-1-2 depot53-1-3 depot53-1-4 depot53-2-1 depot53-2-2 depot53-2-3 depot53-2-4 depot53-3-1 depot53-3-2 depot53-3-3 depot54-1-1 depot54-1-2 depot54-1-3 depot54-1-4 depot54-1-5 depot54-2-1 depot54-2-2 depot54-2-3 depot54-2-4 depot54-2-5 depot54-3-1 depot54-3-2 depot54-3-3 depot54-3-4 depot54-3-5 depot54-4-1 depot54-4-2 container-0-0 container-0-1 - storearea
...
(:init
	...
	(connected depot54-3-4 depot54-3-5)
	(connected depot54-3-4 depot54-3-3)
	(connected depot54-3-5 depot54-2-5)
	(connected depot54-3-5 depot54-3-4)
	(connected depot54-4-1 depot54-3-1)
	(connected depot54-4-1 depot54-4-2)
	(connected depot54-4-2 depot54-3-2)
	(connected depot54-4-2 depot54-4-1)
	(connected transit0 depot48-1-4)
	(connected transit0 depot49-1-1)
	(connected transit1 depot49-1-5)
	...
	(in depot54-3-5 depot54)
	(in depot54-4-1 depot54)
	(in depot54-4-2 depot54)
	...
	(connected depot49-3-3 loadarea)
	(connected loadarea depot49-3-3)
	...
	(connected depot54-4-2 loadarea)
	(connected loadarea depot54-4-2)  
	(clear depot48-3-3)
	(clear depot48-1-2)
	(clear depot48-1-3)
	(clear depot48-1-4)
	...
	(available hoist3)
	(at hoist4 depot49-1-5)
	(available hoist4)
	(at hoist5 depot49-2-4)
	(available hoist5)
	(at hoist6 depot49-1-1)
	(available hoist6)
	(at hoist7 depot49-2-3)
	(available hoist7)
	(at hoist8 depot50-2-3)
	(available hoist8)
	(at hoist9 depot50-2-1)
	(available hoist9)
	(at hoist10 depot50-2-4)
	(available hoist10)
	(at hoist11 depot50-3-3)
	(available hoist11)
	(at hoist12 depot50-2-2)
	(available hoist12)
	(at hoist13 depot51-2-1)
	(available hoist13)
	(at hoist14 depot51-1-1)
	(available hoist14)
	(at hoist15 depot51-2-2)
	(available hoist15)
	(at hoist16 depot51-1-3)
	(available hoist16)
	(at hoist17 depot51-2-4)
	(available hoist17)
	(at hoist18 depot52-1-1)
	(available hoist18)
	(at hoist19 depot52-2-3)
	(available hoist19)
	(at hoist20 depot52-2-2)
	(available hoist20)
	(at hoist21 depot52-3-1)
	(available hoist21)
	(at hoist22 depot52-3-2)
	(available hoist22)
	(at hoist23 depot52-2-1)
	(available hoist23)
	(at hoist24 depot52-1-4)
	(available hoist24)
	(at hoist25 depot53-1-3)
	(available hoist25)
	(at hoist26 depot53-1-2)
	(available hoist26)
	(at hoist27 depot53-1-4)
	(available hoist27)
	(at hoist28 depot53-2-3)
	(available hoist28)
	(at hoist29 depot53-2-1)
	(available hoist29)
	(at hoist30 depot54-3-1)
	(available hoist30)
	(at hoist31 depot54-3-5)
	(available hoist31)
	(at hoist32 depot54-1-5)
	(available hoist32)
	(at hoist33 depot54-2-5)
	(available hoist33)
	(at hoist34 depot54-1-2)
	(available hoist34)
	(at hoist35 depot54-2-4)
	(available hoist35)
	(at hoist36 depot54-2-3)
	(available hoist36)
	(at hoist37 depot54-1-1)
	(available hoist37))
