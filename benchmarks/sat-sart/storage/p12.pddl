...
(:init
	...
	(connected depot54-3-3 loadarea)
	(connected loadarea depot54-3-3)  
	(clear depot48-2-2)
	(clear depot48-2-1)
	(clear depot48-2-3)
	(clear depot48-1-4)
	...
	(available hoist10)
	(at hoist11 depot51-2-1)
	(available hoist11)
	(at hoist12 depot51-1-2)
	(available hoist12)
	(at hoist13 depot51-1-4)
	(available hoist13)
	(at hoist14 depot52-2-1)
	(available hoist14)
	(at hoist15 depot52-2-2)
	(available hoist15)
	(at hoist16 depot52-1-3)
	(available hoist16)
	(at hoist17 depot53-2-1)
	(available hoist17)
	(at hoist18 depot53-2-2)
	(available hoist18)
	(at hoist19 depot53-1-4)
	(available hoist19)
	(at hoist20 depot54-3-3)
	(available hoist20))
