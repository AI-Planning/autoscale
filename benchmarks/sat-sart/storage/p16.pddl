...
;
; Map of the Depots:                                                                                   
; 00000 1111 22222 33333=4444=55555                                                
; 00000 1111 22222 33333 4444 55555                                                
; 00  * 11 * 22  * 33*   *44  555 *                                                
;----------------------------------                                                
; 48: depot48 area
...
(:objects
	depot48-1-1 depot48-1-2 depot48-1-3 depot48-1-4 depot48-1-5 depot48-2-1 depot48-2-2 depot48-2-3 depot48-2-4 depot48-2-5 depot48-3-1 depot48-3-2 depot48-3-5 depot49-1-1 depot49-1-2 depot49-1-3 depot49-1-4 depot49-2-1 depot49-2-2 depot49-2-3 depot49-2-4 depot49-3-1 depot49-3-2 depot49-3-4 depot50-1-1 depot50-1-2 depot50-1-3 depot50-1-4 depot50-1-5 depot50-2-1 depot50-2-2 depot50-2-3 depot50-2-4 depot50-2-5 depot50-3-1 depot50-3-2 depot50-3-5 depot51-1-1 depot51-1-2 depot51-1-3 depot51-1-4 depot51-1-5 depot51-2-1 depot51-2-2 depot51-2-3 depot51-2-4 depot51-2-5 depot51-3-1 depot51-3-2 depot51-3-3 depot52-1-1 depot52-1-2 depot52-1-3 depot52-1-4 depot52-2-1 depot52-2-2 depot52-2-3 depot52-2-4 depot52-3-1 depot52-3-2 depot52-3-3 depot53-1-1 depot53-1-2 depot53-1-3 depot53-1-4 depot53-1-5 depot53-2-1 depot53-2-2 depot53-2-3 depot53-2-4 depot53-2-5 depot53-3-1 depot53-3-2 depot53-3-3 depot53-3-5 container-0-0 container-0-1 - storearea
...
(:init
	...
	(connected depot48-3-5 loadarea)
	(connected loadarea depot48-3-5)
	(connected depot49-3-4 loadarea)
	(connected loadarea depot49-3-4)
	...
	(connected depot53-3-5 loadarea)
	(connected loadarea depot53-3-5)  
	(clear depot48-1-1)
	(clear depot48-1-2)
	(clear depot48-1-3)
	(clear depot48-1-4)
	...
	(available hoist7)
	(at hoist8 depot50-3-5)
	(available hoist8)
	(at hoist9 depot50-1-5)
	(available hoist9)
	(at hoist10 depot50-3-2)
	(available hoist10)
	(at hoist11 depot50-2-5)
	(available hoist11)
	(at hoist12 depot51-1-2)
	(available hoist12)
	(at hoist13 depot51-3-1)
	(available hoist13)
	(at hoist14 depot51-2-3)
	(available hoist14)
	(at hoist15 depot52-1-1)
	(available hoist15)
	(at hoist16 depot52-3-1)
	(available hoist16)
	(at hoist17 depot52-2-2)
	(available hoist17)
	(at hoist18 depot52-3-3)
	(available hoist18)
	(at hoist19 depot53-2-4)
	(available hoist19)
	(at hoist20 depot53-2-3)
	(available hoist20)
	(at hoist21 depot53-2-1)
	(available hoist21)
	(at hoist22 depot53-1-5)
	(available hoist22)
	(at hoist23 depot53-3-1)
	(available hoist23)
	(at hoist24 depot53-3-5)
	(available hoist24)
	(at hoist25 depot53-1-2)
	(available hoist25)
	(at hoist26 depot53-1-4)
	(available hoist26)
	(at hoist27 depot53-3-2)
	(available hoist27)
	(at hoist28 depot53-2-5)
	(available hoist28)
	(at hoist29 depot53-1-3)
	(available hoist29)
	(at hoist30 depot53-3-3)
	(available hoist30)
	(at hoist31 depot53-1-1)
	(available hoist31))
