; Transport two-cities-sequential-3nodes-1000size-3degree-100mindistance-3trucks-3packages-2022seed

(define (problem transport-two-cities-sequential-3nodes-1000size-3degree-100mindistance-3trucks-3packages-2022seed)
 (:domain transport)
 (:objects
