; Transport city-sequential-3nodes-1000size-3degree-100mindistance-3trucks-8packages-2025seed

(define (problem transport-city-sequential-3nodes-1000size-3degree-100mindistance-3trucks-8packages-2025seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
