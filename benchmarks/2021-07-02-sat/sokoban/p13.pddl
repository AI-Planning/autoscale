...
(define (problem p007-hexoban-sequential)
  ...
  (:init
    ...
    (MOVE-DIR pos-13-09 pos-14-08 dir-northeast)
    ...
    (MOVE-DIR pos-14-08 pos-13-09 dir-southwest)
    ...
    (at stone-03 pos-10-04)
    (at stone-04 pos-14-06)
    (at stone-05 pos-11-07)
    (at stone-06 pos-13-07)
    (at stone-07 pos-06-08)
    (at-goal stone-02)
    (clear pos-01-01)
    (clear pos-01-03)
    (clear pos-01-05)
