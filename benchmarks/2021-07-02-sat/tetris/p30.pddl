(define (problem Tetris-42-3-114111)
(:domain tetris)
(:objects  
...
(at_right_l rightl1 f18-1f f19-1f f19-2f)
(at_right_l rightl2 f16-0f f17-0f f17-1f)
(at_right_l rightl3 f14-2f f15-2f f15-3f)
