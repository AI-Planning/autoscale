(define (problem prob)
 ...
 (:goal
  (and
      ...
      (contains shot77 cocktail27)
      (contains shot78 cocktail75)
      ...
      (contains shot112 cocktail32)
      (contains shot113 cocktail25)
