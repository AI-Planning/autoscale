...
(:init
	...
	(on-sale goods18 market1 level30)
...
(:goal (and
	...
	(stored goods7 level34)
	(stored goods8 level15)
	(stored goods9 level25)
	(stored goods10 level39)
