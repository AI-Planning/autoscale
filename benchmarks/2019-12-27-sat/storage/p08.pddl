...
(:init
	...
	(available hoist1)
	(at hoist2 depot48-5-6)
	(available hoist2)
	(at hoist3 depot48-1-1)
	(available hoist3)
	(at hoist4 depot48-6-1)
	(available hoist4)
	...
	(available hoist15)
	(at hoist16 depot48-3-1)
	(available hoist16)
	(at hoist17 depot48-4-7)
	(available hoist17)
	(at hoist18 depot48-2-1)
	(available hoist18)
	(at hoist19 depot48-1-3)
	(available hoist19)
	(at hoist20 depot48-3-5)
	(available hoist20)
	(at hoist21 depot48-5-5)
	(available hoist21)
	(at hoist22 depot48-2-2)
	(available hoist22)
	(at hoist23 depot48-4-5)
	(available hoist23)
	(at hoist24 depot48-2-7)
	(available hoist24)
	(at hoist25 depot48-4-2)
	(available hoist25)
	(at hoist26 depot48-5-7)
	(available hoist26)
	(at hoist27 depot48-3-2)
	(available hoist27)
	(at hoist28 depot48-2-5)
	(available hoist28))
