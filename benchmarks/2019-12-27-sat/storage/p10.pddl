...
;
; Map of the Depots:                                                                                
; 00* 11*=2*2 3* *4 *5=*6=7* 8* *9 A*=*B C*=D*=E* F*=*G H* *I J* K*=L*=*M=*N=*O 
;------------------------------------------------------------------------------ 
; 48: depot48 area
; 49: depot49 area
; 50: depot50 area
...
(:objects
	depot48-1-1 depot48-1-2 depot48-1-3 depot49-1-1 depot49-1-2 depot49-1-3 depot50-1-1 depot50-1-2 depot50-1-3 depot51-1-1 depot51-1-2 depot52-1-1 depot52-1-2 depot53-1-1 depot53-1-2 depot54-1-1 depot54-1-2 depot55-1-1 depot55-1-2 depot56-1-1 depot56-1-2 depot57-1-1 depot57-1-2 depot65-1-1 depot65-1-2 depot66-1-1 depot66-1-2 depot67-1-1 depot67-1-2 depot68-1-1 depot68-1-2 depot69-1-1 depot69-1-2 depot70-1-1 depot70-1-2 depot71-1-1 depot71-1-2 depot72-1-1 depot72-1-2 depot73-1-1 depot73-1-2 depot74-1-1 depot74-1-2 depot75-1-1 depot75-1-2 depot76-1-1 depot76-1-2 depot77-1-1 depot77-1-2 depot78-1-1 depot78-1-2 depot79-1-1 depot79-1-2 container-0-0 container-0-1 container-0-2 container-0-3 container-1-0 container-1-1 container-1-2 container-1-3 container-2-0 container-2-1 container-2-2 container-2-3 container-3-0 container-3-1 container-3-2 container-3-3 container-4-0 container-4-1 container-4-2 container-4-3 container-5-0 container-5-1 container-5-2 container-5-3 container-6-0 container-6-1 container-6-2 container-6-3 container-7-0 - storearea
...
(:init
	...
	(available hoist6)
	(at hoist7 depot53-1-1)
	(available hoist7)
	(at hoist8 depot53-1-2)
	(available hoist8)
	(at hoist9 depot54-1-1)
	(available hoist9)
	(at hoist10 depot55-1-1)
	(available hoist10)
	(at hoist11 depot55-1-2)
	(available hoist11)
	(at hoist12 depot56-1-2)
	(available hoist12)
	(at hoist13 depot65-1-1)
	(available hoist13)
	(at hoist14 depot65-1-2)
	(available hoist14)
	(at hoist15 depot66-1-2)
	(available hoist15)
	(at hoist16 depot67-1-1)
	(available hoist16)
	(at hoist17 depot67-1-2)
	(available hoist17)
	(at hoist18 depot68-1-1)
	(available hoist18)
	(at hoist19 depot68-1-2)
	(available hoist19)
	(at hoist20 depot70-1-1)
	(available hoist20)
	(at hoist21 depot70-1-2)
	(available hoist21)
	(at hoist22 depot72-1-2)
	(available hoist22)
	(at hoist23 depot73-1-1)
	(available hoist23)
	(at hoist24 depot77-1-2)
	(available hoist24)
	(at hoist25 depot77-1-1)
	(available hoist25))
