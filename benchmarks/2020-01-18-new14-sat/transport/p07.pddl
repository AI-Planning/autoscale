; Transport two-cities-sequential-5nodes-1000size-5degree-100mindistance-6trucks-8packages-2025seed

(define (problem transport-two-cities-sequential-5nodes-1000size-5degree-100mindistance-6trucks-8packages-2025seed)
 (:domain transport)
 (:objects
