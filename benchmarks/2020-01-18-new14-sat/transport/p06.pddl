; Transport two-cities-sequential-5nodes-1000size-5degree-100mindistance-6trucks-7packages-2024seed

(define (problem transport-two-cities-sequential-5nodes-1000size-5degree-100mindistance-6trucks-7packages-2024seed)
 (:domain transport)
 (:objects
