; Transport two-cities-sequential-5nodes-1000size-5degree-100mindistance-6trucks-9packages-2026seed

(define (problem transport-two-cities-sequential-5nodes-1000size-5degree-100mindistance-6trucks-9packages-2026seed)
 (:domain transport)
 (:objects
