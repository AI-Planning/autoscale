; Transport city-sequential-2nodes-1000size-4degree-100mindistance-4trucks-25packages-2048seed

(define (problem transport-city-sequential-2nodes-1000size-4degree-100mindistance-4trucks-25packages-2048seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
