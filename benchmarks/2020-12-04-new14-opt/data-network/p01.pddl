(define (problem p13-5-22-tiny-network-2019)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           ...
           (SCRIPT-IO script2 data-0-10 data-0-7 data-1-12)
           (SCRIPT-IO script3 data-1-12 data-0-7 data-2-3)
           (SCRIPT-IO script4 data-2-3 data-1-12 data-3-4)
           (SCRIPT-IO script5 data-2-3 data-1-2 data-3-11)
           (SCRIPT-IO script6 data-3-4 data-2-3 data-4-5)
           (SCRIPT-IO script7 data-3-11 data-0-7 data-4-8)
           (SCRIPT-IO script8 data-3-11 data-2-3 data-4-9)
           (SCRIPT-IO script9 data-3-11 data-0-10 data-4-13)
           (SCRIPT-IO script10 data-1-12 data-0-10 data-2-3)
           (SCRIPT-IO script11 data-0-10 data-0-1 data-1-2)
           (SCRIPT-IO script12 data-1-2 data-0-6 data-2-3)
           (SCRIPT-IO script13 data-0-10 data-0-1 data-1-2)
           (SCRIPT-IO script14 data-1-12 data-0-7 data-2-3)
           (SCRIPT-IO script15 data-1-2 data-0-1 data-2-3)
           (SCRIPT-IO script16 data-1-12 data-0-7 data-2-3)
           (SCRIPT-IO script17 data-2-3 data-1-12 data-3-11)
           (SCRIPT-IO script18 data-1-12 data-1-2 data-2-3)
           (SCRIPT-IO script19 data-1-2 data-0-7 data-2-3)
           (SCRIPT-IO script20 data-3-4 data-1-2 data-4-13)
           (SCRIPT-IO script21 data-1-2 data-0-10 data-2-3)
           (SCRIPT-IO script22 data-0-1 data-0-7 data-1-2)
