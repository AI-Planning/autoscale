(define (problem p11-5-20-tiny-network-2041)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           ...
           (SCRIPT-IO script5 data-1-7 data-1-10 data-2-9)
           (SCRIPT-IO script6 data-1-10 data-1-7 data-2-11)
           (SCRIPT-IO script7 data-2-11 data-2-3 data-3-4)
           (SCRIPT-IO script8 data-2-11 data-2-3 data-3-8)
           (SCRIPT-IO script9 data-3-8 data-1-7 data-4-5)
           (SCRIPT-IO script10 data-0-6 data-0-1 data-1-10)
           (SCRIPT-IO script11 data-3-8 data-1-2 data-4-5)
           (SCRIPT-IO script12 data-1-10 data-1-7 data-2-3)
           (SCRIPT-IO script13 data-0-6 data-0-1 data-1-2)
           (SCRIPT-IO script14 data-0-6 data-0-1 data-1-7)
           (SCRIPT-IO script15 data-2-3 data-0-6 data-3-8)
           (SCRIPT-IO script16 data-0-1 data-0-6 data-1-7)
           (SCRIPT-IO script17 data-3-8 data-1-2 data-4-5)
           (SCRIPT-IO script18 data-2-11 data-0-6 data-3-8)
           (SCRIPT-IO script19 data-3-4 data-3-8 data-4-5)
