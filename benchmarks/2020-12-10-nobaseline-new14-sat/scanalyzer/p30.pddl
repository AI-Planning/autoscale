(define (problem scanalyzer3d-7-ab-none)
  (:domain scanalyzer3d)
  (:objects
    car-in-1a - car
    car-in-1b - car
  ...
  (:init
    ...
    (CYCLE-4 seg-in-1a seg-in-1b seg-out-7a seg-out-7b)
    ...
    (CYCLE-4 seg-in-2a seg-in-2b seg-out-7a seg-out-7b)
    ...
    (CYCLE-4 seg-in-3a seg-in-3b seg-out-7a seg-out-7b)
    ...
    (CYCLE-4 seg-in-4a seg-in-4b seg-out-7a seg-out-7b)
    ...
    (CYCLE-4 seg-in-5a seg-in-5b seg-out-7a seg-out-7b)
    ...
    (CYCLE-4 seg-in-6a seg-in-6b seg-out-7a seg-out-7b)
    (CYCLE-4 seg-in-7a seg-in-7b seg-out-1a seg-out-1b)
    (CYCLE-4 seg-in-7a seg-in-7b seg-out-2a seg-out-2b)
    (CYCLE-4 seg-in-7a seg-in-7b seg-out-3a seg-out-3b)
    (CYCLE-4 seg-in-7a seg-in-7b seg-out-4a seg-out-4b)
    (CYCLE-4 seg-in-7a seg-in-7b seg-out-5a seg-out-5b)
    (CYCLE-4 seg-in-7a seg-in-7b seg-out-6a seg-out-6b)
    (CYCLE-4 seg-in-7a seg-in-7b seg-out-7a seg-out-7b)
    ...
    (on car-in-7a seg-in-7a)
    (on car-in-7b seg-in-7b)
    ...
    (on car-out-7a seg-out-7a)
    (on car-out-7b seg-out-7b)
  )
  (:goal (and
    (analyzed car-in-1a)
    (analyzed car-in-1b)
    ...
    (on car-in-2a seg-out-7b)
    (on car-in-2b seg-in-2a)
    (on car-in-3a seg-out-6b)
    (on car-in-3b seg-in-3a)
    (on car-in-4a seg-out-5b)
    (on car-in-4b seg-in-4a)
    (on car-in-5a seg-out-4b)
    (on car-in-5b seg-in-5a)
    (on car-in-6a seg-out-3b)
    (on car-in-6b seg-in-6a)
    (on car-in-7a seg-out-2b)
    (on car-in-7b seg-in-7a)
    (on car-out-1a seg-in-1b)
    (on car-out-1b seg-out-1a)
    (on car-out-2a seg-in-7b)
    (on car-out-2b seg-out-2a)
    (on car-out-3a seg-in-6b)
    (on car-out-3b seg-out-3a)
    (on car-out-4a seg-in-5b)
    (on car-out-4b seg-out-4a)
    (on car-out-5a seg-in-4b)
    (on car-out-5b seg-out-5a)
    (on car-out-6a seg-in-3b)
    (on car-out-6b seg-out-6a)
    (on car-out-7a seg-in-2b)
    (on car-out-7b seg-out-7a)
  ))
