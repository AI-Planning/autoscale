(define (problem snake-empty-9x10-1-5-42-2048)
(:domain snake)
(:objects
...
(:init
 ...
 (isAdjacent pos8-9 pos8-8)
    (tailSnake pos1-9)
    (headSnake pos1-8)
    (nextSnake pos1-8 pos1-9)
    (blocked pos1-8)
 (blocked pos1-9)
    (spawn pos7-3)
 (nextSpawn pos0-4 dummyPoint)
 (nextSpawn pos7-3 pos8-3)
 (nextSpawn pos8-3 pos6-3)
 (nextSpawn pos6-3 pos3-0)
