(define (problem p24-2-31-ring-network-2031)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-3
    ...
    (:init
           ...
           (SCRIPT-IO script2 data-0-13 data-0-20 data-1-7)
           (SCRIPT-IO script3 data-0-3 data-0-20 data-1-8)
           (SCRIPT-IO script4 data-0-15 data-0-24 data-1-10)
           (SCRIPT-IO script5 data-0-15 data-0-22 data-1-11)
           (SCRIPT-IO script6 data-0-21 data-0-15 data-1-12)
           (SCRIPT-IO script7 data-0-1 data-0-21 data-1-16)
           (SCRIPT-IO script8 data-0-24 data-0-9 data-1-17)
           (SCRIPT-IO script9 data-0-18 data-0-4 data-1-23)
           (SCRIPT-IO script10 data-0-20 data-0-18 data-1-8)
           (SCRIPT-IO script11 data-0-22 data-0-5 data-1-10)
           (SCRIPT-IO script12 data-0-24 data-0-22 data-1-10)
           (SCRIPT-IO script13 data-0-1 data-0-21 data-1-17)
           (SCRIPT-IO script14 data-0-14 data-0-24 data-1-16)
           (SCRIPT-IO script15 data-0-13 data-0-21 data-1-10)
           (SCRIPT-IO script16 data-0-6 data-0-13 data-1-8)
           (SCRIPT-IO script17 data-0-5 data-0-22 data-1-8)
           (SCRIPT-IO script18 data-0-21 data-0-18 data-1-10)
           (SCRIPT-IO script19 data-0-9 data-0-14 data-1-16)
           (SCRIPT-IO script20 data-0-14 data-0-13 data-1-7)
           (SCRIPT-IO script21 data-0-21 data-0-3 data-1-10)
           (SCRIPT-IO script22 data-0-18 data-0-3 data-1-23)
           (SCRIPT-IO script23 data-0-14 data-0-24 data-1-11)
           (SCRIPT-IO script24 data-0-1 data-0-6 data-1-8)
           (SCRIPT-IO script25 data-0-24 data-0-20 data-1-23)
           (SCRIPT-IO script26 data-0-18 data-0-24 data-1-7)
           (SCRIPT-IO script27 data-0-20 data-0-3 data-1-17)
           (SCRIPT-IO script28 data-0-5 data-0-4 data-1-7)
           (SCRIPT-IO script29 data-0-4 data-0-13 data-1-8)
           (SCRIPT-IO script30 data-0-21 data-0-24 data-1-17)
           (SCRIPT-IO script31 data-0-24 data-0-18 data-1-10)
