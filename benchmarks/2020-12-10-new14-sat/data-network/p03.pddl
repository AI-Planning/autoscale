(define (problem p7-2-8-ring-network-2021)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-3
    ...
    (:init
           ...
           (SCRIPT-IO script2 data-0-3 data-0-6 data-1-2)
           (SCRIPT-IO script3 data-0-7 data-0-4 data-1-2)
           ...
           (SCRIPT-IO script7 data-0-5 data-0-6 data-1-2)
