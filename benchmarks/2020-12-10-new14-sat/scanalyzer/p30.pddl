(define (problem scanalyzer3d-5-ab-both)
  (:domain scanalyzer3d)
  (:objects
    car-in-1a - car
    car-in-1b - car
  ...
  (:init
    ...
    (CYCLE-4-WITH-ANALYSIS seg-in-1a seg-in-1b seg-out-4a seg-out-4b)
    (CYCLE-4-WITH-ANALYSIS seg-in-1a seg-in-1b seg-out-5a seg-out-5b)
    ...
    (CYCLE-4-WITH-ANALYSIS seg-in-2a seg-in-2b seg-out-4a seg-out-4b)
    (CYCLE-4-WITH-ANALYSIS seg-in-2a seg-in-2b seg-out-5a seg-out-5b)
    ...
    (CYCLE-4-WITH-ANALYSIS seg-in-3a seg-in-3b seg-out-4a seg-out-4b)
    (CYCLE-4-WITH-ANALYSIS seg-in-3a seg-in-3b seg-out-5a seg-out-5b)
    (CYCLE-4-WITH-ANALYSIS seg-in-4a seg-in-4b seg-out-1a seg-out-1b)
    (CYCLE-4-WITH-ANALYSIS seg-in-4a seg-in-4b seg-out-2a seg-out-2b)
    (CYCLE-4-WITH-ANALYSIS seg-in-4a seg-in-4b seg-out-3a seg-out-3b)
    (CYCLE-4-WITH-ANALYSIS seg-in-4a seg-in-4b seg-out-4a seg-out-4b)
    (CYCLE-4-WITH-ANALYSIS seg-in-4a seg-in-4b seg-out-5a seg-out-5b)
    (CYCLE-4-WITH-ANALYSIS seg-in-5a seg-in-5b seg-out-1a seg-out-1b)
    (CYCLE-4-WITH-ANALYSIS seg-in-5a seg-in-5b seg-out-2a seg-out-2b)
    (CYCLE-4-WITH-ANALYSIS seg-in-5a seg-in-5b seg-out-3a seg-out-3b)
    (CYCLE-4-WITH-ANALYSIS seg-in-5a seg-in-5b seg-out-4a seg-out-4b)
    (CYCLE-4-WITH-ANALYSIS seg-in-5a seg-in-5b seg-out-5a seg-out-5b)
