; Transport city-sequential-2nodes-1000size-5degree-100mindistance-2trucks-41packages-2038seed

(define (problem transport-city-sequential-2nodes-1000size-5degree-100mindistance-2trucks-41packages-2038seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
 ...
 (:init
  ...
  (= (road-length city-loc-2 city-loc-1) 99)
  ; 91,972 -> 487,73
  (road city-loc-1 city-loc-2)
  (= (road-length city-loc-1 city-loc-2) 99)
