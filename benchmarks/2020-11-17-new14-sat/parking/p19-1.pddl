(define   (problem parking)
  ...
  (:init
    ...
    (car-clear car_65)
    (at-curb car_77)
    (at-curb-num car_77 curb_06)
    (behind-car car_51 car_77)
    (car-clear car_51)
    (at-curb car_92)
    (at-curb-num car_92 curb_07)
    (behind-car car_49 car_92)
    (car-clear car_49)
    (at-curb car_61)
    (at-curb-num car_61 curb_08)
    (behind-car car_36 car_61)
    (car-clear car_36)
    (at-curb car_46)
    ...
    (behind-car car_14 car_87)
    (car-clear car_14)
    (at-curb car_73)
    (at-curb-num car_73 curb_13)
    (behind-car car_28 car_73)
    (car-clear car_28)
    (at-curb car_69)
    (at-curb-num car_69 curb_14)
    (behind-car car_86 car_69)
    (car-clear car_86)
    (at-curb car_22)
    ...
    (behind-car car_80 car_17)
    (car-clear car_80)
    (at-curb car_08)
    (at-curb-num car_08 curb_18)
    (behind-car car_82 car_08)
    (car-clear car_82)
    (at-curb car_39)
    ...
    (behind-car car_88 car_48)
    (car-clear car_88)
    (at-curb car_56)
    (at-curb-num car_56 curb_21)
    (behind-car car_32 car_56)
    (car-clear car_32)
    (at-curb car_85)
    (at-curb-num car_85 curb_22)
    (behind-car car_00 car_85)
    (car-clear car_00)
    (at-curb car_84)
    (at-curb-num car_84 curb_23)
    (behind-car car_89 car_84)
    (car-clear car_89)
    (at-curb car_94)
    (at-curb-num car_94 curb_24)
    (behind-car car_66 car_94)
    (car-clear car_66)
    (at-curb car_52)
    ...
    (car-clear car_07)
    (at-curb car_83)
    (at-curb-num car_83 curb_26)
    (behind-car car_19 car_83)
    (car-clear car_19)
    (at-curb car_02)
    (at-curb-num car_02 curb_27)
    (behind-car car_60 car_02)
    (car-clear car_60)
    (at-curb car_34)
    (at-curb-num car_34 curb_28)
    (behind-car car_50 car_34)
    (car-clear car_50)
    (at-curb car_10)
    (at-curb-num car_10 curb_29)
    (behind-car car_31 car_10)
    (car-clear car_31)
    (at-curb car_79)
    (at-curb-num car_79 curb_30)
    (behind-car car_15 car_79)
    (car-clear car_15)
    (at-curb car_43)
    (at-curb-num car_43 curb_31)
    (behind-car car_53 car_43)
    (car-clear car_53)
    (at-curb car_71)
    (at-curb-num car_71 curb_32)
    (behind-car car_42 car_71)
    (car-clear car_42)
    (at-curb car_29)
    ...
    (car-clear car_20)
    (at-curb car_01)
    (at-curb-num car_01 curb_36)
    (behind-car car_78 car_01)
    (car-clear car_78)
    (at-curb car_18)
    ...
    (car-clear car_45)
    (at-curb car_91)
    (at-curb-num car_91 curb_38)
    (behind-car car_21 car_91)
    (car-clear car_21)
    (at-curb car_27)
    (at-curb-num car_27 curb_39)
    (behind-car car_38 car_27)
    (car-clear car_38)
    (at-curb car_95)
    (at-curb-num car_95 curb_40)
    (behind-car car_57 car_95)
    (car-clear car_57)
    (at-curb car_37)
    ...
    (behind-car car_64 car_70)
    (car-clear car_64)
    (at-curb car_72)
    (at-curb-num car_72 curb_43)
    (behind-car car_76 car_72)
    (car-clear car_76)
    (at-curb car_62)
    (at-curb-num car_62 curb_44)
    (behind-car car_68 car_62)
    (car-clear car_68)
    (at-curb car_93)
    (at-curb-num car_93 curb_45)
    (behind-car car_03 car_93)
    (car-clear car_03)
    (at-curb car_11)
    (at-curb-num car_11 curb_46)
    (behind-car car_96 car_11)
    (car-clear car_96)
    (at-curb car_33)
    (at-curb-num car_33 curb_47)
    (car-clear car_33)
    (at-curb car_13)
    (at-curb-num car_13 curb_48)
    (car-clear car_13)
    (at-curb car_12)
    (at-curb-num car_12 curb_49)
    (car-clear car_12)
  )
  (:goal
    (and
...
; =========== INIT =========== 
;  curb_00: car_44 car_47 
;  curb_01: car_54 car_41 
;  curb_02: car_09 car_90 
;  curb_03: car_16 car_35 
;  curb_04: car_74 car_23 
;  curb_05: car_55 car_65 
;  curb_06: car_77 car_51 
;  curb_07: car_92 car_49 
;  curb_08: car_61 car_36 
;  curb_09: car_46 car_04 
;  curb_10: car_59 car_25 
;  curb_11: car_40 car_63 
;  curb_12: car_87 car_14 
;  curb_13: car_73 car_28 
;  curb_14: car_69 car_86 
;  curb_15: car_22 car_67 
;  curb_16: car_58 car_75 
;  curb_17: car_17 car_80 
;  curb_18: car_08 car_82 
;  curb_19: car_39 car_81 
;  curb_20: car_48 car_88 
;  curb_21: car_56 car_32 
;  curb_22: car_85 car_00 
;  curb_23: car_84 car_89 
;  curb_24: car_94 car_66 
;  curb_25: car_52 car_07 
;  curb_26: car_83 car_19 
;  curb_27: car_02 car_60 
;  curb_28: car_34 car_50 
;  curb_29: car_10 car_31 
;  curb_30: car_79 car_15 
;  curb_31: car_43 car_53 
;  curb_32: car_71 car_42 
;  curb_33: car_29 car_05 
;  curb_34: car_26 car_24 
;  curb_35: car_30 car_20 
;  curb_36: car_01 car_78 
;  curb_37: car_18 car_45 
;  curb_38: car_91 car_21 
;  curb_39: car_27 car_38 
;  curb_40: car_95 car_57 
;  curb_41: car_37 car_06 
;  curb_42: car_70 car_64 
;  curb_43: car_72 car_76 
;  curb_44: car_62 car_68 
;  curb_45: car_93 car_03 
;  curb_46: car_11 car_96 
;  curb_47: car_33 
;  curb_48: car_13 
;  curb_49: car_12 
; ========== /INIT =========== 
