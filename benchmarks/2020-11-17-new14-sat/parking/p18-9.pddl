(define   (problem parking)
  ...
  (:init
    ...
    (behind-car car_73 car_67)
    (car-clear car_73)
    (at-curb car_57)
    (at-curb-num car_57 curb_01)
    (behind-car car_11 car_57)
    (car-clear car_11)
    (at-curb car_77)
    (at-curb-num car_77 curb_02)
    (behind-car car_87 car_77)
    (car-clear car_87)
    (at-curb car_38)
    ...
    (car-clear car_40)
    (at-curb car_89)
    (at-curb-num car_89 curb_05)
    (behind-car car_71 car_89)
    (car-clear car_71)
    (at-curb car_86)
    (at-curb-num car_86 curb_06)
    (behind-car car_42 car_86)
    (car-clear car_42)
    (at-curb car_64)
    ...
    (car-clear car_45)
    (at-curb car_48)
    (at-curb-num car_48 curb_12)
    (behind-car car_24 car_48)
    (car-clear car_24)
    (at-curb car_88)
    (at-curb-num car_88 curb_13)
    (behind-car car_54 car_88)
    (car-clear car_54)
    (at-curb car_26)
    ...
    (car-clear car_81)
    (at-curb car_74)
    (at-curb-num car_74 curb_20)
    (behind-car car_28 car_74)
    (car-clear car_28)
    (at-curb car_56)
    ...
    (behind-car car_47 car_46)
    (car-clear car_47)
    (at-curb car_41)
    (at-curb-num car_41 curb_24)
    (behind-car car_51 car_41)
    (car-clear car_51)
    (at-curb car_75)
    (at-curb-num car_75 curb_25)
    (behind-car car_43 car_75)
    (car-clear car_43)
    (at-curb car_78)
    (at-curb-num car_78 curb_26)
    (behind-car car_65 car_78)
    (car-clear car_65)
    (at-curb car_49)
    ...
    (car-clear car_30)
    (at-curb car_44)
    (at-curb-num car_44 curb_28)
    (behind-car car_32 car_44)
    (car-clear car_32)
    (at-curb car_69)
    (at-curb-num car_69 curb_29)
    (behind-car car_55 car_69)
    (car-clear car_55)
    (at-curb car_06)
    ...
    (car-clear car_08)
    (at-curb car_52)
    (at-curb-num car_52 curb_31)
    (behind-car car_05 car_52)
    (car-clear car_05)
    (at-curb car_84)
    (at-curb-num car_84 curb_32)
    (behind-car car_00 car_84)
    (car-clear car_00)
    (at-curb car_19)
    (at-curb-num car_19 curb_33)
    (behind-car car_59 car_19)
    (car-clear car_59)
    (at-curb car_21)
    (at-curb-num car_21 curb_34)
    (behind-car car_72 car_21)
    (car-clear car_72)
    (at-curb car_90)
    (at-curb-num car_90 curb_35)
    (behind-car car_29 car_90)
    (car-clear car_29)
    (at-curb car_85)
    (at-curb-num car_85 curb_36)
    (behind-car car_92 car_85)
    (car-clear car_92)
    (at-curb car_61)
    (at-curb-num car_61 curb_37)
    ...
    (behind-car car_17 car_68)
    (car-clear car_17)
    (at-curb car_35)
    (at-curb-num car_35 curb_40)
    (behind-car car_04 car_35)
    (car-clear car_04)
    (at-curb car_66)
    (at-curb-num car_66 curb_41)
    (behind-car car_01 car_66)
    (car-clear car_01)
    (at-curb car_39)
    ...
    (car-clear car_22)
    (at-curb car_23)
    (at-curb-num car_23 curb_43)
    (behind-car car_31 car_23)
    (car-clear car_31)
    (at-curb car_70)
    (at-curb-num car_70 curb_44)
    (behind-car car_15 car_70)
    (car-clear car_15)
    (at-curb car_37)
    (at-curb-num car_37 curb_45)
    (behind-car car_10 car_37)
    (car-clear car_10)
    (at-curb car_07)
    (at-curb-num car_07 curb_46)
    (car-clear car_07)
    (curb-clear curb_47)
  )
  (:goal
...
; =========== INIT =========== 
;  curb_00: car_67 car_73 
;  curb_01: car_57 car_11 
;  curb_02: car_77 car_87 
;  curb_03: car_38 car_25 
;  curb_04: car_16 car_40 
;  curb_05: car_89 car_71 
;  curb_06: car_86 car_42 
;  curb_07: car_64 car_03 
;  curb_08: car_18 car_80 
;  curb_09: car_82 car_53 
;  curb_10: car_60 car_79 
;  curb_11: car_33 car_45 
;  curb_12: car_48 car_24 
;  curb_13: car_88 car_54 
;  curb_14: car_26 car_27 
;  curb_15: car_34 car_83 
;  curb_16: car_50 car_20 
;  curb_17: car_36 car_63 
;  curb_18: car_12 car_91 
;  curb_19: car_09 car_81 
;  curb_20: car_74 car_28 
;  curb_21: car_56 car_76 
;  curb_22: car_02 car_14 
;  curb_23: car_46 car_47 
;  curb_24: car_41 car_51 
;  curb_25: car_75 car_43 
;  curb_26: car_78 car_65 
;  curb_27: car_49 car_30 
;  curb_28: car_44 car_32 
;  curb_29: car_69 car_55 
;  curb_30: car_06 car_08 
;  curb_31: car_52 car_05 
;  curb_32: car_84 car_00 
;  curb_33: car_19 car_59 
;  curb_34: car_21 car_72 
;  curb_35: car_90 car_29 
;  curb_36: car_85 car_92 
;  curb_37: car_61 car_62 
;  curb_38: car_13 car_58 
;  curb_39: car_68 car_17 
;  curb_40: car_35 car_04 
;  curb_41: car_66 car_01 
;  curb_42: car_39 car_22 
;  curb_43: car_23 car_31 
;  curb_44: car_70 car_15 
;  curb_45: car_37 car_10 
;  curb_46: car_07 
;  curb_47: 
; ========== /INIT =========== 
