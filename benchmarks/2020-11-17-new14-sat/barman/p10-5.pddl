(define (problem prob)
 ...
 (:goal
  (and
      ...
      (contains shot83 cocktail14)
      (contains shot84 cocktail10)
      (contains shot85 cocktail37)
      ...
      (contains shot92 cocktail62)
      (contains shot93 cocktail17)
