(define (problem prob)
 ...
 (:goal
  (and
      ...
      (contains shot26 cocktail82)
      (contains shot27 cocktail73)
      (contains shot28 cocktail61)
      (contains shot29 cocktail43)
      (contains shot30 cocktail74)
