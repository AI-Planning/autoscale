(define (problem prob)
 ...
 (:goal
  (and
      ...
      (contains shot48 cocktail85)
      (contains shot49 cocktail57)
      (contains shot50 cocktail38)
      (contains shot51 cocktail82)
