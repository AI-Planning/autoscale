(define (problem prob)
 ...
 (:goal
  (and
      ...
      (contains shot22 cocktail91)
      (contains shot23 cocktail77)
      ...
      (contains shot69 cocktail34)
      (contains shot70 cocktail58)
      (contains shot71 cocktail89)
