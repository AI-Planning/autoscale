(define (problem p5-3-28-ring-network-2169)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-4
    ...
    (:init
           ...
           (SCRIPT-IO script19 data-1-2 data-0-4 data-2-3)
           ...
           (SCRIPT-IO script26 data-0-4 data-0-5 data-1-2)
           ...
           (= (process-cost script22 server6) 6)
