(define (problem p5-3-28-ring-network-2139)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-4
    ...
    (:init
           ...
           (SCRIPT-IO script4 data-1-2 data-0-1 data-2-5)
           ...
           (SCRIPT-IO script8 data-1-2 data-0-1 data-2-5)
           ...
           (= (process-cost script21 server5) 9)
