; Transport two-cities-sequential-7nodes-1000size-3degree-100mindistance-2trucks-59packages-2143seed

(define (problem transport-two-cities-sequential-7nodes-1000size-3degree-100mindistance-2trucks-59packages-2143seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-1-loc-2 city-2-loc-5) 146)
  (road city-2-loc-5 city-1-loc-2)
  (= (road-length city-2-loc-5 city-1-loc-2) 146)
 ...
 (:goal (and
  ...
  (at package-56 city-2-loc-3)
  (at package-57 city-2-loc-1)
  (at package-58 city-2-loc-7)
