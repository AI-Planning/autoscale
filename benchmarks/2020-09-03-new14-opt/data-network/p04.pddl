(define (problem p11-5-21-tiny-network-2022)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           ...
           (SCRIPT-IO script4 data-2-3 data-0-10 data-3-7)
           (SCRIPT-IO script5 data-2-3 data-1-2 data-3-8)
           (SCRIPT-IO script6 data-2-3 data-0-6 data-3-9)
           (SCRIPT-IO script7 data-2-3 data-1-2 data-3-11)
           (SCRIPT-IO script8 data-3-7 data-3-11 data-4-5)
