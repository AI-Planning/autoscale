; Transport city-sequential-3nodes-1000size-3degree-100mindistance-4trucks-3packages-2020seed

(define (problem transport-city-sequential-3nodes-1000size-3degree-100mindistance-4trucks-3packages-2020seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
