; Transport city-sequential-2nodes-1000size-3degree-100mindistance-3trucks-20packages-2063seed

(define (problem transport-city-sequential-2nodes-1000size-3degree-100mindistance-3trucks-20packages-2063seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
