; Transport city-sequential-3nodes-1000size-4degree-100mindistance-3trucks-22packages-2223seed

(define (problem transport-city-sequential-3nodes-1000size-4degree-100mindistance-3trucks-22packages-2223seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
 ...
 (:init
  ...
  (= (road-length city-loc-3 city-loc-1) 77)
  ; 763,653 -> 17,488
  (road city-loc-1 city-loc-3)
  (= (road-length city-loc-1 city-loc-3) 77)
  ; 17,488 -> 274,922
