; Transport city-sequential-3nodes-1000size-4degree-100mindistance-3trucks-20packages-2041seed

(define (problem transport-city-sequential-3nodes-1000size-4degree-100mindistance-3trucks-20packages-2041seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
