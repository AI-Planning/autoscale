(define (problem p12-2-14-tiny-network-2262)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-3
    ...
    (:init
           ...
           (SCRIPT-IO script5 data-0-7 data-0-8 data-1-11)
           (SCRIPT-IO script6 data-0-3 data-0-10 data-1-12)
           (SCRIPT-IO script7 data-0-5 data-0-8 data-1-12)
           (SCRIPT-IO script8 data-0-3 data-0-1 data-1-11)
           (SCRIPT-IO script9 data-0-1 data-0-8 data-1-2)
           (SCRIPT-IO script10 data-0-3 data-0-7 data-1-11)
           (SCRIPT-IO script11 data-0-5 data-0-10 data-1-11)
           (SCRIPT-IO script12 data-0-3 data-0-7 data-1-4)
           (SCRIPT-IO script13 data-0-10 data-0-1 data-1-12)
           (SCRIPT-IO script14 data-0-8 data-0-1 data-1-9)
