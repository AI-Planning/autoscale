(define (problem p12-2-14-tiny-network-2082)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-3
    ...
    (:init
           ...
           (SCRIPT-IO script2 data-0-12 data-0-6 data-1-4)
           ...
           (SCRIPT-IO script8 data-0-12 data-0-3 data-1-11)
           (SCRIPT-IO script9 data-0-3 data-0-6 data-1-11)
           (SCRIPT-IO script10 data-0-3 data-0-1 data-1-9)
           (SCRIPT-IO script11 data-0-12 data-0-3 data-1-2)
           (SCRIPT-IO script12 data-0-12 data-0-1 data-1-7)
           (SCRIPT-IO script13 data-0-3 data-0-6 data-1-4)
           (SCRIPT-IO script14 data-0-3 data-0-12 data-1-7)
