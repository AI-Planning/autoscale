(define (problem p9-2-10-tiny-network-2229)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-3
    ...
    (:init
           ...
           (SCRIPT-IO script2 data-0-9 data-0-8 data-1-7)
           (SCRIPT-IO script3 data-0-6 data-0-5 data-1-2)
           (SCRIPT-IO script4 data-0-3 data-0-8 data-1-7)
           (SCRIPT-IO script5 data-0-1 data-0-4 data-1-2)
           (SCRIPT-IO script6 data-0-1 data-0-6 data-1-7)
           (SCRIPT-IO script7 data-0-8 data-0-5 data-1-2)
