; Transport city-sequential-5nodes-1000size-5degree-100mindistance-3trucks-5packages-2038seed

(define (problem transport-city-sequential-5nodes-1000size-5degree-100mindistance-3trucks-5packages-2038seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
