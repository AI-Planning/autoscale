; Transport city-sequential-5nodes-1000size-5degree-100mindistance-3trucks-4packages-2037seed

(define (problem transport-city-sequential-5nodes-1000size-5degree-100mindistance-3trucks-4packages-2037seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
