(define (problem p19_hosts_trial_15) (:domain CALDERA)
(:objects
	NUM__247 - NUM
	NUM__255 - NUM
	NUM__184 - NUM
...
(:init
	...
	(MEM_CACHED_DOMAIN_CREDS ID_FYHOST ID_BJDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_GMHOST ID_BZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GMHOST ID_FRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GTHOST ID_DDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_HVHOST ID_CPDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HVHOST ID_FBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_ICHOST ID_BJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_ICHOST ID_FNDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IJHOST ID_EPDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IJHOST ID_HDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IQHOST ID_CDDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IQHOST ID_CPDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_JEHOST ID_XDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JLHOST ID_CXDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_JZHOST ID_BRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JZHOST ID_DJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KGHOST ID_BVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KGHOST ID_FNDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KNHOST ID_BFDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KNHOST ID_CPDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KUHOST ID_CLDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KUHOST ID_EXDOMAINCREDENTIAL)
	(MEM_DOMAIN_USER_ADMINS ID_FYHOST ID_DADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FYHOST ID_FADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GFHOST ID_ECDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GFHOST ID_GDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GMHOST ID_EODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GMHOST ID_FUDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_HAHOST ID_FMDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_HOHOST ID_FUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HVHOST ID_BADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HVHOST ID_ECDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_ICHOST ID_DYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_ICHOST ID_FIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IJHOST ID_CDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IJHOST ID_FEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IQHOST ID_CODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IQHOST ID_FUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IXHOST ID_BQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IXHOST ID_DUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JEHOST ID_CCDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JEHOST ID_SDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JLHOST ID_DQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JLHOST ID_WDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JSHOST ID_CSDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JSHOST ID_FADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JZHOST ID_GDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JZHOST ID_ODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KGHOST ID_CCDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_KUHOST ID_DQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KUHOST ID_ESDOMAINUSER)
	...
	(PROP_DNS_DOMAIN_NAME ID_JZHOST STR__KD)
	(PROP_DNS_DOMAIN_NAME ID_KGHOST STR__KK)
	(PROP_DNS_DOMAIN_NAME ID_KNHOST STR__KR)
	(PROP_DNS_DOMAIN_NAME ID_KUHOST STR__KY)
	...
	(PROP_FQDN ID_JZHOST STR__KE)
	(PROP_FQDN ID_KGHOST STR__KL)
	(PROP_FQDN ID_KNHOST STR__KS)
	(PROP_FQDN ID_KUHOST STR__KZ)
...
(:goal (and (procnone) (PROP_HOST ID_MTRAT ID_HAHOST)(PROP_HOST ID_MZRAT ID_KUHOST)(PROP_HOST ID_MXRAT ID_JZHOST)(PROP_HOST ID_MURAT ID_JEHOST)(PROP_HOST ID_NHRAT ID_IXHOST)(PROP_HOST ID_NARAT ID_HOHOST)(PROP_HOST ID_MPRAT ID_JLHOST)(PROP_HOST ID_NDRAT ID_GTHOST)(PROP_HOST ID_MQRAT ID_JSHOST)(PROP_HOST ID_MVRAT ID_HVHOST)(PROP_HOST ID_NERAT ID_GMHOST)(PROP_HOST ID_MWRAT ID_IQHOST)(PROP_HOST ID_NBRAT ID_GFHOST)(PROP_HOST ID_NGRAT ID_ICHOST)(PROP_HOST ID_NCRAT ID_FYHOST)(PROP_HOST ID_NFRAT ID_HHHOST)(PROP_HOST ID_MSRAT ID_IJHOST)(PROP_HOST ID_MYRAT ID_KNHOST)))
