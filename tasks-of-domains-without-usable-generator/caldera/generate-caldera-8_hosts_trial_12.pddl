(define (problem p8_hosts_trial_12) (:domain CALDERA)
(:objects
	NUM__75 - NUM
	NUM__111 - NUM
	NUM__110 - NUM
...
(:init
	(KNOWS ID_DCHOST)
	(KNOWS ID_ESRAT)
	(KNOWS_PROPERTY ID_DCHOST PFQDN)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_COHOST ID_TDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_DCHOST ID_BNDOMAINCREDENTIAL)
	...
	(MEM_DOMAIN_USER_ADMINS ID_DXHOST ID_BMDOMAINUSER)
...
(:goal (and (procnone) (PROP_HOST ID_FKRAT ID_CVHOST)(PROP_HOST ID_FRRAT ID_DQHOST)(PROP_HOST ID_FNRAT ID_DXHOST)(PROP_HOST ID_FMRAT ID_DJHOST)(PROP_HOST ID_FPRAT ID_ELHOST)(PROP_HOST ID_FORAT ID_EEHOST)(PROP_HOST ID_FQRAT ID_COHOST)))
