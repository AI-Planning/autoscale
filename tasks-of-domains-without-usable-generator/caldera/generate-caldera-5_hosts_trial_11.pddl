(define (problem p5_hosts_trial_11) (:domain CALDERA)
(:objects
...
(:goal (and (procnone) (PROP_HOST ID_DDRAT ID_BQHOST)(PROP_HOST ID_DCRAT ID_CLHOST)(PROP_HOST ID_DERAT ID_CSHOST)(PROP_HOST ID_DBRAT ID_BXHOST)))
