(define (problem p12_hosts_trial_14) (:domain CALDERA)
(:objects
...
(:goal (and (procnone) (PROP_HOST ID_ISRAT ID_EIHOST)(PROP_HOST ID_IORAT ID_GTHOST)(PROP_HOST ID_INRAT ID_EBHOST)(PROP_HOST ID_IXRAT ID_DUHOST)(PROP_HOST ID_IPRAT ID_GMHOST)(PROP_HOST ID_IURAT ID_FDHOST)(PROP_HOST ID_ITRAT ID_EPHOST)(PROP_HOST ID_IVRAT ID_GFHOST)(PROP_HOST ID_IRRAT ID_FYHOST)(PROP_HOST ID_IMRAT ID_FRHOST)(PROP_HOST ID_IQRAT ID_EWHOST)))
