(define (problem p14_hosts_trial_12) (:domain CALDERA)
(:objects
	NUM__179 - NUM
	NUM__193 - NUM
	NUM__145 - NUM
...
(:init
	(KNOWS ID_HQHOST)
	(KNOWS ID_IERAT)
	(KNOWS_PROPERTY ID_HQHOST PFQDN)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_EYHOST ID_CPDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_EYHOST ID_DJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FFHOST ID_CDDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FFHOST ID_DVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FMHOST ID_DBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FMHOST ID_DJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FTHOST ID_BBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FTHOST ID_BFDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GAHOST ID_DFDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GAHOST ID_TDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GHHOST ID_BVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GHHOST ID_EDDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GOHOST ID_DJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GOHOST ID_DNDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GVHOST ID_DDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GVHOST ID_XDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HCHOST ID_BRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HCHOST ID_DBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HJHOST ID_DDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HJHOST ID_TDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HQHOST ID_BZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HQHOST ID_PDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HXHOST ID_BFDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HXHOST ID_DBDOMAINCREDENTIAL)
	(MEM_DOMAIN_USER_ADMINS ID_EKHOST ID_CCDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EKHOST ID_CWDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EKHOST ID_DUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_ERHOST ID_BQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_ERHOST ID_DQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_ERHOST ID_GDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EYHOST ID_DEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EYHOST ID_DMDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EYHOST ID_DYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FFHOST ID_BUDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_FMHOST ID_DMDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FMHOST ID_EGDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FTHOST ID_BADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FTHOST ID_CODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FTHOST ID_DEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GAHOST ID_BQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GAHOST ID_CCDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GAHOST ID_DYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GHHOST ID_BEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GHHOST ID_DUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GHHOST ID_GDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GOHOST ID_CGDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GOHOST ID_DUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GOHOST ID_ECDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GVHOST ID_DQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GVHOST ID_DYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GVHOST ID_GDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HCHOST ID_BYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HCHOST ID_DQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HCHOST ID_ECDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HJHOST ID_BMDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_HQHOST ID_BQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HQHOST ID_CKDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HXHOST ID_BEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HXHOST ID_BIDOMAINUSER)
...
(:goal (and (procnone) (PROP_HOST ID_IWRAT ID_GHHOST)(PROP_HOST ID_JERAT ID_HCHOST)(PROP_HOST ID_JGRAT ID_FMHOST)(PROP_HOST ID_JDRAT ID_GAHOST)(PROP_HOST ID_JFRAT ID_HXHOST)(PROP_HOST ID_JHRAT ID_EKHOST)(PROP_HOST ID_IXRAT ID_EYHOST)(PROP_HOST ID_IYRAT ID_FTHOST)(PROP_HOST ID_IURAT ID_FFHOST)(PROP_HOST ID_IVRAT ID_GVHOST)(PROP_HOST ID_JCRAT ID_ERHOST)(PROP_HOST ID_IZRAT ID_HJHOST)(PROP_HOST ID_JARAT ID_GOHOST)))
