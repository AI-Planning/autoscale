(define (problem p6_hosts_trial_16) (:domain CALDERA)
(:objects
...
(:goal (and (procnone) (PROP_HOST ID_EERAT ID_DAHOST)(PROP_HOST ID_EFRAT ID_CMHOST)(PROP_HOST ID_ECRAT ID_DHHOST)(PROP_HOST ID_EGRAT ID_BYHOST)(PROP_HOST ID_EHRAT ID_CFHOST)))
