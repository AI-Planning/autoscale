(define (problem p5_hosts_trial_16) (:domain CALDERA)
(:objects
...
(:goal (and (procnone) (PROP_HOST ID_DJRAT ID_CSHOST)(PROP_HOST ID_DGRAT ID_BQHOST)(PROP_HOST ID_DIRAT ID_CLHOST)(PROP_HOST ID_DHRAT ID_CEHOST)))
