(define (problem p5_hosts_trial_13) (:domain CALDERA)
(:objects
	STR__MARY - STRING
...
(:goal (and (procnone) (PROP_HOST ID_DSRAT ID_CLHOST)(PROP_HOST ID_DQRAT ID_CSHOST)(PROP_HOST ID_DURAT ID_BQHOST)(PROP_HOST ID_DTRAT ID_CEHOST)))
