(define (problem p16_hosts_trial_2) (:domain CALDERA)
(:objects
...
(:goal (and (procnone) (PROP_HOST ID_FARAT ID_BFHOST)(PROP_HOST ID_EWRAT ID_KHOST)(PROP_HOST ID_EYRAT ID_ELHOST)(PROP_HOST ID_FERAT ID_RHOST)(PROP_HOST ID_FDRAT ID_DJHOST)(PROP_HOST ID_EZRAT ID_CVHOST)(PROP_HOST ID_FIRAT ID_COHOST)(PROP_HOST ID_EXRAT ID_YHOST)(PROP_HOST ID_FBRAT ID_DCHOST)(PROP_HOST ID_FFRAT ID_BTHOST)(PROP_HOST ID_FJRAT ID_CHHOST)(PROP_HOST ID_EVRAT ID_DQHOST)(PROP_HOST ID_FHRAT ID_EEHOST)(PROP_HOST ID_EURAT ID_DXHOST)(PROP_HOST ID_FGRAT ID_CAHOST)))
