(define (problem p11_hosts_trial_2) (:domain CALDERA)
(:objects
	STR__BC - STRING
	STR__DG - STRING
	STR__V - STRING
...
(:goal (and (procnone) (PROP_HOST ID_DURAT ID_CHHOST)(PROP_HOST ID_DPRAT ID_COHOST)(PROP_HOST ID_DQRAT ID_CAHOST)(PROP_HOST ID_DORAT ID_BFHOST)(PROP_HOST ID_DNRAT ID_BMHOST)(PROP_HOST ID_DSRAT ID_DCHOST)(PROP_HOST ID_DTRAT ID_CVHOST)(PROP_HOST ID_DRRAT ID_RHOST)(PROP_HOST ID_DLRAT ID_YHOST)(PROP_HOST ID_DVRAT ID_BTHOST)))
