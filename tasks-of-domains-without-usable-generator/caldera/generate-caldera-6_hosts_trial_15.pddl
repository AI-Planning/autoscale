(define (problem p6_hosts_trial_15) (:domain CALDERA)
(:objects
...
(:goal (and (procnone) (PROP_HOST ID_DZRAT ID_DAHOST)(PROP_HOST ID_DXRAT ID_DHHOST)(PROP_HOST ID_EBRAT ID_CFHOST)(PROP_HOST ID_DYRAT ID_CTHOST)(PROP_HOST ID_EARAT ID_CMHOST)))
