(define (problem p8_hosts_trial_15) (:domain CALDERA)
(:objects
...
(:init
	(KNOWS ID_COHOST)
	(KNOWS ID_ESRAT)
	(KNOWS_PROPERTY ID_COHOST PFQDN)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_DJHOST ID_TDOMAINCREDENTIAL)
	...
	(MEM_DOMAIN_USER_ADMINS ID_DJHOST ID_BYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_DJHOST ID_CGDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_DQHOST ID_BMDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_ELHOST ID_BMDOMAINUSER)
...
(:goal (and (procnone) (PROP_HOST ID_EXRAT ID_DQHOST)(PROP_HOST ID_EZRAT ID_DJHOST)(PROP_HOST ID_FBRAT ID_DXHOST)(PROP_HOST ID_EVRAT ID_DCHOST)(PROP_HOST ID_EYRAT ID_ELHOST)(PROP_HOST ID_EWRAT ID_EEHOST)(PROP_HOST ID_EURAT ID_CVHOST)))
