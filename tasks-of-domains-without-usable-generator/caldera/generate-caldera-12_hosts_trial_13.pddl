(define (problem p12_hosts_trial_13) (:domain CALDERA)
(:objects
...
(:init
	(KNOWS ID_GMHOST)
	(KNOWS ID_HARAT)
	(KNOWS_PROPERTY ID_GMHOST PFQDN)
	(KNOWS_PROPERTY ID_HARAT PEXECUTABLE)
	(KNOWS_PROPERTY ID_HARAT PHOST)
	(MEM_CACHED_DOMAIN_CREDS ID_DUHOST ID_BNDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_DUHOST ID_BZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_DUHOST ID_DFDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_EBHOST ID_BJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_EBHOST ID_DBDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_EPHOST ID_BZDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_FDHOST ID_BRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FDHOST ID_BVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FDHOST ID_DRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FKHOST ID_CTDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FKHOST ID_CXDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_GFHOST ID_CXDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GMHOST ID_BVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GMHOST ID_HDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GMHOST ID_LDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GTHOST ID_BFDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GTHOST ID_CHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GTHOST ID_DNDOMAINCREDENTIAL)
	...
	(MEM_DOMAIN_USER_ADMINS ID_EPHOST ID_BQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EPHOST ID_BYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EPHOST ID_CODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EWHOST ID_CKDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EWHOST ID_DQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EWHOST ID_ODOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_FKHOST ID_BADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FKHOST ID_CKDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FKHOST ID_KDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FRHOST ID_DIDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_GFHOST ID_BYDOMAINUSER)
...
(:goal (and (procnone) (PROP_HOST ID_IVRAT ID_EIHOST)(PROP_HOST ID_ISRAT ID_GTHOST)(PROP_HOST ID_IPRAT ID_GFHOST)(PROP_HOST ID_IORAT ID_FYHOST)(PROP_HOST ID_IRRAT ID_FRHOST)(PROP_HOST ID_IWRAT ID_EBHOST)(PROP_HOST ID_IURAT ID_DUHOST)(PROP_HOST ID_ITRAT ID_FDHOST)(PROP_HOST ID_IQRAT ID_EWHOST)(PROP_HOST ID_IXRAT ID_FKHOST)(PROP_HOST ID_IMRAT ID_EPHOST)))
