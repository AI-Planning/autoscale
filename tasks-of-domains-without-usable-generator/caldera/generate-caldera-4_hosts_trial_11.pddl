(define (problem p4_hosts_trial_11) (:domain CALDERA)
(:objects
...
(:goal (and (procnone) (PROP_HOST ID_CNRAT ID_CDHOST)(PROP_HOST ID_CMRAT ID_BWHOST)(PROP_HOST ID_CPRAT ID_BIHOST)))
