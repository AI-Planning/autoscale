(define (problem p17_hosts_trial_14) (:domain CALDERA)
(:objects
...
(:init
	(KNOWS ID_JCHOST)
	(KNOWS ID_JXRAT)
	(KNOWS_PROPERTY ID_JCHOST PFQDN)
	(KNOWS_PROPERTY ID_JXRAT PEXECUTABLE)
	(KNOWS_PROPERTY ID_JXRAT PHOST)
	(MEM_CACHED_DOMAIN_CREDS ID_FIHOST ID_BFDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FIHOST ID_BJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FPHOST ID_EHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FPHOST ID_ELDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FWHOST ID_CHDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_GKHOST ID_EXDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GKHOST ID_HDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GRHOST ID_BRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GRHOST ID_EHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GYHOST ID_DNDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GYHOST ID_DZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HFHOST ID_DVDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_IAHOST ID_DVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IHHOST ID_HDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IHHOST ID_LDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IOHOST ID_BZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IOHOST ID_EXDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IVHOST ID_DBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IVHOST ID_PDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JCHOST ID_BNDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JCHOST ID_EXDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JJHOST ID_BZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JJHOST ID_CHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JQHOST ID_DDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JQHOST ID_DJDOMAINCREDENTIAL)
	...
	(MEM_DOMAIN_USER_ADMINS ID_FWHOST ID_CDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FWHOST ID_CWDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GDHOST ID_BIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GDHOST ID_DUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GKHOST ID_CWDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GKHOST ID_DMDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GRHOST ID_CDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GRHOST ID_FADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GYHOST ID_DADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GYHOST ID_EWDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HFHOST ID_CWDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HFHOST ID_EWDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HMHOST ID_EKDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HMHOST ID_EODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HTHOST ID_BADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HTHOST ID_BYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IAHOST ID_CCDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IAHOST ID_ODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IHHOST ID_CDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IHHOST ID_CCDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IOHOST ID_CGDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IOHOST ID_SDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IVHOST ID_FEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IVHOST ID_ODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JCHOST ID_CKDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JCHOST ID_DYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JJHOST ID_DEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JJHOST ID_EKDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JQHOST ID_BEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JQHOST ID_SDOMAINUSER)
...
(:goal (and (procnone) (PROP_HOST ID_KQRAT ID_JQHOST)(PROP_HOST ID_KXRAT ID_IHHOST)(PROP_HOST ID_LCRAT ID_IVHOST)(PROP_HOST ID_LGRAT ID_GKHOST)(PROP_HOST ID_KURAT ID_IAHOST)(PROP_HOST ID_LARAT ID_GYHOST)(PROP_HOST ID_KRRAT ID_GDHOST)(PROP_HOST ID_KWRAT ID_JJHOST)(PROP_HOST ID_KSRAT ID_FIHOST)(PROP_HOST ID_LERAT ID_IOHOST)(PROP_HOST ID_LBRAT ID_GRHOST)(PROP_HOST ID_LDRAT ID_HTHOST)(PROP_HOST ID_LFRAT ID_HMHOST)(PROP_HOST ID_KYRAT ID_FWHOST)(PROP_HOST ID_KTRAT ID_HFHOST)(PROP_HOST ID_KZRAT ID_FPHOST)))
