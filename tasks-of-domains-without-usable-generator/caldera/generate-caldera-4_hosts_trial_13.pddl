(define (problem p4_hosts_trial_13) (:domain CALDERA)
(:objects
...
(:goal (and (procnone) (PROP_HOST ID_CQRAT ID_BWHOST)(PROP_HOST ID_CTRAT ID_BPHOST)(PROP_HOST ID_CSRAT ID_BIHOST)))
