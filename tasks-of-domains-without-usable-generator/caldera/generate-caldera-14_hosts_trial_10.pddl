(define (problem p14_hosts_trial_10) (:domain CALDERA)
(:objects
...
(:init
	(KNOWS ID_HBHOST)
	(KNOWS ID_HWRAT)
	(KNOWS_PROPERTY ID_HBHOST PFQDN)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_ECHOST ID_DRDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_EJHOST ID_CPDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_EQHOST ID_DNDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_EQHOST ID_DVDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_EXHOST ID_CPDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_EXHOST ID_CXDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FEHOST ID_BBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FEHOST ID_BNDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FEHOST ID_BZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FEHOST ID_CTDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FEHOST ID_DBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FLHOST ID_BJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FLHOST ID_BNDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FLHOST ID_DRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FLHOST ID_DZDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_FSHOST ID_DFDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_FZHOST ID_DZDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_GUHOST ID_CLDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GUHOST ID_CXDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HBHOST ID_BJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HBHOST ID_BZDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_HIHOST ID_DZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HPHOST ID_BBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HPHOST ID_CLDOMAINCREDENTIAL)
	...
	(MEM_DOMAIN_USER_ADMINS ID_ECHOST ID_DIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EJHOST ID_CKDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EJHOST ID_DQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EQHOST ID_CGDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EQHOST ID_CODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EXHOST ID_BUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EXHOST ID_GDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FEHOST ID_BEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FEHOST ID_DQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FLHOST ID_BUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FLHOST ID_DIDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_FZHOST ID_CCDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_GUHOST ID_KDOMAINUSER)
...
(:goal (and (procnone) (PROP_HOST ID_JGRAT ID_HIHOST)(PROP_HOST ID_JMRAT ID_GUHOST)(PROP_HOST ID_JDRAT ID_HPHOST)(PROP_HOST ID_JNRAT ID_EJHOST)(PROP_HOST ID_JHRAT ID_EQHOST)(PROP_HOST ID_JLRAT ID_GNHOST)(PROP_HOST ID_JFRAT ID_ECHOST)(PROP_HOST ID_JBRAT ID_GGHOST)(PROP_HOST ID_JKRAT ID_FSHOST)(PROP_HOST ID_JJRAT ID_FLHOST)(PROP_HOST ID_JERAT ID_FZHOST)(PROP_HOST ID_JARAT ID_FEHOST)(PROP_HOST ID_JCRAT ID_EXHOST)))
