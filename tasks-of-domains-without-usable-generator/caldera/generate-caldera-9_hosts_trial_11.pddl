(define (problem p9_hosts_trial_11) (:domain CALDERA)
(:objects
...
(:init
	(KNOWS ID_FAHOST)
	(KNOWS ID_FHRAT)
	(KNOWS_PROPERTY ID_FAHOST PFQDN)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_DRHOST ID_CHDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_DYHOST ID_BZDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_EMHOST ID_CTDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_ETHOST ID_BBDOMAINCREDENTIAL)
	...
	(MEM_DOMAIN_USER_ADMINS ID_DDHOST ID_BUDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_EMHOST ID_CCDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_FAHOST ID_BYDOMAINUSER)
...
(:goal (and (procnone) (PROP_HOST ID_GMRAT ID_EFHOST)(PROP_HOST ID_GLRAT ID_DYHOST)(PROP_HOST ID_GQRAT ID_ETHOST)(PROP_HOST ID_GNRAT ID_EMHOST)(PROP_HOST ID_GPRAT ID_DKHOST)(PROP_HOST ID_GRRAT ID_CWHOST)(PROP_HOST ID_GSRAT ID_DRHOST)(PROP_HOST ID_GKRAT ID_DDHOST)))
