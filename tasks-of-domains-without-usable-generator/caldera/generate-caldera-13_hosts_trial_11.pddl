(define (problem p13_hosts_trial_11) (:domain CALDERA)
(:objects
...
(:init
	(KNOWS ID_FZHOST)
	(KNOWS ID_HPRAT)
	(KNOWS_PROPERTY ID_FZHOST PFQDN)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_EJHOST ID_DNDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_EXHOST ID_DZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FEHOST ID_DRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FEHOST ID_HDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FLHOST ID_BVDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_GUHOST ID_DVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HBHOST ID_CHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HBHOST ID_CLDOMAINCREDENTIAL)
	...
	(MEM_DOMAIN_USER_ADMINS ID_EQHOST ID_DMDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_FEHOST ID_CCDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_FSHOST ID_BIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FSHOST ID_CODOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_GUHOST ID_DADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GUHOST ID_DMDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HBHOST ID_BEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HBHOST ID_ODOMAINUSER)
...
(:goal (and (procnone) (PROP_HOST ID_IHRAT ID_HIHOST)(PROP_HOST ID_IKRAT ID_HBHOST)(PROP_HOST ID_ILRAT ID_GNHOST)(PROP_HOST ID_IIRAT ID_GGHOST)(PROP_HOST ID_IJRAT ID_EJHOST)(PROP_HOST ID_IFRAT ID_EQHOST)(PROP_HOST ID_IGRAT ID_FSHOST)(PROP_HOST ID_IQRAT ID_EXHOST)(PROP_HOST ID_INRAT ID_FLHOST)(PROP_HOST ID_IORAT ID_GUHOST)(PROP_HOST ID_IMRAT ID_FEHOST)(PROP_HOST ID_IPRAT ID_ECHOST)))
