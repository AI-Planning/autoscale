(define (problem p19_hosts_trial_16) (:domain CALDERA)
(:objects
...
(:init
	(KNOWS ID_JLHOST)
	(KNOWS ID_LBRAT)
	(KNOWS_PROPERTY ID_JLHOST PFQDN)
	(KNOWS_PROPERTY ID_LBRAT PEXECUTABLE)
	(KNOWS_PROPERTY ID_LBRAT PHOST)
	(MEM_CACHED_DOMAIN_CREDS ID_FYHOST ID_DBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FYHOST ID_FVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GFHOST ID_CHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GFHOST ID_ELDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GMHOST ID_EXDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GMHOST ID_FRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GTHOST ID_CPDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GTHOST ID_DJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HAHOST ID_DNDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HAHOST ID_FRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HHHOST ID_DVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HHHOST ID_DZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HOHOST ID_BJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HOHOST ID_BVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HVHOST ID_BBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HVHOST ID_BRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_ICHOST ID_DRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_ICHOST ID_FVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IJHOST ID_DZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IJHOST ID_FBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IQHOST ID_DJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IQHOST ID_FJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IXHOST ID_CLDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IXHOST ID_TDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JEHOST ID_DDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JEHOST ID_DZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JLHOST ID_DJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JLHOST ID_LDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JSHOST ID_CXDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JSHOST ID_DNDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JZHOST ID_EXDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JZHOST ID_FVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KGHOST ID_BNDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KGHOST ID_EDDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KNHOST ID_CXDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KNHOST ID_EDDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KUHOST ID_BBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KUHOST ID_CDDOMAINCREDENTIAL)
	(MEM_DOMAIN_USER_ADMINS ID_FYHOST ID_BQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FYHOST ID_DADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GFHOST ID_BADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GFHOST ID_CODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GMHOST ID_CKDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_HAHOST ID_CWDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HAHOST ID_ESDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HHHOST ID_CDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HHHOST ID_DMDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HOHOST ID_CSDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HOHOST ID_SDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HVHOST ID_BQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HVHOST ID_DMDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_ICHOST ID_BQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_ICHOST ID_DEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IJHOST ID_BUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IJHOST ID_DYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IQHOST ID_BIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IQHOST ID_BQDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_JLHOST ID_EWDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JLHOST ID_WDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JSHOST ID_BADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JSHOST ID_EODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JZHOST ID_CDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JZHOST ID_EODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KGHOST ID_EKDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KGHOST ID_ESDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KNHOST ID_CSDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KNHOST ID_EKDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KUHOST ID_CDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KUHOST ID_EODOMAINUSER)
	...
	(PROP_DC ID_JLHOST YES)
	(PROP_DC ID_JSHOST NO)
	(PROP_DC ID_JZHOST NO)
	(PROP_DC ID_KGHOST YES)
	...
	(PROP_FQDN ID_HAHOST STR__HE)
	(PROP_FQDN ID_HHHOST STR__HL)
	(PROP_FQDN ID_HOHOST STR__HS)
	(PROP_FQDN ID_HVHOST STR__HZ)
	...
	(PROP_HOSTNAME ID_IQHOST STR__IW)
	(PROP_HOSTNAME ID_IXHOST STR__JD)
	(PROP_HOSTNAME ID_JEHOST STR__JK)
	(PROP_HOSTNAME ID_JLHOST STR__JR)
	(PROP_HOSTNAME ID_JSHOST STR__JY)
	(PROP_HOSTNAME ID_JZHOST STR__KF)
	(PROP_HOSTNAME ID_KGHOST STR__KM)
	(PROP_HOSTNAME ID_KNHOST STR__KT)
	(PROP_HOSTNAME ID_KUHOST STR__LA)
	...
	(PROP_MICROSECONDS ID_HITIMEDELTA NUM__191)
	(PROP_MICROSECONDS ID_HPTIMEDELTA NUM__198)
	(PROP_MICROSECONDS ID_HWTIMEDELTA NUM__205)
	...
	(PROP_MICROSECONDS ID_KOTIMEDELTA NUM__275)
	(PROP_MICROSECONDS ID_KVTIMEDELTA NUM__282)
	...
	(PROP_SECONDS ID_HITIMEDELTA NUM__192)
	(PROP_SECONDS ID_HPTIMEDELTA NUM__199)
	(PROP_SECONDS ID_HWTIMEDELTA NUM__206)
	...
	(PROP_SECONDS ID_KOTIMEDELTA NUM__276)
	(PROP_SECONDS ID_KVTIMEDELTA NUM__283)
...
(:goal (and (procnone) (PROP_HOST ID_MFRAT ID_KUHOST)(PROP_HOST ID_MDRAT ID_ICHOST)(PROP_HOST ID_LYRAT ID_HVHOST)(PROP_HOST ID_MGRAT ID_HAHOST)(PROP_HOST ID_MIRAT ID_KGHOST)(PROP_HOST ID_MCRAT ID_IXHOST)(PROP_HOST ID_MARAT ID_GMHOST)(PROP_HOST ID_MBRAT ID_KNHOST)(PROP_HOST ID_MMRAT ID_JZHOST)(PROP_HOST ID_MNRAT ID_JSHOST)(PROP_HOST ID_MJRAT ID_HOHOST)(PROP_HOST ID_MLRAT ID_GTHOST)(PROP_HOST ID_MKRAT ID_HHHOST)(PROP_HOST ID_LZRAT ID_JEHOST)(PROP_HOST ID_MORAT ID_GFHOST)(PROP_HOST ID_MERAT ID_IJHOST)(PROP_HOST ID_LWRAT ID_FYHOST)(PROP_HOST ID_MHRAT ID_IQHOST)))
