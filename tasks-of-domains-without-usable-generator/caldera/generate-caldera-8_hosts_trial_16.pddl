(define (problem p8_hosts_trial_16) (:domain CALDERA)
(:objects
...
(:init
	...
	(MEM_CACHED_DOMAIN_CREDS ID_COHOST ID_BNDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_DXHOST ID_BRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_DXHOST ID_DDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_EEHOST ID_BFDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_EEHOST ID_BRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_ELHOST ID_CDDOMAINCREDENTIAL)
	...
	(MEM_DOMAIN_USER_ADMINS ID_EEHOST ID_CGDOMAINUSER)
...
(:goal (and (procnone) (PROP_HOST ID_EZRAT ID_ELHOST)(PROP_HOST ID_FARAT ID_DJHOST)(PROP_HOST ID_EYRAT ID_DCHOST)(PROP_HOST ID_EVRAT ID_DQHOST)(PROP_HOST ID_EWRAT ID_CVHOST)(PROP_HOST ID_EURAT ID_EEHOST)(PROP_HOST ID_FBRAT ID_DXHOST)))
