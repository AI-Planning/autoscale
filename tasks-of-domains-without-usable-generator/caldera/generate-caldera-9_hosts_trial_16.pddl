(define (problem p9_hosts_trial_16) (:domain CALDERA)
(:objects
	NUM__77 - NUM
	NUM__111 - NUM
	NUM__125 - NUM
...
(:init
	(KNOWS ID_EMHOST)
	(KNOWS ID_FHRAT)
	(KNOWS_PROPERTY ID_EMHOST PFQDN)
	(KNOWS_PROPERTY ID_FHRAT PEXECUTABLE)
	(KNOWS_PROPERTY ID_FHRAT PHOST)
	(MEM_CACHED_DOMAIN_CREDS ID_CWHOST ID_TDOMAINCREDENTIAL)
	...
	(MEM_DOMAIN_USER_ADMINS ID_CWHOST ID_BEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_DDHOST ID_CKDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_DDHOST ID_WDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_DKHOST ID_BUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_DKHOST ID_CODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_DRHOST ID_CCDOMAINUSER)
...
(:goal (and (procnone) (PROP_HOST ID_GIRAT ID_FAHOST)(PROP_HOST ID_GFRAT ID_DDHOST)(PROP_HOST ID_GHRAT ID_DKHOST)(PROP_HOST ID_GCRAT ID_CWHOST)(PROP_HOST ID_GDRAT ID_DYHOST)(PROP_HOST ID_GJRAT ID_ETHOST)(PROP_HOST ID_GBRAT ID_DRHOST)(PROP_HOST ID_GERAT ID_EFHOST)))
