(define (problem p8_hosts_trial_14) (:domain CALDERA)
(:objects
...
(:init
	...
	(MEM_DOMAIN_USER_ADMINS ID_COHOST ID_BYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_CVHOST ID_BQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_CVHOST ID_BUDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_DXHOST ID_BYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_DXHOST ID_CDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EEHOST ID_BQDOMAINUSER)
...
(:goal (and (procnone) (PROP_HOST ID_FVRAT ID_DQHOST)(PROP_HOST ID_FURAT ID_DXHOST)(PROP_HOST ID_FZRAT ID_EEHOST)(PROP_HOST ID_FSRAT ID_COHOST)(PROP_HOST ID_FTRAT ID_DCHOST)(PROP_HOST ID_FXRAT ID_ELHOST)(PROP_HOST ID_FYRAT ID_DJHOST)))
