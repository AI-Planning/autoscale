(define (problem p9_hosts_trial_5) (:domain CALDERA)
(:objects
...
(:goal (and (procnone) (PROP_HOST ID_EGRAT ID_BGHOST)(PROP_HOST ID_EORAT ID_SHOST)(PROP_HOST ID_EHRAT ID_BUHOST)(PROP_HOST ID_EMRAT ID_CPHOST)(PROP_HOST ID_EJRAT ID_BNHOST)(PROP_HOST ID_EKRAT ID_CBHOST)(PROP_HOST ID_ENRAT ID_ZHOST)(PROP_HOST ID_ELRAT ID_CWHOST)))
