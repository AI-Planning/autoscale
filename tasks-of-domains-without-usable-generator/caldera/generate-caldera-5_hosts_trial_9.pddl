(define (problem p5_hosts_trial_9) (:domain CALDERA)
(:objects
...
(:goal (and (procnone) (PROP_HOST ID_EQRAT ID_DCHOST)(PROP_HOST ID_ESRAT ID_DQHOST)(PROP_HOST ID_EORAT ID_COHOST)(PROP_HOST ID_EPRAT ID_CVHOST)))
