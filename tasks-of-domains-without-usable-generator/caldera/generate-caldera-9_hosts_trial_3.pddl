(define (problem p9_hosts_trial_3) (:domain CALDERA)
(:objects
...
(:goal (and (procnone) (PROP_HOST ID_ECRAT ID_BUHOST)(PROP_HOST ID_EFRAT ID_CPHOST)(PROP_HOST ID_EERAT ID_BGHOST)(PROP_HOST ID_DXRAT ID_BNHOST)(PROP_HOST ID_EBRAT ID_CIHOST)(PROP_HOST ID_EARAT ID_CBHOST)(PROP_HOST ID_DZRAT ID_SHOST)(PROP_HOST ID_DYRAT ID_CWHOST)))
