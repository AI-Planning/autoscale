(define (problem p13_hosts_trial_14) (:domain CALDERA)
(:objects
...
(:init
	...
	(MEM_CACHED_DOMAIN_CREDS ID_FEHOST ID_BJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FEHOST ID_CHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FLHOST ID_CLDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FLHOST ID_DBDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_FZHOST ID_CTDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GGHOST ID_CDDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GGHOST ID_CHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GNHOST ID_BRDOMAINCREDENTIAL)
	...
	(MEM_DOMAIN_USER_ADMINS ID_ECHOST ID_CGDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_ECHOST ID_DIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EJHOST ID_DEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EJHOST ID_SDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EQHOST ID_DUDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_FSHOST ID_CWDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FSHOST ID_ODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FZHOST ID_BIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FZHOST ID_GDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GGHOST ID_DADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GGHOST ID_DYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GNHOST ID_CDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GNHOST ID_CWDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GUHOST ID_BEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GUHOST ID_CSDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HBHOST ID_BEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HBHOST ID_GDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HIHOST ID_CKDOMAINUSER)
...
(:goal (and (procnone) (PROP_HOST ID_IGRAT ID_HBHOST)(PROP_HOST ID_IPRAT ID_HIHOST)(PROP_HOST ID_IMRAT ID_GUHOST)(PROP_HOST ID_ILRAT ID_GNHOST)(PROP_HOST ID_IKRAT ID_FEHOST)(PROP_HOST ID_IJRAT ID_EJHOST)(PROP_HOST ID_IQRAT ID_EQHOST)(PROP_HOST ID_IORAT ID_FSHOST)(PROP_HOST ID_IERAT ID_FLHOST)(PROP_HOST ID_IHRAT ID_GGHOST)(PROP_HOST ID_INRAT ID_ECHOST)(PROP_HOST ID_IFRAT ID_EXHOST)))
