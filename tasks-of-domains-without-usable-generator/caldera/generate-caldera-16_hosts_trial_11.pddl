(define (problem p16_hosts_trial_11) (:domain CALDERA)
(:objects
...
(:init
	(KNOWS ID_HSHOST)
	(KNOWS ID_JIRAT)
	(KNOWS_PROPERTY ID_HSHOST PFQDN)
	(KNOWS_PROPERTY ID_JIRAT PEXECUTABLE)
	(KNOWS_PROPERTY ID_JIRAT PHOST)
	(MEM_CACHED_DOMAIN_CREDS ID_FAHOST ID_DJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FAHOST ID_ELDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FHHOST ID_BVDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_FVHOST ID_CTDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FVHOST ID_EXDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GCHOST ID_BNDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GCHOST ID_BVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GJHOST ID_PDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GJHOST ID_XDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GQHOST ID_BBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GQHOST ID_ETDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GXHOST ID_DVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GXHOST ID_EXDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HEHOST ID_CHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HEHOST ID_EPDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HLHOST ID_BBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HLHOST ID_BFDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HSHOST ID_CTDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_IGHOST ID_CPDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IGHOST ID_EHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_INHOST ID_BJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_INHOST ID_HDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IUHOST ID_BNDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IUHOST ID_DDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JBHOST ID_CXDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JBHOST ID_DRDOMAINCREDENTIAL)
	(MEM_DOMAIN_USER_ADMINS ID_FAHOST ID_DIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FAHOST ID_EODOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_FOHOST ID_EODOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_GCHOST ID_DYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GJHOST ID_DIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GJHOST ID_EKDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GQHOST ID_BQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GQHOST ID_DUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GXHOST ID_DQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GXHOST ID_ESDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HEHOST ID_CODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HEHOST ID_ESDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HLHOST ID_DYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HLHOST ID_EGDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HSHOST ID_DMDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HSHOST ID_EGDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HZHOST ID_EWDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HZHOST ID_KDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IGHOST ID_BADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IGHOST ID_BYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_INHOST ID_BUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_INHOST ID_DMDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IUHOST ID_DEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IUHOST ID_DIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JBHOST ID_DUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JBHOST ID_DYDOMAINUSER)
	...
	(PROP_DNS_DOMAIN_NAME ID_HZHOST STR__ID)
	(PROP_DNS_DOMAIN_NAME ID_IGHOST STR__IK)
	(PROP_DNS_DOMAIN_NAME ID_INHOST STR__IR)
	(PROP_DNS_DOMAIN_NAME ID_IUHOST STR__IY)
	(PROP_DNS_DOMAIN_NAME ID_JBHOST STR__JF)
	...
	(PROP_HOSTNAME ID_HZHOST STR__IF)
	(PROP_HOSTNAME ID_IGHOST STR__IM)
	(PROP_HOSTNAME ID_INHOST STR__IT)
	(PROP_HOSTNAME ID_IUHOST STR__JA)
	(PROP_HOSTNAME ID_JBHOST STR__JH)
...
(:goal (and (procnone) (PROP_HOST ID_KERAT ID_JBHOST)(PROP_HOST ID_KLRAT ID_HEHOST)(PROP_HOST ID_KJRAT ID_FOHOST)(PROP_HOST ID_KHRAT ID_HZHOST)(PROP_HOST ID_KDRAT ID_FHHOST)(PROP_HOST ID_KGRAT ID_IUHOST)(PROP_HOST ID_KMRAT ID_FVHOST)(PROP_HOST ID_KCRAT ID_FAHOST)(PROP_HOST ID_KPRAT ID_INHOST)(PROP_HOST ID_KARAT ID_IGHOST)(PROP_HOST ID_KIRAT ID_GCHOST)(PROP_HOST ID_KORAT ID_GXHOST)(PROP_HOST ID_KFRAT ID_GJHOST)(PROP_HOST ID_KNRAT ID_HLHOST)(PROP_HOST ID_KKRAT ID_GQHOST)))
