(define (problem p14_hosts_trial_16) (:domain CALDERA)
(:objects
...
(:init
	...
	(MEM_CACHED_DOMAIN_CREDS ID_EKHOST ID_DVDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_EYHOST ID_BVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_EYHOST ID_CDDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FFHOST ID_EDDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FFHOST ID_EHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FMHOST ID_BJDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_GHHOST ID_CDDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_HQHOST ID_CTDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HQHOST ID_EDDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HXHOST ID_CHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HXHOST ID_TDOMAINCREDENTIAL)
	...
	(MEM_DOMAIN_USER_ADMINS ID_EYHOST ID_CKDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EYHOST ID_KDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FFHOST ID_CGDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FFHOST ID_CODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FMHOST ID_BMDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FMHOST ID_CODOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_GAHOST ID_DUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GHHOST ID_CCDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GHHOST ID_DIDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_GVHOST ID_BYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HCHOST ID_BQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HCHOST ID_DIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HJHOST ID_CKDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HJHOST ID_DYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HQHOST ID_CODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HQHOST ID_DADOMAINUSER)
...
(:goal (and (procnone) (PROP_HOST ID_JGRAT ID_GAHOST)(PROP_HOST ID_JERAT ID_GHHOST)(PROP_HOST ID_JFRAT ID_HXHOST)(PROP_HOST ID_IVRAT ID_FFHOST)(PROP_HOST ID_IYRAT ID_FMHOST)(PROP_HOST ID_JCRAT ID_EYHOST)(PROP_HOST ID_IURAT ID_HCHOST)(PROP_HOST ID_IZRAT ID_HQHOST)(PROP_HOST ID_IXRAT ID_HJHOST)(PROP_HOST ID_JDRAT ID_GVHOST)(PROP_HOST ID_JBRAT ID_ERHOST)(PROP_HOST ID_JARAT ID_FTHOST)(PROP_HOST ID_JHRAT ID_EKHOST)))
