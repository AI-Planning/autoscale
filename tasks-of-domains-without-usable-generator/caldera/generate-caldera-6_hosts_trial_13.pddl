(define (problem p6_hosts_trial_13) (:domain CALDERA)
(:objects
...
(:goal (and (procnone) (PROP_HOST ID_DZRAT ID_CTHOST)(PROP_HOST ID_DYRAT ID_CMHOST)(PROP_HOST ID_EBRAT ID_BYHOST)(PROP_HOST ID_EARAT ID_DAHOST)(PROP_HOST ID_DWRAT ID_CFHOST)))
