(define (problem p7_hosts_trial_11) (:domain CALDERA)
(:objects
...
(:goal (and (procnone) (PROP_HOST ID_EHRAT ID_CUHOST)(PROP_HOST ID_EGRAT ID_CNHOST)(PROP_HOST ID_ELRAT ID_CGHOST)(PROP_HOST ID_EIRAT ID_DIHOST)(PROP_HOST ID_EKRAT ID_DBHOST)(PROP_HOST ID_EFRAT ID_DWHOST)))
