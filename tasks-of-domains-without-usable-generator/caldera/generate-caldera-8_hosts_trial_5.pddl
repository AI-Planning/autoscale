(define (problem p8_hosts_trial_5) (:domain CALDERA)
(:objects
...
(:goal (and (procnone) (PROP_HOST ID_DPRAT ID_CPHOST)(PROP_HOST ID_DORAT ID_SHOST)(PROP_HOST ID_DRRAT ID_CBHOST)(PROP_HOST ID_DSRAT ID_ZHOST)(PROP_HOST ID_DURAT ID_BNHOST)(PROP_HOST ID_DVRAT ID_CIHOST)(PROP_HOST ID_DQRAT ID_BUHOST)))
