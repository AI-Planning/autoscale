(define (problem p6_hosts_trial_14) (:domain CALDERA)
(:objects
...
(:goal (and (procnone) (PROP_HOST ID_DURAT ID_BYHOST)(PROP_HOST ID_DRRAT ID_DHHOST)(PROP_HOST ID_DVRAT ID_CTHOST)(PROP_HOST ID_DQRAT ID_DAHOST)(PROP_HOST ID_DTRAT ID_CFHOST)))
