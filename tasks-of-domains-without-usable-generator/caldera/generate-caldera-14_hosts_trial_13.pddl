(define (problem p14_hosts_trial_13) (:domain CALDERA)
(:objects
...
(:init
	...
	(MEM_CACHED_DOMAIN_CREDS ID_EKHOST ID_BRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_EKHOST ID_CPDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_EKHOST ID_DZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_ERHOST ID_DBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_ERHOST ID_DJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_ERHOST ID_DRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_EYHOST ID_CPDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_EYHOST ID_DVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_EYHOST ID_LDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FFHOST ID_BVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FFHOST ID_CDDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FFHOST ID_DRDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_FTHOST ID_TDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GAHOST ID_BRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GAHOST ID_CHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GAHOST ID_CTDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_GOHOST ID_BFDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GOHOST ID_BVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GOHOST ID_CPDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GVHOST ID_BZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GVHOST ID_CDDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GVHOST ID_CHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HCHOST ID_CLDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HCHOST ID_DFDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HCHOST ID_TDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HJHOST ID_BZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HJHOST ID_DBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HJHOST ID_DZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HQHOST ID_CDDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HQHOST ID_EHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HQHOST ID_HDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HXHOST ID_BNDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HXHOST ID_CDDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HXHOST ID_PDOMAINCREDENTIAL)
	(MEM_DOMAIN_USER_ADMINS ID_EKHOST ID_DADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EKHOST ID_ODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_ERHOST ID_DYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_ERHOST ID_KDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EYHOST ID_BYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EYHOST ID_DEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FFHOST ID_BEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FFHOST ID_BYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FMHOST ID_BQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FMHOST ID_DUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FTHOST ID_DIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FTHOST ID_GDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GAHOST ID_BEDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_GOHOST ID_CDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_HJHOST ID_DYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HJHOST ID_KDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HQHOST ID_EGDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HQHOST ID_GDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HXHOST ID_BUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HXHOST ID_CCDOMAINUSER)
...
(:goal (and (procnone) (PROP_HOST ID_IPRAT ID_FFHOST)(PROP_HOST ID_IHRAT ID_EKHOST)(PROP_HOST ID_IMRAT ID_HCHOST)(PROP_HOST ID_IJRAT ID_HXHOST)(PROP_HOST ID_INRAT ID_GVHOST)(PROP_HOST ID_IGRAT ID_GHHOST)(PROP_HOST ID_IRRAT ID_HJHOST)(PROP_HOST ID_IQRAT ID_GAHOST)(PROP_HOST ID_ITRAT ID_ERHOST)(PROP_HOST ID_ISRAT ID_GOHOST)(PROP_HOST ID_IIRAT ID_HQHOST)(PROP_HOST ID_IKRAT ID_FMHOST)(PROP_HOST ID_ILRAT ID_FTHOST)))
