(define (problem p20_hosts_trial_14) (:domain CALDERA)
(:objects
	...
	ID_NMFILE - OBSERVEDFILE
	ID_NWFILE - OBSERVEDFILE
	ID_NKFILE - OBSERVEDFILE
	ID_NNFILE - OBSERVEDFILE
	ID_NJFILE - OBSERVEDFILE
	ID_NOFILE - OBSERVEDFILE
...
(:init
	...
	(MEM_CACHED_DOMAIN_CREDS ID_GGHOST ID_CLDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GGHOST ID_HDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_GUHOST ID_DRDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_HPHOST ID_FRDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_IDHOST ID_FJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IKHOST ID_CDDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IKHOST ID_LDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IRHOST ID_CTDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_JTHOST ID_BJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JTHOST ID_EDDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KAHOST ID_BFDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KAHOST ID_CLDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KHHOST ID_ETDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KHHOST ID_TDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KOHOST ID_DFDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KOHOST ID_PDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KVHOST ID_CPDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KVHOST ID_XDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_LCHOST ID_DRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_LCHOST ID_FFDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_LJHOST ID_BVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_LJHOST ID_FNDOMAINCREDENTIAL)
	...
	(MEM_DOMAIN_USER_ADMINS ID_GNHOST ID_FMDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_HBHOST ID_DYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HIHOST ID_DQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HIHOST ID_KDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HPHOST ID_FEDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_IDHOST ID_DADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IDHOST ID_DQDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_IRHOST ID_EWDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IYHOST ID_BEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IYHOST ID_DIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JFHOST ID_BQDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_JTHOST ID_BIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JTHOST ID_BMDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KAHOST ID_BIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KAHOST ID_FUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KHHOST ID_CDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KHHOST ID_FMDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KOHOST ID_BUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KOHOST ID_FMDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KVHOST ID_BEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KVHOST ID_CCDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_LCHOST ID_BEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_LCHOST ID_BYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_LJHOST ID_BIDOMAINUSER)
...
(:goal (and (procnone) (PROP_HOST ID_OFRAT ID_LJHOST)(PROP_HOST ID_OORAT ID_HWHOST)(PROP_HOST ID_OQRAT ID_LCHOST)(PROP_HOST ID_OPRAT ID_JTHOST)(PROP_HOST ID_ORRAT ID_HBHOST)(PROP_HOST ID_OSRAT ID_IRHOST)(PROP_HOST ID_OERAT ID_HPHOST)(PROP_HOST ID_OGRAT ID_GNHOST)(PROP_HOST ID_ODRAT ID_KAHOST)(PROP_HOST ID_OIRAT ID_JMHOST)(PROP_HOST ID_OBRAT ID_IDHOST)(PROP_HOST ID_ONRAT ID_KVHOST)(PROP_HOST ID_OTRAT ID_GUHOST)(PROP_HOST ID_OJRAT ID_GGHOST)(PROP_HOST ID_OLRAT ID_KOHOST)(PROP_HOST ID_OARAT ID_KHHOST)(PROP_HOST ID_OKRAT ID_IKHOST)(PROP_HOST ID_OHRAT ID_HIHOST)(PROP_HOST ID_OMRAT ID_IYHOST)))
