(define (problem p16_hosts_trial_3) (:domain CALDERA)
(:objects
...
(:goal (and (procnone) (PROP_HOST ID_GTRAT ID_CWHOST)(PROP_HOST ID_GKRAT ID_BGHOST)(PROP_HOST ID_GPRAT ID_BNHOST)(PROP_HOST ID_GIRAT ID_ETHOST)(PROP_HOST ID_GQRAT ID_BUHOST)(PROP_HOST ID_GMRAT ID_DDHOST)(PROP_HOST ID_GRRAT ID_DKHOST)(PROP_HOST ID_GXRAT ID_CIHOST)(PROP_HOST ID_GNRAT ID_SHOST)(PROP_HOST ID_GURAT ID_CPHOST)(PROP_HOST ID_GWRAT ID_DRHOST)(PROP_HOST ID_GJRAT ID_DYHOST)(PROP_HOST ID_GSRAT ID_EFHOST)(PROP_HOST ID_GLRAT ID_EMHOST)(PROP_HOST ID_GVRAT ID_CBHOST)))
