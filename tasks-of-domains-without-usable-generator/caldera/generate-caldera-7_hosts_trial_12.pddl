(define (problem p7_hosts_trial_12) (:domain CALDERA)
(:objects
...
(:init
	...
	(MEM_CACHED_DOMAIN_CREDS ID_DWHOST ID_BZDOMAINCREDENTIAL)
...
(:goal (and (procnone) (PROP_HOST ID_EXRAT ID_DBHOST)(PROP_HOST ID_EYRAT ID_CNHOST)(PROP_HOST ID_ETRAT ID_DPHOST)(PROP_HOST ID_EZRAT ID_CUHOST)(PROP_HOST ID_EURAT ID_CGHOST)(PROP_HOST ID_EVRAT ID_DWHOST)))
