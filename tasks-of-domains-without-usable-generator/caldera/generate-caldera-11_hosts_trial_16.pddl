(define (problem p11_hosts_trial_16) (:domain CALDERA)
(:objects
...
(:init
	(KNOWS ID_EVHOST)
	(KNOWS ID_GLRAT)
	(KNOWS_PROPERTY ID_EVHOST PFQDN)
	(KNOWS_PROPERTY ID_GLRAT PEXECUTABLE)
	(KNOWS_PROPERTY ID_GLRAT PHOST)
	(MEM_CACHED_DOMAIN_CREDS ID_DMHOST ID_BRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_DMHOST ID_BZDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_EOHOST ID_BNDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_FQHOST ID_BJDOMAINCREDENTIAL)
	...
	(MEM_DOMAIN_USER_ADMINS ID_EAHOST ID_CODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EAHOST ID_ODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EHHOST ID_BMDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EHHOST ID_CODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EOHOST ID_BMDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_FQHOST ID_CWDOMAINUSER)
...
(:goal (and (procnone) (PROP_HOST ID_HCRAT ID_EHHOST)(PROP_HOST ID_HARAT ID_FQHOST)(PROP_HOST ID_HERAT ID_DMHOST)(PROP_HOST ID_GYRAT ID_FJHOST)(PROP_HOST ID_HIRAT ID_FCHOST)(PROP_HOST ID_HBRAT ID_EAHOST)(PROP_HOST ID_HDRAT ID_DTHOST)(PROP_HOST ID_HGRAT ID_FXHOST)(PROP_HOST ID_HHRAT ID_EOHOST)(PROP_HOST ID_HFRAT ID_GEHOST)))
