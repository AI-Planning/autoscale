(define (problem p11_hosts_trial_12) (:domain CALDERA)
(:objects
...
(:init
	...
	(MEM_CACHED_DOMAIN_CREDS ID_DMHOST ID_BJDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_DTHOST ID_DBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_EAHOST ID_BNDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_EAHOST ID_DJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_EAHOST ID_TDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_EHHOST ID_CLDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_EHHOST ID_CTDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_EHHOST ID_HDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_EOHOST ID_CHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_EOHOST ID_CXDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_FCHOST ID_CXDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_FQHOST ID_CDDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FQHOST ID_CPDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FQHOST ID_DDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FXHOST ID_CXDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FXHOST ID_DBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FXHOST ID_TDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GEHOST ID_CTDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GEHOST ID_CXDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GEHOST ID_DJDOMAINCREDENTIAL)
	(MEM_DOMAIN_USER_ADMINS ID_DMHOST ID_BIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_DMHOST ID_CODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_DMHOST ID_CWDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_EHHOST ID_BMDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EHHOST ID_CGDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EOHOST ID_CODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EOHOST ID_CWDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EOHOST ID_ODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EVHOST ID_CCDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_FJHOST ID_CSDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FJHOST ID_CWDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_FXHOST ID_CODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FXHOST ID_GDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GEHOST ID_CKDOMAINUSER)
...
(:goal (and (procnone) (PROP_HOST ID_HPRAT ID_FJHOST)(PROP_HOST ID_HSRAT ID_FCHOST)(PROP_HOST ID_HRRAT ID_EVHOST)(PROP_HOST ID_HQRAT ID_GEHOST)(PROP_HOST ID_HORAT ID_DMHOST)(PROP_HOST ID_HMRAT ID_FQHOST)(PROP_HOST ID_HTRAT ID_EOHOST)(PROP_HOST ID_HKRAT ID_DTHOST)(PROP_HOST ID_HLRAT ID_EAHOST)(PROP_HOST ID_HNRAT ID_EHHOST)))
