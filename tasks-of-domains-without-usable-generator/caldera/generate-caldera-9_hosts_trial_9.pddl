(define (problem p9_hosts_trial_9) (:domain CALDERA)
(:objects
...
(:goal (and (procnone) (PROP_HOST ID_HJRAT ID_EBHOST)(PROP_HOST ID_HLRAT ID_FYHOST)(PROP_HOST ID_HMRAT ID_FDHOST)(PROP_HOST ID_HPRAT ID_FRHOST)(PROP_HOST ID_HQRAT ID_EIHOST)(PROP_HOST ID_HORAT ID_DUHOST)(PROP_HOST ID_HNRAT ID_FKHOST)(PROP_HOST ID_HIRAT ID_EWHOST)))
