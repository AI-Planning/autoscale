(define (problem p5_hosts_trial_2) (:domain CALDERA)
(:objects
...
(:goal (and (procnone) (PROP_HOST ID_BYRAT ID_RHOST)(PROP_HOST ID_BZRAT ID_BFHOST)(PROP_HOST ID_BVRAT ID_YHOST)(PROP_HOST ID_BXRAT ID_BMHOST)))
