(define (problem p6_hosts_trial_12) (:domain CALDERA)
(:objects
...
(:goal (and (procnone) (PROP_HOST ID_DQRAT ID_CFHOST)(PROP_HOST ID_DRRAT ID_DHHOST)(PROP_HOST ID_DSRAT ID_DAHOST)(PROP_HOST ID_DURAT ID_CTHOST)(PROP_HOST ID_DVRAT ID_BYHOST)))
