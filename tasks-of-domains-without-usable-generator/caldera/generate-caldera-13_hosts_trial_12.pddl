(define (problem p13_hosts_trial_12) (:domain CALDERA)
(:objects
...
(:init
	(KNOWS ID_HIHOST)
	(KNOWS ID_HPRAT)
	(KNOWS_PROPERTY ID_HIHOST PFQDN)
	(KNOWS_PROPERTY ID_HPRAT PEXECUTABLE)
	(KNOWS_PROPERTY ID_HPRAT PHOST)
	(MEM_CACHED_DOMAIN_CREDS ID_ECHOST ID_CXDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_ECHOST ID_DVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_ECHOST ID_XDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_EJHOST ID_BJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_EJHOST ID_CLDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_EQHOST ID_DBDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_FEHOST ID_DNDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_FSHOST ID_DBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FSHOST ID_DZDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_GGHOST ID_DDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GGHOST ID_DJDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_GUHOST ID_DDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HBHOST ID_DDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HBHOST ID_LDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HBHOST ID_PDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HIHOST ID_BFDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HIHOST ID_DDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HIHOST ID_XDOMAINCREDENTIAL)
	(MEM_DOMAIN_USER_ADMINS ID_ECHOST ID_BADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_ECHOST ID_BEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_ECHOST ID_CSDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EJHOST ID_CCDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EJHOST ID_DADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EJHOST ID_DUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EQHOST ID_BIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EQHOST ID_DIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EQHOST ID_DYDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_FEHOST ID_CSDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_FSHOST ID_SDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FZHOST ID_BADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FZHOST ID_CDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FZHOST ID_CGDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_GNHOST ID_CSDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_HBHOST ID_DEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HIHOST ID_DMDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HIHOST ID_DUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HIHOST ID_WDOMAINUSER)
	...
	(PROP_FQDN ID_ECHOST STR__EH)
	(PROP_FQDN ID_EJHOST STR__EO)
	(PROP_FQDN ID_EQHOST STR__EV)
	(PROP_FQDN ID_EXHOST STR__FC)
	(PROP_FQDN ID_FEHOST STR__FJ)
	(PROP_FQDN ID_FLHOST STR__FQ)
	(PROP_FQDN ID_FSHOST STR__FX)
	(PROP_FQDN ID_FZHOST STR__GE)
	...
	(PROP_HOSTNAME ID_FEHOST STR__FI)
	(PROP_HOSTNAME ID_FLHOST STR__FP)
	(PROP_HOSTNAME ID_FSHOST STR__FW)
	(PROP_HOSTNAME ID_FZHOST STR__GD)
...
(:goal (and (procnone) (PROP_HOST ID_JPRAT ID_GNHOST)(PROP_HOST ID_JORAT ID_FSHOST)(PROP_HOST ID_JGRAT ID_ECHOST)(PROP_HOST ID_JMRAT ID_HBHOST)(PROP_HOST ID_JHRAT ID_FLHOST)(PROP_HOST ID_JNRAT ID_FEHOST)(PROP_HOST ID_JJRAT ID_EXHOST)(PROP_HOST ID_JIRAT ID_GGHOST)(PROP_HOST ID_JKRAT ID_EQHOST)(PROP_HOST ID_JERAT ID_GUHOST)(PROP_HOST ID_JFRAT ID_FZHOST)(PROP_HOST ID_JQRAT ID_EJHOST)))
