(define (problem p5_hosts_trial_15) (:domain CALDERA)
(:objects
...
(:goal (and (procnone) (PROP_HOST ID_DURAT ID_BXHOST)(PROP_HOST ID_DQRAT ID_CLHOST)(PROP_HOST ID_DSRAT ID_CEHOST)(PROP_HOST ID_DTRAT ID_CSHOST)))
