(define (problem p14_hosts_trial_14) (:domain CALDERA)
(:objects
	STR__FS - STRING
	STR__U - STRING
	STR__FQ - STRING
...
(:init
	...
	(MEM_CACHED_DOMAIN_CREDS ID_EKHOST ID_DFDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_EYHOST ID_DNDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_FTHOST ID_CXDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FTHOST ID_HDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GAHOST ID_BZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GAHOST ID_DDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_HJHOST ID_BVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HJHOST ID_CHDOMAINCREDENTIAL)
	...
	(MEM_DOMAIN_USER_ADMINS ID_EKHOST ID_CSDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_EYHOST ID_CCDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EYHOST ID_ODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FFHOST ID_BYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FFHOST ID_DIDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_GAHOST ID_GDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GHHOST ID_BADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GHHOST ID_CDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GOHOST ID_CGDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GOHOST ID_CODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GVHOST ID_DMDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GVHOST ID_KDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HCHOST ID_BADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HCHOST ID_GDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HJHOST ID_BEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HJHOST ID_EGDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_HXHOST ID_CODOMAINUSER)
...
(:goal (and (procnone) (PROP_HOST ID_JHRAT ID_FTHOST)(PROP_HOST ID_JFRAT ID_HQHOST)(PROP_HOST ID_JDRAT ID_GAHOST)(PROP_HOST ID_JCRAT ID_HJHOST)(PROP_HOST ID_IURAT ID_GOHOST)(PROP_HOST ID_JGRAT ID_HCHOST)(PROP_HOST ID_IVRAT ID_FFHOST)(PROP_HOST ID_IXRAT ID_HXHOST)(PROP_HOST ID_JBRAT ID_GHHOST)(PROP_HOST ID_IYRAT ID_ERHOST)(PROP_HOST ID_JERAT ID_FMHOST)(PROP_HOST ID_JARAT ID_GVHOST)(PROP_HOST ID_IZRAT ID_EKHOST)))
