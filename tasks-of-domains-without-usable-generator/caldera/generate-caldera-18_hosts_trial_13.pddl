(define (problem p18_hosts_trial_13) (:domain CALDERA)
(:objects
...
(:init
	...
	(MEM_CACHED_DOMAIN_CREDS ID_FQHOST ID_DVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FQHOST ID_DZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FQHOST ID_FFDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FXHOST ID_CDDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FXHOST ID_DFDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FXHOST ID_DVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GEHOST ID_BJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GEHOST ID_DZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GEHOST ID_LDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GLHOST ID_BBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GLHOST ID_BRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GLHOST ID_CXDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GSHOST ID_BBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GSHOST ID_EXDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GSHOST ID_LDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GZHOST ID_BRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GZHOST ID_EHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GZHOST ID_TDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HGHOST ID_EDDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HGHOST ID_FNDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HGHOST ID_TDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HNHOST ID_BZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HNHOST ID_CHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HNHOST ID_DZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HUHOST ID_CPDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HUHOST ID_EPDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HUHOST ID_TDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IBHOST ID_DJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IBHOST ID_ETDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IBHOST ID_FBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IIHOST ID_CLDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IIHOST ID_CPDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IIHOST ID_DVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IPHOST ID_DDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IPHOST ID_DZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IPHOST ID_XDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IWHOST ID_BBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IWHOST ID_BVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IWHOST ID_CPDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JDHOST ID_BNDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JDHOST ID_CLDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JDHOST ID_FNDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JKHOST ID_BZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JKHOST ID_CDDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JKHOST ID_EHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JRHOST ID_CLDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JRHOST ID_ETDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JRHOST ID_FNDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JYHOST ID_BZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JYHOST ID_FFDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JYHOST ID_PDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KFHOST ID_BBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KFHOST ID_BFDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KFHOST ID_DDOMAINCREDENTIAL)
	(MEM_DOMAIN_USER_ADMINS ID_FQHOST ID_CCDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FQHOST ID_FADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FXHOST ID_DADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FXHOST ID_EODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GEHOST ID_DIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GEHOST ID_ECDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GLHOST ID_DADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GLHOST ID_DIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GSHOST ID_DADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GSHOST ID_DIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GZHOST ID_DQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GZHOST ID_FMDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HGHOST ID_EKDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HGHOST ID_ESDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HNHOST ID_BQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HNHOST ID_ODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HUHOST ID_CKDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HUHOST ID_DADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IBHOST ID_DQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IBHOST ID_FEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IIHOST ID_BIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IIHOST ID_CWDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IPHOST ID_CKDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IPHOST ID_EWDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IWHOST ID_BQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IWHOST ID_GDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JDHOST ID_DQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JDHOST ID_WDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JKHOST ID_BADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JKHOST ID_CGDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JRHOST ID_BADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JRHOST ID_DYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JYHOST ID_BUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JYHOST ID_KDOMAINUSER)
	...
	(PROP_DC ID_GSHOST YES)
	(PROP_DC ID_GZHOST YES)
	(PROP_DC ID_HGHOST YES)
	(PROP_DC ID_HNHOST NO)
	(PROP_DC ID_HUHOST NO)
	(PROP_DC ID_IBHOST NO)
	(PROP_DC ID_IIHOST NO)
	(PROP_DC ID_IPHOST NO)
	(PROP_DC ID_IWHOST YES)
	(PROP_DC ID_JDHOST YES)
	(PROP_DC ID_JKHOST YES)
	...
	(PROP_DNS_DOMAIN_NAME ID_GLHOST STR__GQ)
	(PROP_DNS_DOMAIN_NAME ID_GSHOST STR__GX)
	(PROP_DNS_DOMAIN_NAME ID_GZHOST STR__HE)
	(PROP_DNS_DOMAIN_NAME ID_HGHOST STR__HL)
	(PROP_DNS_DOMAIN_NAME ID_HNHOST STR__HS)
	...
	(PROP_FQDN ID_GLHOST STR__GP)
	(PROP_FQDN ID_GSHOST STR__GW)
	(PROP_FQDN ID_GZHOST STR__HD)
	(PROP_FQDN ID_HGHOST STR__HK)
	(PROP_FQDN ID_HNHOST STR__HR)
	(PROP_FQDN ID_HUHOST STR__HY)
	(PROP_FQDN ID_IBHOST STR__IF)
	(PROP_FQDN ID_IIHOST STR__IM)
	(PROP_FQDN ID_IPHOST STR__IT)
	(PROP_FQDN ID_IWHOST STR__JA)
	(PROP_FQDN ID_JDHOST STR__JH)
	(PROP_FQDN ID_JKHOST STR__JO)
	(PROP_FQDN ID_JRHOST STR__JV)
	(PROP_FQDN ID_JYHOST STR__KC)
	(PROP_FQDN ID_KFHOST STR__KJ)
...
(:goal (and (procnone) (PROP_HOST ID_LYRAT ID_JDHOST)(PROP_HOST ID_MJRAT ID_HNHOST)(PROP_HOST ID_MERAT ID_IBHOST)(PROP_HOST ID_MKRAT ID_IIHOST)(PROP_HOST ID_MFRAT ID_FXHOST)(PROP_HOST ID_MARAT ID_IWHOST)(PROP_HOST ID_MIRAT ID_HGHOST)(PROP_HOST ID_MHRAT ID_JKHOST)(PROP_HOST ID_MORAT ID_GSHOST)(PROP_HOST ID_MCRAT ID_JYHOST)(PROP_HOST ID_MNRAT ID_IPHOST)(PROP_HOST ID_LZRAT ID_GEHOST)(PROP_HOST ID_MDRAT ID_GLHOST)(PROP_HOST ID_MLRAT ID_JRHOST)(PROP_HOST ID_MBRAT ID_KFHOST)(PROP_HOST ID_MGRAT ID_GZHOST)(PROP_HOST ID_MPRAT ID_FQHOST)))
