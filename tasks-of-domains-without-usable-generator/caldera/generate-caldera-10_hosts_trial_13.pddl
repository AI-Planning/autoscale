(define (problem p10_hosts_trial_13) (:domain CALDERA)
(:objects
...
(:init
	(KNOWS ID_FBHOST)
	(KNOWS ID_FWRAT)
	(KNOWS_PROPERTY ID_FBHOST PFQDN)
	(KNOWS_PROPERTY ID_FWRAT PEXECUTABLE)
	(KNOWS_PROPERTY ID_FWRAT PHOST)
	(MEM_CACHED_DOMAIN_CREDS ID_DEHOST ID_BBDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_DLHOST ID_CHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_DLHOST ID_TDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_DSHOST ID_BFDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_DSHOST ID_BRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_DSHOST ID_CTDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_DZHOST ID_CHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_DZHOST ID_CTDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_DZHOST ID_DBDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_ENHOST ID_BRDOMAINCREDENTIAL)
	...
	(MEM_DOMAIN_USER_ADMINS ID_DEHOST ID_BYDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_ENHOST ID_CODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_ENHOST ID_KDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_ENHOST ID_WDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_FBHOST ID_CWDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FBHOST ID_WDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FIHOST ID_BIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FIHOST ID_BMDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FIHOST ID_CCDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FPHOST ID_CKDOMAINUSER)
...
(:goal (and (procnone) (PROP_HOST ID_HCRAT ID_DLHOST)(PROP_HOST ID_HLRAT ID_EUHOST)(PROP_HOST ID_HDRAT ID_DZHOST)(PROP_HOST ID_HGRAT ID_EGHOST)(PROP_HOST ID_HKRAT ID_ENHOST)(PROP_HOST ID_HJRAT ID_FIHOST)(PROP_HOST ID_HIRAT ID_DEHOST)(PROP_HOST ID_HERAT ID_DSHOST)(PROP_HOST ID_HHRAT ID_FPHOST)))
