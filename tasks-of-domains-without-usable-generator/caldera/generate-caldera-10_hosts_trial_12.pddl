(define (problem p10_hosts_trial_12) (:domain CALDERA)
(:objects
...
(:init
	...
	(MEM_CACHED_DOMAIN_CREDS ID_EGHOST ID_BFDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_EUHOST ID_DDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_FPHOST ID_CLDOMAINCREDENTIAL)
	...
	(MEM_DOMAIN_USER_ADMINS ID_DZHOST ID_CCDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_EUHOST ID_CCDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FBHOST ID_BIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FBHOST ID_BMDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FIHOST ID_BMDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FIHOST ID_CGDOMAINUSER)
...
(:goal (and (procnone) (PROP_HOST ID_GCRAT ID_DSHOST)(PROP_HOST ID_GFRAT ID_DLHOST)(PROP_HOST ID_FYRAT ID_EUHOST)(PROP_HOST ID_GERAT ID_DZHOST)(PROP_HOST ID_GHRAT ID_FPHOST)(PROP_HOST ID_FZRAT ID_FBHOST)(PROP_HOST ID_GBRAT ID_ENHOST)(PROP_HOST ID_GGRAT ID_DEHOST)(PROP_HOST ID_GARAT ID_FIHOST)))
