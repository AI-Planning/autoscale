(define (problem p18_hosts_trial_14) (:domain CALDERA)
(:objects
...
(:init
	(KNOWS ID_IWHOST)
	(KNOWS ID_KMRAT)
	(KNOWS_PROPERTY ID_IWHOST PFQDN)
	(KNOWS_PROPERTY ID_KMRAT PEXECUTABLE)
	(KNOWS_PROPERTY ID_KMRAT PHOST)
	(MEM_CACHED_DOMAIN_CREDS ID_FQHOST ID_ELDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FQHOST ID_FFDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FXHOST ID_DJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FXHOST ID_HDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_GSHOST ID_CTDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GSHOST ID_DVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GZHOST ID_BJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GZHOST ID_TDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HGHOST ID_EPDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HGHOST ID_LDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HNHOST ID_EPDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HNHOST ID_LDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HUHOST ID_BVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HUHOST ID_FBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IBHOST ID_DZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IBHOST ID_XDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IIHOST ID_DNDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IIHOST ID_HDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IPHOST ID_DDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IPHOST ID_DFDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IWHOST ID_BRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IWHOST ID_BVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JDHOST ID_CHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JDHOST ID_CLDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JKHOST ID_EDDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JKHOST ID_FJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JRHOST ID_CDDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JRHOST ID_DDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JYHOST ID_BFDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JYHOST ID_BZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KFHOST ID_BNDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KFHOST ID_EPDOMAINCREDENTIAL)
	(MEM_DOMAIN_USER_ADMINS ID_FQHOST ID_BQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FQHOST ID_ECDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FXHOST ID_DQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FXHOST ID_EODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GEHOST ID_CSDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GEHOST ID_DUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GLHOST ID_BADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GLHOST ID_WDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GSHOST ID_EODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GSHOST ID_FMDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GZHOST ID_BQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GZHOST ID_DEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HGHOST ID_CGDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HGHOST ID_WDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HNHOST ID_BIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HNHOST ID_EKDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HUHOST ID_DMDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HUHOST ID_EODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IBHOST ID_BMDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IBHOST ID_ECDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IIHOST ID_EKDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IIHOST ID_FIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IPHOST ID_BADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IPHOST ID_DUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IWHOST ID_CSDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IWHOST ID_GDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JDHOST ID_BEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JDHOST ID_EODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JKHOST ID_DADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JKHOST ID_DYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JRHOST ID_EWDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JRHOST ID_FADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JYHOST ID_CSDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JYHOST ID_CWDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KFHOST ID_GDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KFHOST ID_WDOMAINUSER)
	...
	(PROP_FQDN ID_GZHOST STR__HF)
	(PROP_FQDN ID_HGHOST STR__HM)
	(PROP_FQDN ID_HNHOST STR__HT)
	...
	(PROP_HOSTNAME ID_GZHOST STR__HE)
	(PROP_HOSTNAME ID_HGHOST STR__HL)
	(PROP_HOSTNAME ID_HNHOST STR__HS)
	(PROP_HOSTNAME ID_HUHOST STR__HZ)
	(PROP_HOSTNAME ID_IBHOST STR__IG)
	(PROP_HOSTNAME ID_IIHOST STR__IN)
	(PROP_HOSTNAME ID_IPHOST STR__IU)
	(PROP_HOSTNAME ID_IWHOST STR__JB)
	(PROP_HOSTNAME ID_JDHOST STR__JI)
	(PROP_HOSTNAME ID_JKHOST STR__JP)
	(PROP_HOSTNAME ID_JRHOST STR__JW)
	(PROP_HOSTNAME ID_JYHOST STR__KD)
	(PROP_HOSTNAME ID_KFHOST STR__KK)
...
(:goal (and (procnone) (PROP_HOST ID_NARAT ID_KFHOST)(PROP_HOST ID_MYRAT ID_GSHOST)(PROP_HOST ID_NHRAT ID_JYHOST)(PROP_HOST ID_NFRAT ID_IBHOST)(PROP_HOST ID_MURAT ID_HNHOST)(PROP_HOST ID_MXRAT ID_GZHOST)(PROP_HOST ID_MZRAT ID_FQHOST)(PROP_HOST ID_MRRAT ID_GEHOST)(PROP_HOST ID_MTRAT ID_HUHOST)(PROP_HOST ID_NBRAT ID_GLHOST)(PROP_HOST ID_MVRAT ID_JRHOST)(PROP_HOST ID_MWRAT ID_FXHOST)(PROP_HOST ID_MQRAT ID_IPHOST)(PROP_HOST ID_NERAT ID_HGHOST)(PROP_HOST ID_NDRAT ID_IIHOST)(PROP_HOST ID_NGRAT ID_JKHOST)(PROP_HOST ID_NCRAT ID_JDHOST)))
