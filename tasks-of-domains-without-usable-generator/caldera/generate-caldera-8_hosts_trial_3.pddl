(define (problem p8_hosts_trial_3) (:domain CALDERA)
(:objects
...
(:goal (and (procnone) (PROP_HOST ID_DZRAT ID_CBHOST)(PROP_HOST ID_ECRAT ID_CIHOST)(PROP_HOST ID_DWRAT ID_BGHOST)(PROP_HOST ID_DXRAT ID_CPHOST)(PROP_HOST ID_EBRAT ID_BNHOST)(PROP_HOST ID_EDRAT ID_SHOST)(PROP_HOST ID_EARAT ID_ZHOST)))
