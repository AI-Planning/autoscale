(define (problem p15_hosts_trial_13) (:domain CALDERA)
(:objects
...
(:goal (and (procnone) (PROP_HOST ID_JTRAT ID_HRHOST)(PROP_HOST ID_JSRAT ID_EZHOST)(PROP_HOST ID_JMRAT ID_GIHOST)(PROP_HOST ID_JORAT ID_IMHOST)(PROP_HOST ID_JYRAT ID_HDHOST)(PROP_HOST ID_JRRAT ID_GWHOST)(PROP_HOST ID_JLRAT ID_HYHOST)(PROP_HOST ID_JNRAT ID_FGHOST)(PROP_HOST ID_JXRAT ID_ESHOST)(PROP_HOST ID_JKRAT ID_GPHOST)(PROP_HOST ID_JPRAT ID_HKHOST)(PROP_HOST ID_JURAT ID_GBHOST)(PROP_HOST ID_JQRAT ID_FNHOST)(PROP_HOST ID_JVRAT ID_IFHOST)))
