(define (problem p8_hosts_trial_13) (:domain CALDERA)
(:objects
...
(:goal (and (procnone) (PROP_HOST ID_FCRAT ID_CVHOST)(PROP_HOST ID_FFRAT ID_DXHOST)(PROP_HOST ID_FERAT ID_ELHOST)(PROP_HOST ID_FHRAT ID_DQHOST)(PROP_HOST ID_FIRAT ID_EEHOST)(PROP_HOST ID_FGRAT ID_COHOST)(PROP_HOST ID_FDRAT ID_DJHOST)))
