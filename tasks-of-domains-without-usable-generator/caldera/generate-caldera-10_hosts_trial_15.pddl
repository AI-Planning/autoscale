(define (problem p10_hosts_trial_15) (:domain CALDERA)
(:objects
...
(:goal (and (procnone) (PROP_HOST ID_HLRAT ID_FIHOST)(PROP_HOST ID_HIRAT ID_DSHOST)(PROP_HOST ID_HERAT ID_EUHOST)(PROP_HOST ID_HHRAT ID_DLHOST)(PROP_HOST ID_HJRAT ID_FBHOST)(PROP_HOST ID_HCRAT ID_ENHOST)(PROP_HOST ID_HFRAT ID_DEHOST)(PROP_HOST ID_HDRAT ID_FPHOST)(PROP_HOST ID_HGRAT ID_DZHOST)))
