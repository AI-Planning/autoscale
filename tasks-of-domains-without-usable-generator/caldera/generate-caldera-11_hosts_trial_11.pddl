(define (problem p11_hosts_trial_11) (:domain CALDERA)
(:objects
	NUM__142 - NUM
	NUM__120 - NUM
	NUM__162 - NUM
...
(:init
	...
	(MEM_CACHED_DOMAIN_CREDS ID_EHHOST ID_DBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_EOHOST ID_BZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_EOHOST ID_CDDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_EOHOST ID_CTDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_EVHOST ID_CHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_EVHOST ID_CPDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_FCHOST ID_DBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FJHOST ID_BVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FJHOST ID_CDDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FJHOST ID_XDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_GEHOST ID_CHDOMAINCREDENTIAL)
	...
	(MEM_DOMAIN_USER_ADMINS ID_DMHOST ID_CGDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_DMHOST ID_CSDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_DTHOST ID_BADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_DTHOST ID_CDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_DTHOST ID_DIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EAHOST ID_BMDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EAHOST ID_CDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EAHOST ID_CSDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EHHOST ID_BEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EHHOST ID_CCDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EHHOST ID_DEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EOHOST ID_BYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EOHOST ID_DADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EOHOST ID_SDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EVHOST ID_BUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EVHOST ID_CKDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EVHOST ID_CWDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FCHOST ID_BMDOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_FJHOST ID_ODOMAINUSER)
	...
	(MEM_DOMAIN_USER_ADMINS ID_FXHOST ID_BIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FXHOST ID_CDOMAINUSER)
...
(:goal (and (procnone) (PROP_HOST ID_HDRAT ID_FXHOST)(PROP_HOST ID_HCRAT ID_EHHOST)(PROP_HOST ID_HARAT ID_FCHOST)(PROP_HOST ID_HFRAT ID_EAHOST)(PROP_HOST ID_HERAT ID_DTHOST)(PROP_HOST ID_HHRAT ID_FJHOST)(PROP_HOST ID_HBRAT ID_FQHOST)(PROP_HOST ID_HGRAT ID_DMHOST)(PROP_HOST ID_GYRAT ID_EVHOST)(PROP_HOST ID_GZRAT ID_EOHOST)))
