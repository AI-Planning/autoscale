(define (problem p15_hosts_trial_10) (:domain CALDERA)
(:objects
...
(:init
	(KNOWS ID_KOHOST)
	(KNOWS ID_MLRAT)
	(KNOWS_PROPERTY ID_KOHOST PFQDN)
	(KNOWS_PROPERTY ID_MLRAT PEXECUTABLE)
	(KNOWS_PROPERTY ID_MLRAT PHOST)
	(MEM_CACHED_DOMAIN_CREDS ID_IKHOST ID_BBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IKHOST ID_CPDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IKHOST ID_FJDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_IRHOST ID_GLDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IRHOST ID_IHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IYHOST ID_CTDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IYHOST ID_FVDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_JFHOST ID_GLDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JFHOST ID_HRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JMHOST ID_CHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JMHOST ID_DVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JMHOST ID_EDDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_JTHOST ID_DRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_JTHOST ID_GDDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KAHOST ID_DFDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_KHHOST ID_HJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KHHOST ID_HVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KHHOST ID_HZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KOHOST ID_BZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KOHOST ID_CHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KOHOST ID_FBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KOHOST ID_FJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KVHOST ID_DDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KVHOST ID_EHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KVHOST ID_EXDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_KVHOST ID_HZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_LCHOST ID_BBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_LCHOST ID_DVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_LCHOST ID_FJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_LCHOST ID_HDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_LJHOST ID_DRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_LJHOST ID_EDDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_LJHOST ID_FFDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_LJHOST ID_HJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_LQHOST ID_BVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_LQHOST ID_CHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_LQHOST ID_DRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_LQHOST ID_HNDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_LXHOST ID_CDDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_LXHOST ID_DZDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_LXHOST ID_FRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_LXHOST ID_HBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_MEHOST ID_DRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_MEHOST ID_ETDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_MEHOST ID_FJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_MEHOST ID_HVDOMAINCREDENTIAL)
	...
	(MEM_DOMAIN_USER_ADMINS ID_IRHOST ID_FQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IRHOST ID_HUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IRHOST ID_ICDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IYHOST ID_HMDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IYHOST ID_IGDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IYHOST ID_SDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JFHOST ID_CDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JFHOST ID_CWDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JFHOST ID_HADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JMHOST ID_BQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JMHOST ID_FIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JMHOST ID_KDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JTHOST ID_DMDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JTHOST ID_GWDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_JTHOST ID_SDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KAHOST ID_DADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KAHOST ID_ESDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KAHOST ID_HYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KHHOST ID_CWDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KHHOST ID_DYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KHHOST ID_SDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KOHOST ID_CODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KOHOST ID_FUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KOHOST ID_WDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KVHOST ID_CWDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KVHOST ID_ECDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_KVHOST ID_ODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_LCHOST ID_DYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_LCHOST ID_HYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_LCHOST ID_ODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_LJHOST ID_CCDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_LJHOST ID_IGDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_LJHOST ID_ODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_LQHOST ID_FADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_LQHOST ID_HADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_LQHOST ID_ICDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_LXHOST ID_HUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_LXHOST ID_HYDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_LXHOST ID_IGDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_MEHOST ID_FMDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_MEHOST ID_FUDOMAINUSER)
	...
	(PROP_DNS_DOMAIN_NAME ID_LQHOST STR__LV)
	(PROP_DNS_DOMAIN_NAME ID_LXHOST STR__MC)
	(PROP_DNS_DOMAIN_NAME ID_MEHOST STR__MJ)
	...
	(PROP_ELEVATED ID_MLRAT YES)
	(PROP_EXECUTABLE ID_MLRAT STR__MM)
	...
	(PROP_FQDN ID_LQHOST STR__LU)
	(PROP_FQDN ID_LXHOST STR__MB)
	(PROP_FQDN ID_MEHOST STR__MI)
	...
	(PROP_MICROSECONDS ID_LYTIMEDELTA NUM__311)
	(PROP_MICROSECONDS ID_MFTIMEDELTA NUM__318)
	...
	(PROP_SECONDS ID_LYTIMEDELTA NUM__312)
	(PROP_SECONDS ID_MFTIMEDELTA NUM__319)
...
(:goal (and (procnone) (PROP_HOST ID_OTRAT ID_JFHOST)(PROP_HOST ID_OURAT ID_JMHOST)(PROP_HOST ID_OPRAT ID_LXHOST)(PROP_HOST ID_OHRAT ID_LQHOST)(PROP_HOST ID_ORRAT ID_IKHOST)(PROP_HOST ID_OLRAT ID_IRHOST)(PROP_HOST ID_OSRAT ID_LCHOST)(PROP_HOST ID_OKRAT ID_KHHOST)(PROP_HOST ID_OIRAT ID_MEHOST)(PROP_HOST ID_OORAT ID_JTHOST)(PROP_HOST ID_OMRAT ID_LJHOST)(PROP_HOST ID_OJRAT ID_KVHOST)(PROP_HOST ID_OQRAT ID_KAHOST)(PROP_HOST ID_ONRAT ID_IYHOST)))
