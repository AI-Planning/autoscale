(define (problem p9_hosts_trial_6) (:domain CALDERA)
(:objects
...
(:init
	(KNOWS ID_CPHOST)
	(KNOWS ID_DDRAT)
	(KNOWS_PROPERTY ID_CPHOST PFQDN)
...
(:goal (and (procnone) (PROP_HOST ID_DPRAT ID_CIHOST)(PROP_HOST ID_DRRAT ID_SHOST)(PROP_HOST ID_DSRAT ID_CWHOST)(PROP_HOST ID_DWRAT ID_BUHOST)(PROP_HOST ID_DVRAT ID_BNHOST)(PROP_HOST ID_DURAT ID_ZHOST)(PROP_HOST ID_DORAT ID_BGHOST)(PROP_HOST ID_DQRAT ID_CBHOST)))
