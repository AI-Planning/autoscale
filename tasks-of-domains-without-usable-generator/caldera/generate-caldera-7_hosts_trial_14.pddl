(define (problem p7_hosts_trial_14) (:domain CALDERA)
(:objects
...
(:init
	...
	(MEM_CACHED_DOMAIN_CREDS ID_DBHOST ID_DDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_DBHOST ID_LDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_DIHOST ID_BBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_DIHOST ID_BVDOMAINCREDENTIAL)
...
(:goal (and (procnone) (PROP_HOST ID_EYRAT ID_CGHOST)(PROP_HOST ID_EWRAT ID_CUHOST)(PROP_HOST ID_EZRAT ID_CNHOST)(PROP_HOST ID_ETRAT ID_DIHOST)(PROP_HOST ID_EXRAT ID_DBHOST)(PROP_HOST ID_EURAT ID_DWHOST)))
