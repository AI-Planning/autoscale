(define (problem p15_hosts_trial_15) (:domain CALDERA)
(:objects
...
(:init
	...
	(MEM_CACHED_DOMAIN_CREDS ID_EZHOST ID_DNDOMAINCREDENTIAL)
	...
	(MEM_CACHED_DOMAIN_CREDS ID_FNHOST ID_CXDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FUHOST ID_HDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_FUHOST ID_LDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GBHOST ID_DVDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GBHOST ID_TDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GIHOST ID_CDDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GIHOST ID_DJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GPHOST ID_BRDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GPHOST ID_CHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GWHOST ID_BBDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_GWHOST ID_DDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HDHOST ID_BFDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HDHOST ID_CTDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HKHOST ID_BFDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HKHOST ID_DJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HRHOST ID_BFDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HRHOST ID_CTDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HYHOST ID_CHDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_HYHOST ID_EPDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IFHOST ID_CXDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IFHOST ID_EPDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IMHOST ID_DJDOMAINCREDENTIAL)
	(MEM_CACHED_DOMAIN_CREDS ID_IMHOST ID_DRDOMAINCREDENTIAL)
	(MEM_DOMAIN_USER_ADMINS ID_ESHOST ID_BMDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_ESHOST ID_KDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EZHOST ID_DUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_EZHOST ID_EGDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FGHOST ID_DIDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FGHOST ID_EODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FNHOST ID_CGDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FNHOST ID_EKDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FUHOST ID_BQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_FUHOST ID_CKDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GBHOST ID_CKDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GBHOST ID_GDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GIHOST ID_CGDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GIHOST ID_DADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GPHOST ID_BQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GPHOST ID_CCDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GWHOST ID_BEDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_GWHOST ID_WDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HDHOST ID_DQDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HDHOST ID_KDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HKHOST ID_CCDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HKHOST ID_WDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HRHOST ID_BADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HRHOST ID_CCDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HYHOST ID_CDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_HYHOST ID_ODOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IFHOST ID_BUDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IFHOST ID_CGDOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IMHOST ID_BADOMAINUSER)
	(MEM_DOMAIN_USER_ADMINS ID_IMHOST ID_BMDOMAINUSER)
...
(:goal (and (procnone) (PROP_HOST ID_JGRAT ID_FGHOST)(PROP_HOST ID_IXRAT ID_HRHOST)(PROP_HOST ID_JBRAT ID_ESHOST)(PROP_HOST ID_IWRAT ID_GBHOST)(PROP_HOST ID_JDRAT ID_FNHOST)(PROP_HOST ID_JERAT ID_HKHOST)(PROP_HOST ID_IYRAT ID_FUHOST)(PROP_HOST ID_JHRAT ID_GPHOST)(PROP_HOST ID_IZRAT ID_IFHOST)(PROP_HOST ID_JARAT ID_HYHOST)(PROP_HOST ID_JFRAT ID_GIHOST)(PROP_HOST ID_JCRAT ID_EZHOST)(PROP_HOST ID_IVRAT ID_GWHOST)(PROP_HOST ID_JIRAT ID_HDHOST)))
