...
(:action DUMMY-STRIPS-ACTION-31
 :parameters ()
 :precondition (available Mdm2-pRbp2)
 :effect (and (goal16)))
...
(:action DUMMY-STRIPS-ACTION-68
 :parameters ()
 :precondition (available pRbp1-E2F13p1-DP12)
 :effect (and (goal35)))
...
(:action DUMMY-STRIPS-ACTION-70
 :parameters ()
 :precondition (available p27-cdk2-cycA)
 :effect (and (goal36)))
...
(:action DUMMY-STRIPS-ACTION-75
 :parameters ()
 :precondition (available cdk1p1p3-Gadd45)
 :effect (and (goal38)))
...
(:action DUMMY-STRIPS-ACTION-99
 :parameters ()
 :precondition (available cdk1-cks1)
 :effect (and (goal50)))
...
(:action DUMMY-STRIPS-ACTION-101
 :parameters ()
 :precondition (available m1433-cdc25Cp1p2)
 :effect (and (goal51)))
...
(:action DUMMY-STRIPS-ACTION-104
 :parameters ()
 :precondition (available Skp1p1)
 :effect (and (goal53)))

(:action DUMMY-STRIPS-ACTION-105
 :parameters ()
 :precondition (available cdk2p1p2-cycA-E2F13)
 :effect (and (goal53)))
...
(:action DUMMY-STRIPS-ACTION-107
 :parameters ()
 :precondition (available Skp2-Skp1-cdk2p2-cycA)
 :effect (and (goal54)))
...
(:action DUMMY-STRIPS-ACTION-114
 :parameters ()
 :precondition (available HDAC1-p107-E2F4-DP12)
 :effect (and (goal58)))
...
(:action DUMMY-STRIPS-ACTION-120
 :parameters ()
 :precondition (available pRbp1-AP2-gE-c)
 :effect (and (goal61)))
...
(:action DUMMY-STRIPS-ACTION-122
 :parameters ()
 :precondition (available Mdm2-E2F13-DP12)
 :effect (and (goal62)))

(:action DUMMY-STRIPS-ACTION-123
 :parameters ()
 :precondition (available Raf1-p130-E2F4p1-DP12-gE2)
 :effect (and (goal62)))
...
(:action DUMMY-STRIPS-ACTION-127
 :parameters ()
 :precondition (available p16-cdk46p1p2)
 :effect (and (goal64)))
...
(:action DUMMY-STRIPS-ACTION-154
 :parameters ()
 :precondition (available cdk2p1p2-cks1)
 :effect (and (goal78)))

(:action DUMMY-STRIPS-ACTION-155
 :parameters ()
 :precondition (available p27-cdk2p1p2-cycE)
 :effect (and (goal78)))
...
(:action DUMMY-STRIPS-ACTION-159
 :parameters ()
 :precondition (available HDAC1-p130-E2F4-DP12)
 :effect (and (goal80)))
...
(:action DUMMY-STRIPS-ACTION-173
 :parameters ()
 :precondition (available Raf1-p130-E2F4-DP12)
 :effect (and (goal87)))
