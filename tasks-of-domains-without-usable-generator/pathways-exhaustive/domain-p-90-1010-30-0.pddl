...
(:action DUMMY-STRIPS-ACTION-73
 :parameters ()
 :precondition (available Mdm2-E2F13p1-DP12)
 :effect (and (goal37)))
...
(:action DUMMY-STRIPS-ACTION-87
 :parameters ()
 :precondition (available DMP1-cycDp1)
 :effect (and (goal44)))
...
(:action DUMMY-STRIPS-ACTION-90
 :parameters ()
 :precondition (available p130-E2F5-DP12p1-gE2)
 :effect (and (goal46)))
...
(:action DUMMY-STRIPS-ACTION-121
 :parameters ()
 :precondition (available Raf1-pRbp1-E2F13-DP12p1)
 :effect (and (goal61)))
...
(:action DUMMY-STRIPS-ACTION-124
 :parameters ()
 :precondition (available Raf1-pRbp1-E2F13-DP12p1-gE2)
 :effect (and (goal63)))
...
(:action DUMMY-STRIPS-ACTION-137
 :parameters ()
 :precondition (available DMP1p1-cycDp1)
 :effect (and (goal69)))
...
(:action DUMMY-STRIPS-ACTION-140
 :parameters ()
 :precondition (available p57p1-cdk46p1p2-cycDp1)
 :effect (and (goal71)))
...
(:action DUMMY-STRIPS-ACTION-149
 :parameters ()
 :precondition (available Raf1-pRbp1-E2F13p1-DP12p1-gE2)
 :effect (and (goal75)))
...
(:action DUMMY-STRIPS-ACTION-155
 :parameters ()
 :precondition (available pRbp1-E2F13p1-DP12p1-gE2)
 :effect (and (goal78)))
...
(:action DUMMY-STRIPS-ACTION-159
 :parameters ()
 :precondition (available Raf1-pRb-E2F13p1-DP12-gE2)
 :effect (and (goal80)))
