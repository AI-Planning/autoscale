...
(DEFINE (PROBLEM ASTERINA-PECTINIFERA-TO-CEPAEA-NEMORALIS)
        ...
        (:GOAL (AND (NORMAL COX1) (NORMAL V) (NORMAL RRNL) (NORMAL L1)
                    ...
                    (NORMAL NAD4) (INVERTED SUB1) (NORMAL K)
                    (CW K COX1) (CW SUB1 K) (CW NAD4 SUB1) (CW S1 NAD4)
