...
;; simplified sequence 2: (1 25 2 23 17 12 3 20 6 15 30 27 31 18 -19 -9 -21 -8 -7 33 -28 10 11 32 -4 -37 -14 26 5 35 -22 -29 -16 -36)
...
;; sequence 2 (names): ((NORMAL COX1) (NORMAL L2) (NORMAL COX2) (NORMAL K) (NORMAL D) (NORMAL ATP6) (NORMAL COX3) (NORMAL G) (NORMAL NAD3) (NORMAL A) (NORMAL R) (NORMAL N) (NORMAL S1) (NORMAL E) (INVERTED F) (INVERTED NAD5) (INVERTED H) (INVERTED NAD4) (INVERTED NAD4L) (NORMAL T) (INVERTED P) (NORMAL NAD6) (NORMAL COB) (NORMAL S2) (INVERTED NAD1) (INVERTED SUB1) (INVERTED RRNS) (NORMAL M) (NORMAL NAD2) (NORMAL W) (INVERTED I) (INVERTED Q) (INVERTED C) (INVERTED Y))

(DEFINE (PROBLEM ALBINARIA-COERULEA-TO-ARTEMIA-FRANCISCANA)
        ...
        (:GOAL (AND (NORMAL COX1) (NORMAL L2) (NORMAL COX2) (NORMAL K)
                    ...
                    (INVERTED RRNS) (NORMAL M) (NORMAL NAD2) (NORMAL W)
                    (INVERTED I) (INVERTED Q) (INVERTED C) (INVERTED Y)
                    (CW Y COX1) (CW C Y) (CW Q C) (CW I Q) (CW W I)
                    (CW NAD2 W) (CW M NAD2) (CW RRNS M) (CW SUB1 RRNS)
                    (CW NAD1 SUB1) (CW S2 NAD1) (CW COB S2)
