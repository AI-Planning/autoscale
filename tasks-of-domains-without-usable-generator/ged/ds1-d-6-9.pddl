...
;; simplified sequence 2: (1 27 2 17 36 20 3 29 10 11 35 12 30 21 9 19 18 28 33 7 8 16 -38 37 15 32 25 4 22 23 6 31 5)
...
;; sequence 2 (names): ((NORMAL COX1) (NORMAL N) (NORMAL COX2) (NORMAL D) (NORMAL Y) (NORMAL G) (NORMAL COX3) (NORMAL Q) (NORMAL NAD6) (NORMAL COB) (NORMAL W) (NORMAL ATP6) (NORMAL R) (NORMAL H) (NORMAL NAD5) (NORMAL F) (NORMAL E) (NORMAL P) (NORMAL T) (NORMAL NAD4L) (NORMAL NAD4) (NORMAL C) (INVERTED SUB2) (NORMAL SUB1) (NORMAL A) (NORMAL S2) (NORMAL L2) (NORMAL NAD1) (NORMAL I) (NORMAL K) (NORMAL NAD3) (NORMAL S1) (NORMAL NAD2))

(DEFINE (PROBLEM ALBINARIA-COERULEA-TO-LUMBRICUS-TERRESTRIS)
        ...
        (:GOAL (AND (NORMAL COX1) (NORMAL N) (NORMAL COX2) (NORMAL D)
                    ...
                    (NORMAL NAD4) (NORMAL C) (INVERTED SUB2)
                    (NORMAL SUB1) (NORMAL A) (NORMAL S2) (NORMAL L2)
                    ...
                    (CW NAD4L NAD4) (CW T NAD4L) (CW P T) (CW E P)
                    (CW F E) (CW NAD5 F) (CW H NAD5) (CW R H)
                    (CW ATP6 R) (CW W ATP6) (CW COB W) (CW NAD6 COB)
                    (CW Q NAD6) (CW COX3 Q) (CW G COX3) (CW Y G)
