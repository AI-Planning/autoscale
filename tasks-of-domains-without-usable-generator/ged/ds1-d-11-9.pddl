...
;; simplified sequence 1: (1 35 10 30 29 11 24 3 23 15 25 27 26 7 14 36 4 19 12 22 20 2 21 13 6 16 32 28 17 34 9 18 37 33 8)
;; simplified sequence 2: (1 27 2 17 36 20 3 29 10 11 35 12 30 21 9 19 18 28 33 7 8 16 26 14 34 13 24 15 32 25 4 22 23 6 37)
...
(DEFINE (PROBLEM ONCHOCERCA-VOLVULUS-TO-LUMBRICUS-TERRESTRIS)
        ...
        (:INIT (NORMAL COX1) (NORMAL W) (NORMAL NAD6) (NORMAL R)
               ...
               (NORMAL NAD5) (NORMAL E) (NORMAL SUB1) (NORMAL T)
               (NORMAL NAD4) (PRESENT COX1) (PRESENT W) (PRESENT NAD6)
               (PRESENT R) (PRESENT Q) (PRESENT COB) (PRESENT L1)
               (PRESENT COX3) (PRESENT K) (PRESENT A) (PRESENT L2)
               (PRESENT N) (PRESENT M) (PRESENT NAD4L) (PRESENT RRNS)
               (PRESENT Y) (PRESENT NAD1) (PRESENT F) (PRESENT ATP6)
               (PRESENT I) (PRESENT G) (PRESENT COX2) (PRESENT H)
               (PRESENT RRNL) (PRESENT NAD3) (PRESENT C) (PRESENT S2)
               (PRESENT P) (PRESENT D) (PRESENT V) (PRESENT NAD5)
               (PRESENT E) (PRESENT SUB1) (PRESENT T) (PRESENT NAD4)
               ...
               (CW COX2 H) (CW G COX2) (CW I G) (CW ATP6 I) (CW F ATP6)
               (CW NAD1 F) (CW Y NAD1) (CW RRNS Y) (CW NAD4L RRNS)
               (CW M NAD4L) (CW N M) (CW L2 N) (CW A L2) (CW K A)
               (CW COX3 K) (CW L1 COX3) (CW COB L1) (CW Q COB) (CW R Q)
               (CW NAD6 R) (CW W NAD6) (CW COX1 W) (IDLE)
               (= (TOTAL-COST) 0))
