...
;; simplified sequence 1: (1 34 13 24 15 10 28 9 4 7 11 17 16 19 2 36 35 20 21 -29 -25 -27 -12 -30 -18 -14 26 -6 -32 37 31 8 22 5 23)
...
(DEFINE (PROBLEM CEPAEA-NEMORALIS-TO-ASCARIS-SUUM)
        ...
        (:INIT (NORMAL COX1) (NORMAL V) (NORMAL RRNL) (NORMAL L1)
               ...
               (INVERTED S2) (NORMAL SUB1) (NORMAL S1) (NORMAL NAD4)
               (NORMAL I) (NORMAL NAD2) (NORMAL K) (PRESENT COX1)
               (PRESENT V) (PRESENT RRNL) (PRESENT L1) (PRESENT A)
               (PRESENT NAD6) (PRESENT P) (PRESENT NAD5) (PRESENT NAD1)
               ...
               (PRESENT SUB1) (PRESENT S1) (PRESENT NAD4) (PRESENT I)
               (PRESENT NAD2) (PRESENT K) (CW K COX1) (CW NAD2 K)
               (CW I NAD2) (CW NAD4 I) (CW S1 NAD4) (CW SUB1 S1)
               (CW S2 SUB1) (CW NAD3 S2) (CW M NAD3) (CW RRNS M)
               (CW E RRNS) (CW R E) (CW ATP6 R) (CW N ATP6) (CW L2 N)
               (CW Q L2) (CW H Q) (CW G H) (CW W G) (CW Y W)
               (CW COX2 Y) (CW F COX2) (CW C F) (CW D C) (CW COB D)
               (CW NAD4L COB) (CW NAD1 NAD4L) (CW NAD5 NAD1)
               (CW P NAD5) (CW NAD6 P) (CW A NAD6) (CW L1 A)
