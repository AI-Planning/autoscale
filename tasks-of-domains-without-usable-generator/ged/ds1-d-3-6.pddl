...
(DEFINE (PROBLEM PARACENTROTUS-LIVIDUS-TO-ALBINARIA-COERULEA)
        ...
        (:GOAL (AND (NORMAL COX1) (NORMAL V) (NORMAL RRNL) (NORMAL L1)
                    ...
                    (INVERTED COX3) (NORMAL SUB1) (NORMAL K)
