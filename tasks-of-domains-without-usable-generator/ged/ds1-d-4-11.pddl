...
;; simplified sequence 1: (1 25 2 23 17 12 3 20 6 15 30 27 31 18 -19 -9 -21 -8 -7 33 -28 10 11 32 -4 -24 -13 -34 -14 22 -29 26 5 35 -16 -36)
...
(DEFINE (PROBLEM DROSOPHILA-YAKUBA-TO-ONCHOCERCA-VOLVULUS)
        ...
        (:INIT (NORMAL COX1) (NORMAL L2) (NORMAL COX2) (NORMAL K)
               ...
               (INVERTED V) (INVERTED RRNS) (NORMAL I) (INVERTED Q)
               ...
               (PRESENT RRNL) (PRESENT V) (PRESENT RRNS) (PRESENT I)
               (PRESENT Q) (PRESENT M) (PRESENT NAD2) (PRESENT W)
               (PRESENT C) (PRESENT Y) (CW Y COX1) (CW C Y) (CW W C)
               (CW NAD2 W) (CW M NAD2) (CW Q M) (CW I Q) (CW RRNS I)
