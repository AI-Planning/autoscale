...
;; simplified sequence 1: (1 37 28 15 10 9 4 7 11 17 16 19 2 36 35 20 21 -29 -25 -27 -12 -30 -18 -14 -26 -6 -32 31 8 -33 -3 22 5 23)
;; simplified sequence 2: (1 25 2 23 17 12 3 20 6 15 30 27 31 18 -19 -9 -21 -8 -7 33 -28 10 11 32 -4 -37 -14 22 -29 26 5 35 -16 -36)
...
;; sequence 2 (names): ((NORMAL COX1) (NORMAL L2) (NORMAL COX2) (NORMAL K) (NORMAL D) (NORMAL ATP6) (NORMAL COX3) (NORMAL G) (NORMAL NAD3) (NORMAL A) (NORMAL R) (NORMAL N) (NORMAL S1) (NORMAL E) (INVERTED F) (INVERTED NAD5) (INVERTED H) (INVERTED NAD4) (INVERTED NAD4L) (NORMAL T) (INVERTED P) (NORMAL NAD6) (NORMAL COB) (NORMAL S2) (INVERTED NAD1) (INVERTED SUB1) (INVERTED RRNS) (NORMAL I) (INVERTED Q) (NORMAL M) (NORMAL NAD2) (NORMAL W) (INVERTED C) (INVERTED Y))

(DEFINE (PROBLEM ALBINARIA-COERULEA-TO-DROSOPHILA-YAKUBA)
        ...
        (:INIT (NORMAL COX1) (NORMAL SUB1) (NORMAL P) (NORMAL A)
               ...
               (PRESENT COX1) (PRESENT SUB1) (PRESENT P) (PRESENT A)
               ...
               (CW SUB1 P) (CW COX1 SUB1) (IDLE) (= (TOTAL-COST) 0))
        (:GOAL (AND (NORMAL COX1) (NORMAL L2) (NORMAL COX2) (NORMAL K)
                    ...
                    (INVERTED RRNS) (NORMAL I) (INVERTED Q) (NORMAL M)
                    (NORMAL NAD2) (NORMAL W) (INVERTED C) (INVERTED Y)
                    (CW Y COX1) (CW C Y) (CW W C) (CW NAD2 W)
                    (CW M NAD2) (CW Q M) (CW I Q) (CW RRNS I)
                    (CW SUB1 RRNS) (CW NAD1 SUB1) (CW S2 NAD1)
                    (CW COB S2) (CW NAD6 COB) (CW P NAD6) (CW T P)
                    (CW NAD4L T) (CW NAD4 NAD4L) (CW H NAD4)
