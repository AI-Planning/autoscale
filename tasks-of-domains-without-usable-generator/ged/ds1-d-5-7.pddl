...
;; simplified sequence 1: (1 25 2 23 17 12 3 20 6 15 30 27 31 18 -19 -9 -21 -8 -7 33 -28 10 11 32 -4 37 38 5 35 -22 -29 -16 -36)
;; simplified sequence 2: (1 -37 15 10 28 9 4 7 11 17 16 19 2 36 35 20 21 -29 -25 -27 -12 -30 -18 38 -6 -32 -33 -3 31 8 22 5 23)
;; common subsequences: (((-24 -13 -34) . 37) ((-14 26) . 38))
;; #safe insertions/deletions: 0
;; sequence 1 (names): ((NORMAL COX1) (NORMAL L2) (NORMAL COX2) (NORMAL K) (NORMAL D) (NORMAL ATP6) (NORMAL COX3) (NORMAL G) (NORMAL NAD3) (NORMAL A) (NORMAL R) (NORMAL N) (NORMAL S1) (NORMAL E) (INVERTED F) (INVERTED NAD5) (INVERTED H) (INVERTED NAD4) (INVERTED NAD4L) (NORMAL T) (INVERTED P) (NORMAL NAD6) (NORMAL COB) (NORMAL S2) (INVERTED NAD1) (NORMAL SUB1) (NORMAL SUB2) (NORMAL NAD2) (NORMAL W) (INVERTED I) (INVERTED Q) (INVERTED C) (INVERTED Y))
...
(DEFINE (PROBLEM ARTEMIA-FRANCISCANA-TO-CEPAEA-NEMORALIS)
        ...
        (:INIT (NORMAL COX1) (NORMAL L2) (NORMAL COX2) (NORMAL K)
               ...
               (INVERTED NAD1) (NORMAL SUB1) (NORMAL SUB2)
               ...
               (PRESENT SUB2) (PRESENT NAD2) (PRESENT W) (PRESENT I)
               (PRESENT Q) (PRESENT C) (PRESENT Y) (CW Y COX1) (CW C Y)
               (CW Q C) (CW I Q) (CW W I) (CW NAD2 W) (CW SUB2 NAD2)
               (CW SUB1 SUB2) (CW NAD1 SUB1) (CW S2 NAD1) (CW COB S2)
        ...
        (:GOAL (AND (NORMAL COX1) (INVERTED SUB1) (NORMAL A)
                    ...
                    (NORMAL SUB2) (INVERTED NAD3) (INVERTED S2)
                    ...
                    (CW NAD3 S2) (CW SUB2 NAD3) (CW E SUB2) (CW R E)
