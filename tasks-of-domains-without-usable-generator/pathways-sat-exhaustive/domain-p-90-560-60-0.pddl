...
(:action DUMMY-STRIPS-ACTION-10
 :parameters ()
 :precondition (available Mdm2-pRb)
 :effect (and (goal6)))
...
(:action DUMMY-STRIPS-ACTION-68
 :parameters ()
 :precondition (available pRbp1p2-Jun)
 :effect (and (goal35)))
...
(:action DUMMY-STRIPS-ACTION-133
 :parameters ()
 :precondition (available HDAC1-pRb-E2F13p1-DP12-gE2)
 :effect (and (goal67)))
...
(:action DUMMY-STRIPS-ACTION-153
 :parameters ()
 :precondition (available PCNA-p21-cdk2p1p2-cycE)
 :effect (and (goal77)))
