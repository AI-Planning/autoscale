...
(:action DUMMY-STRIPS-ACTION-50
 :parameters ()
 :precondition (available HDAC1-p130-E2F5-DP12p1)
 :effect (and (goal26)))
...
(:action DUMMY-STRIPS-ACTION-126
 :parameters ()
 :precondition (available cdk1p1p2p3)
 :effect (and (goal64)))
