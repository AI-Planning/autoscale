;  15 x 15 with 1 robots, 1 carts, 10 tables, and 2  cupboards
(define 
  (problem test) 
  (:domain TIDYBOT) 
  ...
  (:init 
   ...
   (object-pos object5 x4 y9)
   (object-pos object6 x5 y2)
   (object-pos object7 x3 y11)
