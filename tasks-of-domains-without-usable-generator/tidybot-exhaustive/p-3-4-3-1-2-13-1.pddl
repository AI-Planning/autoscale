;  13 x 13 with 1 robots, 1 carts, 2 tables, and 3  cupboards
(define 
  (problem test) 
  (:domain TIDYBOT) 
  ...
  (:init 
   ...
   (object-goal object6 x7 y2)
   (object-goal object7 x9 y6)
   (object-goal object8 x3 y2)
   (object-goal object8 x9 y2)
   (object-goal object9 x3 y3)
   (object-goal object10 x4 y2)
   (object-goal object10 x7 y2)
   (object-goal object11 x4 y3)
   (object-goal object11 x7 y2)
   ...
   (object-pos object1 x9 y6)
   (object-pos object2 x3 y3)
   (object-pos object3 x10 y2)
   (object-pos object4 x9 y5)
   (object-pos object5 x8 y5)
   (object-pos object6 x9 y2)
   (object-pos object7 x8 y6)
   (object-pos object8 x2 y8)
   (object-pos object9 x2 y7)
