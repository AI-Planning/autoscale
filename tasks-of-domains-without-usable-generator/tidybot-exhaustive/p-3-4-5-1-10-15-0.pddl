;  15 x 15 with 1 robots, 1 carts, 9 tables, and 3  cupboards
(define 
  (problem test) 
  (:domain TIDYBOT) 
  ...
  (:init 
   ...
   (base-obstacle x12 y1)(surface x12 y1)
   (base-obstacle x12 y2)(surface x12 y2)
   (base-obstacle x12 y3)(surface x12 y3)
   (base-obstacle x12 y4)(surface x12 y4)
