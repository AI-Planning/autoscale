;  15 x 15 with 1 robots, 1 carts, 9 tables, and 2  cupboards
(define 
  (problem test) 
  (:domain TIDYBOT) 
  ...
  (:init 
   ...
   (base-obstacle x12 y5)(surface x12 y5)
   ...
   (object-pos object3 x12 y1)
   (object-pos object4 x8 y4)
   (object-pos object5 x7 y4)
   (object-pos object6 x12 y5)
