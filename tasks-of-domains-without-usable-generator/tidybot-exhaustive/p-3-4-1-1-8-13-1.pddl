;  13 x 13 with 1 robots, 1 carts, 5 tables, and 3  cupboards
(define 
  (problem test) 
  (:domain TIDYBOT) 
  ...
  (:init 
   ...
   (object-pos object3 x10 y9)
   (object-pos object4 x8 y2)
   (object-pos object5 x8 y6)
