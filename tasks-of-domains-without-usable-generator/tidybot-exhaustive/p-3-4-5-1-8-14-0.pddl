...
(define 
  ...
  (:init 
   ...
   (object-pos object0 x7 y5)
   (object-pos object1 x2 y9)
   (object-pos object2 x4 y11)
   (object-pos object3 x2 y8)
   (object-pos object4 x5 y9)
   (object-pos object5 x9 y9)
   (object-pos object6 x11 y5)
   (object-pos object7 x5 y10)
   (object-pos object8 x3 y5)
   (object-pos object9 x3 y4)
   (object-pos object10 x2 y1)
   (object-pos object11 x1 y8)
   
   (gripper-empty pr2)
   (gripper-rel pr2 xrel0 yrel0)
   (gripper-obstacle x7 y5)
   (gripper-obstacle x2 y9)
   (gripper-obstacle x4 y11)
