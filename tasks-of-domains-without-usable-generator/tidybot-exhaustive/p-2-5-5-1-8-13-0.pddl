;  13 x 13 with 1 robots, 1 carts, 7 tables, and 1  cupboards
(define 
  (problem test) 
  (:domain TIDYBOT) 
  ...
  (:init 
   ...
   (object-goal object5 x1 y6)
   (object-goal object6 x7 y3)
   (object-goal object6 x1 y2)
   (object-goal object7 x7 y4)
   (object-goal object8 x7 y5)
   (object-goal object8 x8 y8)
