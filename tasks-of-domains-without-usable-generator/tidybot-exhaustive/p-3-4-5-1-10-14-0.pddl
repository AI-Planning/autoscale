;  14 x 14 with 1 robots, 1 carts, 5 tables, and 3  cupboards
(define 
  (problem test) 
  (:domain TIDYBOT) 
  ...
  (:init 
   ...
   (object-goal object0 x6 y1)
   (object-goal object1 x2 y5)
   (object-goal object2 x3 y4)
   (object-goal object3 x3 y5)
   (object-goal object4 x9 y9)
   (object-goal object4 x5 y11)
   (object-goal object5 x9 y10)
   (object-goal object6 x10 y9)
   (object-goal object6 x4 y9)
   (object-goal object7 x10 y10)
   (object-goal object8 x7 y4)
   (object-goal object8 x5 y9)
   (object-goal object9 x7 y5)
   (object-goal object10 x8 y4)
   (object-goal object10 x5 y1)
   (object-goal object11 x8 y5)
   (object-goal object11 x5 y1)
   ...
   (base-obstacle x11 y4)(surface x11 y4)
   (base-obstacle x11 y5)(surface x11 y5)
   ...
   (base-obstacle x10 y11)(gripper-obstacle x10 y11)
   (base-obstacle x11 y8)(gripper-obstacle x11 y8)
   (base-obstacle x11 y9)(gripper-obstacle x11 y9)
   (base-obstacle x11 y10)(gripper-obstacle x11 y10)
   (base-obstacle x11 y11)(gripper-obstacle x11 y11)
   ...
   (object-pos object1 x11 y3)
   (object-pos object2 x8 y1)
   (object-pos object3 x9 y10)
   (object-pos object4 x2 y1)
   (object-pos object5 x1 y9)
   (object-pos object6 x8 y4)
   (object-pos object7 x5 y11)
   (object-pos object8 x10 y9)
   (object-pos object9 x4 y10)
   (object-pos object10 x11 y5)
   (object-pos object11 x5 y10)
   
   (gripper-empty pr2)
   (gripper-rel pr2 xrel0 yrel0)
   (gripper-obstacle x7 y1)
   (gripper-obstacle x11 y3)
   (gripper-obstacle x8 y1)
   (gripper-obstacle x9 y10)
   (gripper-obstacle x2 y1)
   (gripper-obstacle x1 y9)
   (gripper-obstacle x8 y4)
   (gripper-obstacle x5 y11)
   (gripper-obstacle x10 y9)
   (gripper-obstacle x4 y10)
   (gripper-obstacle x11 y5)
