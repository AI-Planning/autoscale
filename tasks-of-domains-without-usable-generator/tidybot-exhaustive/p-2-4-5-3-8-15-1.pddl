;  15 x 15 with 1 robots, 1 carts, 3 tables, and 2  cupboards
(define 
  (problem test) 
  (:domain TIDYBOT) 
  ...
  (:init 
   ...
   (object-goal object0 x12 y10)
   (object-goal object1 x10 y7)
   (object-goal object1 x12 y10)
