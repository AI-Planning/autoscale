;  15 x 15 with 1 robots, 1 carts, 10 tables, and 3  cupboards
(define 
  (problem test) 
  (:domain TIDYBOT) 
  ...
  (:init 
   ...
   (object-goal object8 x3 y9)
   (object-goal object9 x7 y5)
   (object-goal object10 x8 y4)
   (object-goal object10 x1 y1)
