...
(define 
  ...
  (:init 
   ...
   (base-pos pr2 x0 y0)
   (base-obstacle x0 y0)
   (base-obstacle x0 y1)(gripper-obstacle x0 y1)
   (base-obstacle x0 y2)(gripper-obstacle x0 y2)
   (base-obstacle x0 y3)(gripper-obstacle x0 y3)
   (base-obstacle x0 y4)(gripper-obstacle x0 y4)
