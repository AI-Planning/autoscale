;  13 x 13 with 1 robots, 1 carts, 4 tables, and 3  cupboards
(define 
  (problem test) 
  (:domain TIDYBOT) 
  ...
  (:init 
   ...
   (object-pos object3 x9 y2)
   (object-pos object4 x9 y9)
   (object-pos object5 x2 y7)
   (object-pos object6 x3 y3)
   (object-pos object7 x3 y7)
   (object-pos object8 x9 y5)
   (object-pos object9 x8 y6)
   (object-pos object10 x9 y6)
