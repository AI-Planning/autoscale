(define (problem Tetris-22-2-4463006)
(:domain tetris)
(:objects  
...
(clear f21-2f)
(clear f21-3f)
(at_two straight0 f8-0f f8-1f)
(at_two straight1 f3-0f f3-1f)
(at_two straight2 f2-2f f2-1f)
(at_two straight3 f11-2f f11-1f)
(at_two straight4 f7-0f f6-0f)
(at_two straight5 f9-2f f9-1f)
(at_two straight6 f4-3f f5-3f)
(at_two straight7 f5-1f f5-0f)
(at_two straight8 f1-0f f2-0f)
(at_two straight9 f1-1f f0-1f)
(at_two straight10 f8-2f f7-2f)
(at_two straight11 f7-3f f6-3f)
(at_two straight12 f10-3f f11-3f)
(at_two straight13 f10-0f f10-1f)
(at_two straight14 f4-2f f3-2f)
(at_two straight15 f0-3f f0-2f)
(at_two straight16 f3-3f f2-3f)
(at_two straight17 f6-2f f5-2f)
(at_two straight18 f6-1f f7-1f)
 )
(:goal
(and
(clear f0-0f)
