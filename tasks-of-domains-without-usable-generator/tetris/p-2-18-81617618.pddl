(define (problem Tetris-18-2-635581)
(:domain tetris)
(:objects  
...
(clear f17-2f)
(clear f17-3f)
(at_two straight0 f4-0f f3-0f)
(at_two straight1 f0-2f f0-3f)
(at_two straight2 f9-1f f9-0f)
(at_two straight3 f7-2f f7-3f)
(at_two straight4 f8-3f f8-2f)
(at_two straight5 f5-3f f6-3f)
(at_two straight6 f7-0f f6-0f)
(at_two straight7 f6-1f f6-2f)
(at_two straight8 f1-0f f1-1f)
(at_two straight9 f9-3f f9-2f)
(at_two straight10 f3-2f f2-2f)
(at_two straight11 f2-1f f3-1f)
(at_two straight12 f4-3f f3-3f)
(at_two straight13 f1-3f f2-3f)
(at_two straight14 f4-2f f5-2f)
(at_two straight15 f4-1f f5-1f)
(at_two straight16 f0-0f f0-1f)
 )
(:goal
(and
(clear f0-0f)
