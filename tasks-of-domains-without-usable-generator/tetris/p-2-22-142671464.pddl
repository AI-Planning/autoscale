(define (problem Tetris-22-2-646079)
(:domain tetris)
(:objects  
...
(clear f21-2f)
(clear f21-3f)
(at_two straight0 f8-1f f7-1f)
(at_two straight1 f3-3f f3-2f)
(at_two straight2 f9-3f f9-2f)
(at_two straight3 f7-3f f6-3f)
(at_two straight4 f4-1f f4-2f)
(at_two straight5 f0-2f f0-1f)
(at_two straight6 f5-0f f5-1f)
(at_two straight7 f0-3f f1-3f)
(at_two straight8 f11-3f f11-2f)
(at_two straight9 f2-3f f2-2f)
(at_two straight10 f3-1f f2-1f)
(at_two straight11 f7-2f f8-2f)
(at_two straight12 f1-2f f1-1f)
(at_two straight13 f2-0f f3-0f)
(at_two straight14 f7-0f f8-0f)
(at_two straight15 f10-0f f9-0f)
(at_two straight16 f0-0f f1-0f)
(at_two straight17 f4-3f f5-3f)
 )
(:goal
(and
(clear f0-0f)
