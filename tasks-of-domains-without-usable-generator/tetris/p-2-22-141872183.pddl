(define (problem Tetris-22-2-8102629)
(:domain tetris)
(:objects  
...
(clear f21-2f)
(clear f21-3f)
(at_two straight0 f2-2f f1-2f)
(at_two straight1 f7-2f f6-2f)
(at_two straight2 f5-2f f5-1f)
(at_two straight3 f10-3f f10-2f)
(at_two straight4 f3-3f f4-3f)
(at_two straight5 f9-0f f8-0f)
(at_two straight6 f5-3f f6-3f)
(at_two straight7 f11-2f f11-3f)
(at_two straight8 f6-0f f6-1f)
(at_two straight9 f9-1f f10-1f)
(at_two straight10 f7-3f f8-3f)
(at_two straight11 f0-1f f0-0f)
(at_two straight12 f9-2f f8-2f)
(at_two straight13 f0-2f f0-3f)
(at_two straight14 f5-0f f4-0f)
(at_two straight15 f2-1f f3-1f)
(at_two straight16 f4-1f f4-2f)
(at_two straight17 f1-0f f1-1f)
 )
(:goal
(and
(clear f0-0f)
