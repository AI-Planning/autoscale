(define (problem Tetris-26-2-3742943)
(:domain tetris)
(:objects  
...
(at_two straight3 f8-1f f8-2f)
(at_two straight4 f12-1f f13-1f)
(at_two straight5 f12-2f f12-3f)
(at_two straight6 f4-3f f5-3f)
(at_two straight7 f1-3f f0-3f)
(at_two straight8 f8-3f f7-3f)
(at_two straight9 f3-2f f2-2f)
 )
(:goal
(and
(clear f0-0f)
