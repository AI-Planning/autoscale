(define (problem Tetris-14-1-740240)
(:domain tetris)
(:objects  
...
square0 square1 square2 square3 square4 square5 square6 square7 square8 square9 square10 square11 square12 square13 square14 square15 square16 square17 square18 square19 square20 square21 - one_square
nada- two_straight
nisba- right_l
)
(:init
...
(clear f13-2f)
(clear f13-3f)
(at_square square0 f1-1f)
(at_square square1 f4-2f)
(at_square square2 f6-0f)
(at_square square3 f1-0f)
(at_square square4 f2-0f)
(at_square square5 f7-1f)
(at_square square6 f0-3f)
(at_square square7 f2-1f)
(at_square square8 f7-3f)
(at_square square9 f6-2f)
(at_square square10 f2-2f)
(at_square square11 f3-0f)
(at_square square12 f0-0f)
(at_square square13 f0-2f)
(at_square square14 f6-1f)
(at_square square15 f5-0f)
(at_square square16 f1-3f)
(at_square square17 f3-2f)
(at_square square18 f2-3f)
(at_square square19 f1-2f)
(at_square square20 f4-1f)
(at_square square21 f5-3f)
 )
(:goal
(and
(clear f0-0f)
