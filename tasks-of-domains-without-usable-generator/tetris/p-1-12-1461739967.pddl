(define (problem Tetris-12-1-884158)
(:domain tetris)
(:objects  
...
(at_square square7 f0-2f)
(at_square square8 f4-3f)
(at_square square9 f2-2f)
(at_square square10 f2-1f)
(at_square square11 f0-1f)
(at_square square12 f1-1f)
(at_square square13 f6-2f)
(at_square square14 f0-0f)
(at_square square15 f5-1f)
(at_square square16 f4-0f)
(at_square square17 f5-3f)
(at_square square18 f6-1f)
(at_square square19 f3-1f)
(at_square square20 f6-3f)
(at_square square21 f3-0f)
 )
(:goal
(and
(clear f0-0f)
