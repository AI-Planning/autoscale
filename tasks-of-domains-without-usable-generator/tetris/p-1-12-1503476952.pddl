(define (problem Tetris-12-1-2091121)
(:domain tetris)
(:objects  
...
square0 square1 square2 square3 square4 square5 square6 square7 square8 square9 square10 square11 square12 square13 square14 square15 square16 square17 square18 square19 square20 - one_square
nada- two_straight
nisba- right_l
)
(:init
...
(clear f11-2f)
(clear f11-3f)
(at_square square0 f3-2f)
(at_square square1 f5-1f)
(at_square square2 f1-2f)
(at_square square3 f3-3f)
(at_square square4 f3-0f)
(at_square square5 f2-0f)
(at_square square6 f0-1f)
(at_square square7 f4-3f)
(at_square square8 f1-0f)
(at_square square9 f5-2f)
(at_square square10 f2-1f)
(at_square square11 f6-0f)
(at_square square12 f2-3f)
(at_square square13 f1-3f)
(at_square square14 f1-1f)
(at_square square15 f6-2f)
(at_square square16 f3-1f)
(at_square square17 f6-3f)
(at_square square18 f0-0f)
(at_square square19 f4-0f)
(at_square square20 f4-2f)
 )
(:goal
(and
(clear f0-0f)
