(define (problem Tetris-18-2-2527851)
(:domain tetris)
(:objects  
...
(clear f17-2f)
(clear f17-3f)
(at_two straight0 f1-0f f1-1f)
(at_two straight1 f3-2f f4-2f)
(at_two straight2 f2-2f f2-1f)
(at_two straight3 f1-2f f0-2f)
(at_two straight4 f9-2f f8-2f)
(at_two straight5 f6-0f f5-0f)
(at_two straight6 f6-2f f6-1f)
(at_two straight7 f7-0f f7-1f)
(at_two straight8 f3-0f f4-0f)
(at_two straight9 f5-1f f5-2f)
(at_two straight10 f2-3f f1-3f)
(at_two straight11 f9-1f f10-1f)
(at_two straight12 f6-3f f5-3f)
(at_two straight13 f4-3f f3-3f)
(at_two straight14 f0-0f f0-1f)
(at_two straight15 f8-0f f8-1f)
(at_two straight16 f4-1f f3-1f)
(at_two straight17 f9-3f f8-3f)
 )
(:goal
(and
(clear f0-0f)
