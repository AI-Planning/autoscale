(define (problem Tetris-10-2-9300219)
(:domain tetris)
(:objects  
...
(at_two straight4 f0-2f f0-3f)
(at_two straight5 f2-0f f3-0f)
(at_two straight6 f3-1f f3-2f)
(at_two straight7 f1-0f f0-0f)
(at_two straight8 f3-3f f4-3f)
 )
(:goal
(and
(clear f0-0f)
