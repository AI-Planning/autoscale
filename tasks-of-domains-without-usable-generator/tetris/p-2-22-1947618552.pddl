(define (problem Tetris-22-2-2290795)
(:domain tetris)
(:objects  
...
(at_two straight7 f9-3f f8-3f)
(at_two straight8 f10-3f f11-3f)
(at_two straight9 f2-3f f2-2f)
(at_two straight10 f3-1f f3-2f)
(at_two straight11 f1-0f f2-0f)
(at_two straight12 f9-1f f10-1f)
(at_two straight13 f7-1f f7-0f)
(at_two straight14 f5-0f f6-0f)
 )
(:goal
(and
(clear f0-0f)
