(define (problem Tetris-22-2-1301945)
(:domain tetris)
(:objects  
...
(clear f21-2f)
(clear f21-3f)
(at_two straight0 f9-2f f10-2f)
(at_two straight1 f5-2f f6-2f)
(at_two straight2 f0-0f f1-0f)
(at_two straight3 f2-1f f1-1f)
(at_two straight4 f7-0f f8-0f)
(at_two straight5 f4-0f f4-1f)
(at_two straight6 f0-3f f1-3f)
(at_two straight7 f7-1f f8-1f)
(at_two straight8 f10-0f f9-0f)
(at_two straight9 f11-1f f11-2f)
(at_two straight10 f7-3f f7-2f)
(at_two straight11 f2-2f f3-2f)
(at_two straight12 f3-0f f2-0f)
(at_two straight13 f4-3f f3-3f)
(at_two straight14 f10-1f f9-1f)
(at_two straight15 f0-2f f1-2f)
(at_two straight16 f8-3f f8-2f)
(at_two straight17 f5-0f f5-1f)
(at_two straight18 f5-3f f6-3f)
(at_two straight19 f6-0f f6-1f)
 )
(:goal
(and
(clear f0-0f)
