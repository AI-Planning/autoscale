(define (problem Tetris-18-2-4750044)
(:domain tetris)
(:objects  
...
(clear f17-2f)
(clear f17-3f)
(at_two straight0 f6-1f f5-1f)
(at_two straight1 f2-3f f2-2f)
(at_two straight2 f9-2f f8-2f)
(at_two straight3 f2-0f f3-0f)
(at_two straight4 f0-3f f1-3f)
(at_two straight5 f4-2f f4-3f)
(at_two straight6 f1-2f f1-1f)
(at_two straight7 f0-1f f0-2f)
(at_two straight8 f7-3f f6-3f)
(at_two straight9 f2-1f f3-1f)
(at_two straight10 f7-2f f6-2f)
(at_two straight11 f5-3f f5-2f)
(at_two straight12 f3-2f f3-3f)
(at_two straight13 f6-0f f5-0f)
(at_two straight14 f1-0f f0-0f)
(at_two straight15 f8-1f f7-1f)
(at_two straight16 f9-0f f8-0f)
(at_two straight17 f9-3f f10-3f)
 )
(:goal
(and
(clear f0-0f)
