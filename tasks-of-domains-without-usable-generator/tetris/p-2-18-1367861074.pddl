(define (problem Tetris-18-2-5041047)
(:domain tetris)
(:objects  
...
(clear f17-2f)
(clear f17-3f)
(at_two straight0 f8-0f f7-0f)
(at_two straight1 f1-2f f0-2f)
(at_two straight2 f4-2f f4-3f)
(at_two straight3 f9-2f f9-3f)
(at_two straight4 f6-3f f6-2f)
(at_two straight5 f6-1f f7-1f)
(at_two straight6 f2-1f f2-0f)
(at_two straight7 f5-3f f5-2f)
(at_two straight8 f3-0f f3-1f)
(at_two straight9 f5-0f f4-0f)
(at_two straight10 f2-2f f2-3f)
(at_two straight11 f9-0f f9-1f)
(at_two straight12 f1-3f f0-3f)
(at_two straight13 f3-3f f3-2f)
(at_two straight14 f1-1f f1-0f)
(at_two straight15 f7-3f f8-3f)
 )
(:goal
(and
(clear f0-0f)
