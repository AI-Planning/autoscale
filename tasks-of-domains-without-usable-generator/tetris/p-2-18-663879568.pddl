(define (problem Tetris-18-2-8755390)
(:domain tetris)
(:objects  
...
(clear f17-2f)
(clear f17-3f)
(at_two straight0 f3-1f f3-0f)
(at_two straight1 f8-3f f8-2f)
(at_two straight2 f9-1f f8-1f)
(at_two straight3 f7-2f f7-3f)
(at_two straight4 f6-1f f7-1f)
(at_two straight5 f4-2f f3-2f)
(at_two straight6 f1-3f f1-2f)
(at_two straight7 f0-0f f0-1f)
(at_two straight8 f9-2f f9-3f)
(at_two straight9 f2-1f f1-1f)
(at_two straight10 f3-3f f4-3f)
(at_two straight11 f6-2f f5-2f)
(at_two straight12 f8-0f f9-0f)
(at_two straight13 f5-1f f4-1f)
(at_two straight14 f0-3f f0-2f)
(at_two straight15 f2-3f f2-2f)
(at_two straight16 f4-0f f5-0f)
 )
(:goal
(and
(clear f0-0f)
