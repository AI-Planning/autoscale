(define (problem Tetris-14-2-4348216)
(:domain tetris)
(:objects  
...
(at_two straight3 f2-0f f1-0f)
(at_two straight4 f0-0f f0-1f)
(at_two straight5 f2-2f f2-3f)
(at_two straight6 f1-2f f0-2f)
(at_two straight7 f7-2f f8-2f)
(at_two straight8 f5-0f f4-0f)
(at_two straight9 f0-3f f1-3f)
(at_two straight10 f3-3f f3-2f)
(at_two straight11 f7-0f f6-0f)
 )
(:goal
(and
(clear f0-0f)
