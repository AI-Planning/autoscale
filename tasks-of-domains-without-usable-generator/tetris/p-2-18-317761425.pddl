(define (problem Tetris-18-2-1126233)
(:domain tetris)
(:objects  
...
(clear f17-2f)
(clear f17-3f)
(at_two straight0 f0-3f f0-2f)
(at_two straight1 f3-1f f4-1f)
(at_two straight2 f2-0f f1-0f)
(at_two straight3 f3-3f f3-2f)
(at_two straight4 f2-3f f2-2f)
(at_two straight5 f7-2f f8-2f)
(at_two straight6 f9-3f f9-2f)
(at_two straight7 f5-3f f6-3f)
(at_two straight8 f4-2f f5-2f)
(at_two straight9 f6-2f f6-1f)
(at_two straight10 f8-1f f9-1f)
(at_two straight11 f5-1f f5-0f)
(at_two straight12 f2-1f f1-1f)
(at_two straight13 f8-0f f9-0f)
(at_two straight14 f7-1f f7-0f)
(at_two straight15 f1-3f f1-2f)
 )
(:goal
(and
(clear f0-0f)
