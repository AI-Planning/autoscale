(define (problem Tetris-14-1-2943526)
(:domain tetris)
(:objects  
...
square0 square1 square2 square3 square4 square5 square6 square7 square8 square9 square10 square11 square12 square13 square14 square15 square16 square17 square18 square19 - one_square
nada- two_straight
nisba- right_l
)
(:init
...
(at_square square9 f3-0f)
(at_square square10 f6-2f)
(at_square square11 f5-1f)
(at_square square12 f2-0f)
(at_square square13 f4-2f)
(at_square square14 f5-3f)
(at_square square15 f4-1f)
(at_square square16 f7-3f)
