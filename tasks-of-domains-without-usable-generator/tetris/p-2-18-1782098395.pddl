(define (problem Tetris-18-2-9602498)
(:domain tetris)
(:objects  
...
(clear f17-2f)
(clear f17-3f)
(at_two straight0 f8-3f f8-2f)
(at_two straight1 f6-3f f7-3f)
(at_two straight2 f6-0f f7-0f)
(at_two straight3 f7-2f f6-2f)
(at_two straight4 f9-3f f9-2f)
(at_two straight5 f9-1f f9-0f)
(at_two straight6 f0-1f f0-0f)
(at_two straight7 f5-3f f5-2f)
(at_two straight8 f2-0f f2-1f)
(at_two straight9 f3-3f f3-2f)
(at_two straight10 f1-2f f1-1f)
(at_two straight11 f5-0f f4-0f)
(at_two straight12 f6-1f f7-1f)
(at_two straight13 f2-3f f1-3f)
(at_two straight14 f0-2f f0-3f)
(at_two straight15 f8-0f f8-1f)
(at_two straight16 f4-1f f3-1f)
 )
(:goal
(and
(clear f0-0f)
