(define (problem Tetris-20-2-4408786)
(:domain tetris)
(:objects  
...
(at_two straight2 f5-3f f4-3f)
(at_two straight3 f10-2f f10-1f)
(at_two straight4 f9-3f f8-3f)
(at_two straight5 f0-3f f0-2f)
(at_two straight6 f2-0f f2-1f)
(at_two straight7 f3-1f f3-2f)
(at_two straight8 f7-3f f7-2f)
(at_two straight9 f8-1f f8-0f)
(at_two straight10 f9-2f f9-1f)
(at_two straight11 f4-1f f4-0f)
(at_two straight12 f10-3f f11-3f)
(at_two straight13 f1-1f f1-2f)
(at_two straight14 f5-1f f6-1f)
(at_two straight15 f4-2f f5-2f)
 )
(:goal
(and
(clear f0-0f)
