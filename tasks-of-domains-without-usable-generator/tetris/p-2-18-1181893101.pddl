(define (problem Tetris-18-2-2730845)
(:domain tetris)
(:objects  
...
(clear f17-2f)
(clear f17-3f)
(at_two straight0 f5-1f f4-1f)
(at_two straight1 f7-2f f8-2f)
(at_two straight2 f3-3f f2-3f)
(at_two straight3 f3-1f f2-1f)
(at_two straight4 f8-3f f9-3f)
(at_two straight5 f9-1f f10-1f)
(at_two straight6 f5-0f f4-0f)
(at_two straight7 f3-2f f2-2f)
(at_two straight8 f1-1f f0-1f)
(at_two straight9 f9-0f f8-0f)
(at_two straight10 f2-0f f3-0f)
(at_two straight11 f6-1f f6-0f)
(at_two straight12 f6-2f f6-3f)
(at_two straight13 f1-3f f1-2f)
(at_two straight14 f9-2f f10-2f)
(at_two straight15 f4-2f f4-3f)
(at_two straight16 f0-3f f0-2f)
 )
(:goal
(and
(clear f0-0f)
