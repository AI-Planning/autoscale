(define (problem Tetris-12-1-4619109)
(:domain tetris)
(:objects  
...
(at_square square4 f1-0f)
(at_square square5 f3-0f)
(at_square square6 f6-3f)
(at_square square7 f3-3f)
(at_square square8 f3-2f)
(at_square square9 f4-2f)
(at_square square10 f1-3f)
(at_square square11 f5-3f)
(at_square square12 f6-1f)
(at_square square13 f2-1f)
(at_square square14 f5-1f)
(at_square square15 f2-0f)
(at_square square16 f2-3f)
(at_square square17 f2-2f)
(at_square square18 f3-1f)
(at_square square19 f5-0f)
(at_square square20 f6-2f)
(at_square square21 f1-2f)
 )
(:goal
(and
(clear f0-0f)
