(define (problem Tetris-18-2-7826878)
(:domain tetris)
(:objects  
...
(clear f17-2f)
(clear f17-3f)
(at_two straight0 f6-2f f6-3f)
(at_two straight1 f9-3f f9-2f)
(at_two straight2 f2-3f f1-3f)
(at_two straight3 f1-1f f2-1f)
(at_two straight4 f2-2f f3-2f)
(at_two straight5 f6-1f f7-1f)
(at_two straight6 f9-0f f10-0f)
(at_two straight7 f4-0f f4-1f)
(at_two straight8 f5-3f f4-3f)
(at_two straight9 f0-3f f0-2f)
(at_two straight10 f8-3f f8-2f)
(at_two straight11 f2-0f f3-0f)
(at_two straight12 f8-0f f7-0f)
(at_two straight13 f7-3f f7-2f)
(at_two straight14 f0-0f f0-1f)
(at_two straight15 f5-2f f4-2f)
(at_two straight16 f5-0f f5-1f)
 )
(:goal
(and
(clear f0-0f)
