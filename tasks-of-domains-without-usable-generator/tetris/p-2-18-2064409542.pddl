(define (problem Tetris-18-2-2016475)
(:domain tetris)
(:objects  
...
(clear f17-2f)
(clear f17-3f)
(at_two straight0 f4-3f f4-2f)
(at_two straight1 f0-2f f0-3f)
(at_two straight2 f9-2f f9-1f)
(at_two straight3 f2-1f f3-1f)
(at_two straight4 f2-2f f3-2f)
(at_two straight5 f6-1f f7-1f)
(at_two straight6 f1-2f f1-1f)
(at_two straight7 f9-3f f10-3f)
(at_two straight8 f1-3f f2-3f)
(at_two straight9 f8-3f f8-2f)
(at_two straight10 f7-3f f7-2f)
(at_two straight11 f5-1f f5-0f)
(at_two straight12 f1-0f f2-0f)
(at_two straight13 f0-0f f0-1f)
(at_two straight14 f4-1f f4-0f)
(at_two straight15 f9-0f f8-0f)
(at_two straight16 f6-3f f6-2f)
(at_two straight17 f7-0f f6-0f)
 )
(:goal
(and
(clear f0-0f)
