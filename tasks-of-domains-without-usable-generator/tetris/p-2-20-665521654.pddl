(define (problem Tetris-20-2-3081124)
(:domain tetris)
(:objects  
...
(clear f19-2f)
(clear f19-3f)
(at_two straight0 f8-3f f7-3f)
(at_two straight1 f2-1f f3-1f)
(at_two straight2 f1-3f f1-2f)
(at_two straight3 f9-3f f9-2f)
(at_two straight4 f0-0f f1-0f)
(at_two straight5 f0-3f f0-2f)
(at_two straight6 f6-2f f5-2f)
(at_two straight7 f10-0f f10-1f)
(at_two straight8 f10-3f f11-3f)
(at_two straight9 f3-3f f3-2f)
(at_two straight10 f5-0f f6-0f)
(at_two straight11 f6-3f f5-3f)
(at_two straight12 f9-1f f8-1f)
(at_two straight13 f7-0f f7-1f)
(at_two straight14 f3-0f f2-0f)
(at_two straight15 f0-1f f1-1f)
(at_two straight16 f4-0f f4-1f)
(at_two straight17 f8-2f f7-2f)
(at_two straight18 f5-1f f6-1f)
 )
(:goal
(and
(clear f0-0f)
