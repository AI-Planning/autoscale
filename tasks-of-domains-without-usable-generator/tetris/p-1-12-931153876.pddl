(define (problem Tetris-12-1-9562862)
(:domain tetris)
(:objects  
...
(at_square square1 f6-0f)
(at_square square2 f3-2f)
(at_square square3 f2-0f)
(at_square square4 f5-0f)
(at_square square5 f0-0f)
(at_square square6 f3-0f)
(at_square square7 f2-3f)
(at_square square8 f5-2f)
(at_square square9 f5-1f)
(at_square square10 f6-3f)
(at_square square11 f4-0f)
(at_square square12 f0-2f)
(at_square square13 f4-2f)
(at_square square14 f6-2f)
(at_square square15 f6-1f)
(at_square square16 f4-1f)
(at_square square17 f4-3f)
(at_square square18 f1-0f)
(at_square square19 f1-3f)
(at_square square20 f2-2f)
(at_square square21 f0-1f)
 )
(:goal
(and
(clear f0-0f)
