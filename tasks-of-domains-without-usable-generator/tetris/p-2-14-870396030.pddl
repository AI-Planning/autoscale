(define (problem Tetris-14-2-5388494)
(:domain tetris)
(:objects  
...
(at_two straight6 f1-1f f1-2f)
(at_two straight7 f5-2f f4-2f)
(at_two straight8 f0-0f f1-0f)
(at_two straight9 f6-2f f7-2f)
(at_two straight10 f1-3f f2-3f)
