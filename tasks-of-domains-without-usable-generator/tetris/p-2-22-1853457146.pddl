(define (problem Tetris-22-2-2195277)
(:domain tetris)
(:objects  
...
(clear f21-2f)
(clear f21-3f)
(at_two straight0 f4-2f f5-2f)
(at_two straight1 f3-3f f3-2f)
(at_two straight2 f1-3f f1-2f)
(at_two straight3 f5-1f f4-1f)
(at_two straight4 f9-0f f9-1f)
(at_two straight5 f11-1f f11-2f)
(at_two straight6 f5-3f f6-3f)
(at_two straight7 f8-0f f8-1f)
(at_two straight8 f10-3f f10-2f)
(at_two straight9 f8-3f f9-3f)
(at_two straight10 f2-0f f1-0f)
(at_two straight11 f7-1f f6-1f)
(at_two straight12 f0-2f f0-3f)
(at_two straight13 f5-0f f4-0f)
(at_two straight14 f0-1f f1-1f)
(at_two straight15 f11-3f f12-3f)
 )
(:goal
(and
(clear f0-0f)
