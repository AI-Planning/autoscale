(define (problem Tetris-22-2-4063757)
(:domain tetris)
(:objects  
...
(clear f21-2f)
(clear f21-3f)
(at_two straight0 f8-2f f8-1f)
(at_two straight1 f10-3f f10-2f)
(at_two straight2 f11-3f f11-2f)
(at_two straight3 f2-2f f2-1f)
(at_two straight4 f11-0f f10-0f)
(at_two straight5 f10-1f f11-1f)
(at_two straight6 f5-2f f6-2f)
(at_two straight7 f2-0f f3-0f)
(at_two straight8 f8-3f f9-3f)
(at_two straight9 f1-2f f0-2f)
(at_two straight10 f6-0f f5-0f)
(at_two straight11 f4-1f f3-1f)
(at_two straight12 f7-3f f6-3f)
(at_two straight13 f3-3f f2-3f)
(at_two straight14 f0-0f f0-1f)
(at_two straight15 f7-1f f7-0f)
(at_two straight16 f9-1f f9-2f)
 )
(:goal
(and
(clear f0-0f)
