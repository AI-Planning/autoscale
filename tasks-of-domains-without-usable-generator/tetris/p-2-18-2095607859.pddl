(define (problem Tetris-18-2-207355)
(:domain tetris)
(:objects  
...
(clear f17-2f)
(clear f17-3f)
(at_two straight0 f3-2f f3-3f)
(at_two straight1 f6-2f f6-1f)
(at_two straight2 f2-1f f3-1f)
(at_two straight3 f2-2f f2-3f)
(at_two straight4 f4-1f f4-0f)
(at_two straight5 f9-0f f10-0f)
(at_two straight6 f7-1f f7-0f)
(at_two straight7 f2-0f f3-0f)
(at_two straight8 f4-2f f4-3f)
(at_two straight9 f1-1f f0-1f)
(at_two straight10 f0-2f f0-3f)
(at_two straight11 f8-0f f8-1f)
(at_two straight12 f5-0f f5-1f)
(at_two straight13 f8-3f f8-2f)
(at_two straight14 f1-2f f1-3f)
(at_two straight15 f9-2f f10-2f)
 )
(:goal
(and
(clear f0-0f)
