(define (problem Tetris-12-1-1638073)
(:domain tetris)
(:objects  
...
(clear f11-2f)
(clear f11-3f)
(at_square square0 f5-2f)
(at_square square1 f3-0f)
(at_square square2 f6-2f)
(at_square square3 f6-3f)
