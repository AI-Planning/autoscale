(define (problem Tetris-12-1-7358297)
(:domain tetris)
(:objects  
...
(at_square square2 f2-3f)
(at_square square3 f2-0f)
(at_square square4 f3-3f)
(at_square square5 f5-3f)
(at_square square6 f3-1f)
(at_square square7 f4-3f)
(at_square square8 f6-3f)
(at_square square9 f2-2f)
(at_square square10 f3-0f)
(at_square square11 f4-1f)
(at_square square12 f5-1f)
(at_square square13 f0-3f)
(at_square square14 f1-1f)
(at_square square15 f5-2f)
(at_square square16 f6-2f)
(at_square square17 f0-1f)
(at_square square18 f3-2f)
 )
(:goal
(and
(clear f0-0f)
