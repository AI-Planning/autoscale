(define (problem Tetris-20-2-7660863)
(:domain tetris)
(:objects  
...
(clear f19-2f)
(clear f19-3f)
(at_two straight0 f7-1f f8-1f)
(at_two straight1 f9-3f f10-3f)
(at_two straight2 f6-2f f5-2f)
(at_two straight3 f6-3f f7-3f)
(at_two straight4 f3-3f f3-2f)
(at_two straight5 f1-2f f1-1f)
(at_two straight6 f4-0f f4-1f)
(at_two straight7 f2-0f f3-0f)
(at_two straight8 f9-1f f9-0f)
(at_two straight9 f0-1f f0-0f)
(at_two straight10 f10-2f f9-2f)
(at_two straight11 f10-1f f11-1f)
(at_two straight12 f6-0f f7-0f)
(at_two straight13 f10-0f f11-0f)
(at_two straight14 f8-3f f8-2f)
(at_two straight15 f2-1f f2-2f)
(at_two straight16 f1-3f f0-3f)
(at_two straight17 f4-2f f4-3f)
 )
(:goal
(and
(clear f0-0f)
