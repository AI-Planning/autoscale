(define (problem Tetris-20-2-9445839)
(:domain tetris)
(:objects  
...
(clear f19-2f)
(clear f19-3f)
(at_two straight0 f9-2f f9-3f)
(at_two straight1 f7-0f f6-0f)
(at_two straight2 f0-1f f0-2f)
(at_two straight3 f3-0f f2-0f)
(at_two straight4 f4-0f f4-1f)
(at_two straight5 f2-1f f1-1f)
(at_two straight6 f1-2f f2-2f)
(at_two straight7 f6-3f f6-2f)
(at_two straight8 f5-1f f6-1f)
(at_two straight9 f8-1f f9-1f)
(at_two straight10 f3-1f f3-2f)
(at_two straight11 f4-2f f4-3f)
(at_two straight12 f8-0f f9-0f)
(at_two straight13 f1-3f f0-3f)
(at_two straight14 f10-1f f10-2f)
(at_two straight15 f1-0f f0-0f)
 )
(:goal
(and
(clear f0-0f)
