(define (problem Tetris-16-2-8536990)
(:domain tetris)
(:objects  
...
(at_two straight7 f0-1f f1-1f)
(at_two straight8 f8-1f f8-0f)
(at_two straight9 f0-3f f0-2f)
(at_two straight10 f2-1f f3-1f)
(at_two straight11 f6-3f f7-3f)
(at_two straight12 f8-2f f8-3f)
(at_two straight13 f5-0f f4-0f)
(at_two straight14 f7-1f f6-1f)
 )
(:goal
(and
(clear f0-0f)
