(define (problem Tetris-14-2-2592249)
(:domain tetris)
(:objects  
...
(at_two straight6 f4-3f f4-2f)
(at_two straight7 f2-2f f2-3f)
(at_two straight8 f1-2f f1-3f)
(at_two straight9 f3-1f f3-2f)
(at_two straight10 f5-2f f5-3f)
