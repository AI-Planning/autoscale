(define (problem Tetris-20-2-1597809)
(:domain tetris)
(:objects  
...
(clear f19-2f)
(clear f19-3f)
(at_two straight0 f1-1f f1-0f)
(at_two straight1 f10-2f f11-2f)
(at_two straight2 f0-0f f0-1f)
(at_two straight3 f8-3f f8-2f)
(at_two straight4 f6-3f f6-2f)
(at_two straight5 f4-2f f4-1f)
(at_two straight6 f7-0f f8-0f)
(at_two straight7 f4-0f f3-0f)
(at_two straight8 f9-1f f10-1f)
(at_two straight9 f9-2f f9-3f)
(at_two straight10 f5-0f f6-0f)
(at_two straight11 f2-2f f2-1f)
(at_two straight12 f7-3f f7-2f)
(at_two straight13 f8-1f f7-1f)
(at_two straight14 f1-3f f1-2f)
(at_two straight15 f4-3f f5-3f)
(at_two straight16 f0-2f f0-3f)
(at_two straight17 f3-2f f3-3f)
 )
(:goal
(and
(clear f0-0f)
