(define (problem Tetris-22-2-6030285)
(:domain tetris)
(:objects  
...
(clear f21-2f)
(clear f21-3f)
(at_two straight0 f11-2f f11-1f)
(at_two straight1 f6-2f f5-2f)
(at_two straight2 f2-1f f2-0f)
(at_two straight3 f0-2f f0-3f)
(at_two straight4 f9-1f f9-0f)
(at_two straight5 f1-2f f1-1f)
(at_two straight6 f9-3f f9-2f)
(at_two straight7 f0-0f f0-1f)
(at_two straight8 f6-0f f7-0f)
(at_two straight9 f5-3f f6-3f)
(at_two straight10 f4-3f f4-2f)
(at_two straight11 f4-0f f4-1f)
(at_two straight12 f10-0f f10-1f)
(at_two straight13 f8-2f f8-1f)
(at_two straight14 f3-0f f3-1f)
(at_two straight15 f2-3f f3-3f)
(at_two straight16 f10-3f f10-2f)
 )
(:goal
(and
(clear f0-0f)
