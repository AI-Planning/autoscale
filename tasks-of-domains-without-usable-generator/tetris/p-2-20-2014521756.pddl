(define (problem Tetris-20-2-661413)
(:domain tetris)
(:objects  
...
(clear f19-2f)
(clear f19-3f)
(at_two straight0 f6-2f f5-2f)
(at_two straight1 f1-2f f1-1f)
(at_two straight2 f8-2f f7-2f)
(at_two straight3 f2-3f f2-2f)
(at_two straight4 f8-0f f8-1f)
(at_two straight5 f5-1f f6-1f)
(at_two straight6 f9-1f f9-2f)
(at_two straight7 f1-0f f2-0f)
(at_two straight8 f4-1f f4-0f)
(at_two straight9 f10-0f f9-0f)
(at_two straight10 f5-0f f6-0f)
(at_two straight11 f10-3f f10-2f)
(at_two straight12 f0-2f f0-3f)
(at_two straight13 f0-0f f0-1f)
(at_two straight14 f3-2f f4-2f)
(at_two straight15 f7-1f f7-0f)
(at_two straight16 f4-3f f3-3f)
 )
(:goal
(and
(clear f0-0f)
