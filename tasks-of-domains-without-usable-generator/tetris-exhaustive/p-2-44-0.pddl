(define (problem Tetris-44-2-1174477)
(:domain tetris)
(:objects  
...
(at_two straight18 f22-3f f23-3f)
(at_two straight19 f14-3f f15-3f)
(at_two straight20 f2-2f f1-2f)
(at_two straight21 f4-1f f3-1f)
(at_two straight22 f20-1f f19-1f)
(at_two straight23 f6-0f f5-0f)
(at_two straight24 f19-0f f20-0f)
 )
(:goal
(and
(clear f0-0f)
