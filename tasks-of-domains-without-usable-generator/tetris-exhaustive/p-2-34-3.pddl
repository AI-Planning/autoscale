(define (problem Tetris-34-2-7166249)
(:domain tetris)
(:objects  
...
(clear f33-2f)
(clear f33-3f)
(at_two straight0 f17-1f f18-1f)
...
(at_two straight11 f11-3f f11-2f)
(at_two straight12 f8-1f f9-1f)
(at_two straight13 f8-2f f7-2f)
(at_two straight14 f2-3f f2-2f)
(at_two straight15 f4-0f f5-0f)
 )
(:goal
(and
(clear f0-0f)
