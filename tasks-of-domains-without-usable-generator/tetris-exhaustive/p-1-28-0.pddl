(define (problem Tetris-28-1-836461)
(:domain tetris)
(:objects  
...
(at_square square2 f8-3f)
(at_square square3 f6-2f)
(at_square square4 f7-2f)
(at_square square5 f9-1f)
(at_square square6 f8-1f)
(at_square square7 f4-1f)
(at_square square8 f12-0f)
(at_square square9 f9-2f)
(at_square square10 f14-1f)
(at_square square11 f4-0f)
(at_square square12 f11-0f)
(at_square square13 f14-2f)
(at_square square14 f7-0f)
(at_square square15 f5-3f)
(at_square square16 f5-1f)
(at_square square17 f0-0f)
(at_square square18 f1-3f)
(at_square square19 f9-3f)
(at_square square20 f13-2f)
(at_square square21 f3-2f)
(at_square square22 f3-1f)
(at_square square23 f12-3f)
(at_square square24 f1-0f)
(at_square square25 f1-2f)
(at_square square26 f8-2f)
(at_square square27 f13-1f)
(at_square square28 f12-2f)
(at_square square29 f1-1f)
(at_square square30 f14-0f)
(at_square square31 f13-0f)
(at_square square32 f14-3f)
(at_square square33 f7-3f)
(at_square square34 f10-2f)
(at_square square35 f9-0f)
(at_square square36 f3-0f)
(at_square square37 f11-2f)
(at_square square38 f10-1f)
(at_square square39 f6-0f)
(at_square square40 f5-0f)
(at_square square41 f7-1f)
(at_square square42 f2-0f)
(at_square square43 f11-3f)
(at_square square44 f11-1f)
(at_square square45 f12-1f)
(at_square square46 f5-2f)
(at_square square47 f0-3f)
(at_square square48 f10-3f)
(at_square square49 f2-1f)
(at_square square50 f0-1f)
(at_square square51 f3-3f)
(at_square square52 f13-3f)
(at_square square53 f2-3f)
(at_square square54 f4-3f)
 )
(:goal
(and
(clear f0-0f)
