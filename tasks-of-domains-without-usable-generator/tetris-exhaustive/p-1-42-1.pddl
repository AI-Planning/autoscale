(define (problem Tetris-42-1-3670536)
(:domain tetris)
(:objects  
...
square0 square1 square2 square3 square4 square5 square6 square7 square8 square9 square10 square11 square12 square13 square14 square15 square16 square17 - one_square
nada- two_straight
nisba- right_l
)
(:init
...
(clear f41-2f)
(clear f41-3f)
(at_square square0 f18-0f)
(at_square square1 f8-0f)
(at_square square2 f15-3f)
(at_square square3 f6-0f)
(at_square square4 f15-0f)
(at_square square5 f12-3f)
(at_square square6 f19-0f)
(at_square square7 f14-2f)
(at_square square8 f7-0f)
(at_square square9 f10-0f)
(at_square square10 f0-0f)
(at_square square11 f20-0f)
(at_square square12 f12-1f)
(at_square square13 f13-0f)
(at_square square14 f16-1f)
(at_square square15 f14-3f)
(at_square square16 f17-1f)
(at_square square17 f11-1f)
 )
(:goal
(and
(clear f0-0f)
