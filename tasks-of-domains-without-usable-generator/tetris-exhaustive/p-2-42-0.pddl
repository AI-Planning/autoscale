(define (problem Tetris-42-2-9130755)
(:domain tetris)
(:objects  
...
(clear f41-2f)
(clear f41-3f)
(at_two straight0 f13-0f f14-0f)
(at_two straight1 f16-3f f16-2f)
(at_two straight2 f9-3f f10-3f)
(at_two straight3 f18-1f f18-2f)
(at_two straight4 f9-1f f8-1f)
(at_two straight5 f19-2f f19-3f)
(at_two straight6 f9-0f f8-0f)
(at_two straight7 f21-2f f21-1f)
(at_two straight8 f17-0f f18-0f)
(at_two straight9 f13-2f f13-3f)
(at_two straight10 f17-3f f17-2f)
(at_two straight11 f1-0f f0-0f)
(at_two straight12 f10-1f f11-1f)
(at_two straight13 f2-1f f2-2f)
(at_two straight14 f7-1f f7-0f)
(at_two straight15 f2-0f f3-0f)
(at_two straight16 f3-2f f4-2f)
(at_two straight17 f6-1f f5-1f)
(at_two straight18 f21-3f f22-3f)
(at_two straight19 f14-3f f15-3f)
(at_two straight20 f0-2f f0-3f)
(at_two straight21 f7-2f f7-3f)
(at_two straight22 f4-1f f3-1f)
(at_two straight23 f20-1f f19-1f)
(at_two straight24 f6-0f f5-0f)
 )
(:goal
(and
(clear f0-0f)
