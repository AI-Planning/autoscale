(define (problem Tetris-48-1-3542089)
(:domain tetris)
(:objects  
...
(at_square square11 f23-0f)
(at_square square12 f21-0f)
(at_square square13 f5-0f)
(at_square square14 f9-0f)
(at_square square15 f8-3f)
(at_square square16 f19-3f)
(at_square square17 f22-3f)
(at_square square18 f12-3f)
(at_square square19 f4-2f)
(at_square square20 f3-0f)
(at_square square21 f4-3f)
(at_square square22 f6-2f)
(at_square square23 f21-3f)
(at_square square24 f24-2f)
(at_square square25 f13-3f)
(at_square square26 f18-2f)
(at_square square27 f10-0f)
(at_square square28 f8-1f)
(at_square square29 f22-2f)
(at_square square30 f17-0f)
 )
(:goal
(and
(clear f0-0f)
