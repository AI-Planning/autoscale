(define (problem Tetris-24-1-7465677)
(:domain tetris)
(:objects  
...
square0 square1 square2 square3 square4 square5 square6 square7 square8 square9 square10 square11 square12 square13 square14 square15 square16 square17 square18 square19 square20 square21 square22 square23 square24 - one_square
nada- two_straight
nisba- right_l
)
(:init
...
(at_square square10 f4-0f)
(at_square square11 f11-0f)
(at_square square12 f10-2f)
(at_square square13 f7-0f)
(at_square square14 f5-3f)
(at_square square15 f5-1f)
(at_square square16 f0-0f)
(at_square square17 f1-3f)
(at_square square18 f9-3f)
(at_square square19 f11-2f)
(at_square square20 f3-1f)
(at_square square21 f1-0f)
(at_square square22 f1-2f)
(at_square square23 f8-2f)
(at_square square24 f12-2f)
 )
(:goal
(and
(clear f0-0f)
