(define (problem Tetris-48-4-2857985)
(:domain tetris)
(:objects  
...
straight0 straight1 straight2 straight3 straight4 straight5 straight6 straight7 straight8 straight9 straight10 straight11 straight12 straight13 straight14 straight15 - two_straight
...
(at_two straight2 f2-0f f3-0f)
(at_two straight3 f2-2f f3-2f)
(at_two straight4 f5-1f f6-1f)
(at_two straight5 f7-2f f8-2f)
(at_two straight6 f10-0f f11-0f)
(at_two straight7 f11-1f f12-1f)
(at_two straight8 f11-2f f12-2f)
(at_two straight9 f14-0f f15-0f)
(at_two straight10 f17-1f f18-1f)
(at_two straight11 f17-2f f18-2f)
(at_two straight12 f20-0f f21-0f)
(at_two straight13 f21-1f f22-1f)
(at_two straight14 f22-0f f23-0f)
(at_two straight15 f22-2f f23-2f)
(at_square square0 f1-0f)
(at_square square1 f2-1f)
(at_square square2 f4-0f)
(at_square square3 f5-0f)
(at_square square4 f6-0f)
(at_square square5 f7-0f)
(at_square square6 f7-1f)
(at_square square7 f9-2f)
(at_square square8 f10-1f)
(at_square square9 f13-2f)
(at_square square10 f15-2f)
(at_square square11 f16-0f)
(at_square square12 f17-0f)
(at_square square13 f20-1f)
(at_square square14 f21-2f)
(at_square square15 f23-1f)
 )
(:goal
(and
(clear f0-0f)
