(define (problem Tetris-30-2-5304572)
(:domain tetris)
(:objects  
...
(at_two straight8 f15-3f f16-3f)
(at_two straight9 f1-0f f0-0f)
(at_two straight10 f10-1f f11-1f)
(at_two straight11 f4-3f f3-3f)
(at_two straight12 f15-0f f16-0f)
(at_two straight13 f9-0f f10-0f)
(at_two straight14 f7-2f f7-3f)
(at_two straight15 f1-2f f1-1f)
(at_two straight16 f7-0f f8-0f)
(at_two straight17 f3-1f f4-1f)
(at_two straight18 f5-2f f5-1f)
(at_two straight19 f3-0f f2-0f)
(at_two straight20 f13-0f f14-0f)
(at_two straight21 f15-1f f15-2f)
(at_two straight22 f14-1f f13-1f)
(at_two straight23 f9-2f f9-1f)
(at_two straight24 f6-2f f6-3f)
(at_two straight25 f14-3f f14-2f)
(at_two straight26 f1-3f f2-3f)
(at_two straight27 f0-3f f0-2f)
 )
(:goal
(and
(clear f0-0f)
