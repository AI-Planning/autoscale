(define (problem Tetris-32-1-4209951)
(:domain tetris)
(:objects  
...
(at_square square7 f4-2f)
(at_square square8 f3-0f)
(at_square square9 f10-3f)
(at_square square10 f13-2f)
(at_square square11 f6-3f)
(at_square square12 f14-2f)
(at_square square13 f1-0f)
(at_square square14 f2-3f)
(at_square square15 f0-3f)
(at_square square16 f10-1f)
(at_square square17 f10-0f)
(at_square square18 f7-1f)
(at_square square19 f14-0f)
(at_square square20 f2-2f)
(at_square square21 f16-3f)
(at_square square22 f9-0f)
(at_square square23 f9-3f)
(at_square square24 f1-2f)
(at_square square25 f15-0f)
(at_square square26 f2-1f)
(at_square square27 f4-0f)
(at_square square28 f16-2f)
(at_square square29 f16-1f)
(at_square square30 f3-3f)
(at_square square31 f7-0f)
(at_square square32 f8-0f)
(at_square square33 f7-2f)
(at_square square34 f5-2f)
(at_square square35 f3-1f)
(at_square square36 f2-0f)
(at_square square37 f0-1f)
(at_square square38 f5-0f)
(at_square square39 f15-1f)
(at_square square40 f9-2f)
(at_square square41 f13-1f)
(at_square square42 f1-3f)
(at_square square43 f12-1f)
(at_square square44 f8-2f)
(at_square square45 f6-0f)
(at_square square46 f5-1f)
(at_square square47 f10-2f)
(at_square square48 f15-3f)
(at_square square49 f11-3f)
 )
(:goal
(and
(clear f0-0f)
