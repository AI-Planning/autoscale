(define (problem Tetris-38-1-7166249)
(:domain tetris)
(:objects  
...
(at_square square22 f13-2f)
(at_square square23 f18-2f)
(at_square square24 f10-0f)
(at_square square25 f8-1f)
(at_square square26 f2-3f)
(at_square square27 f15-0f)
(at_square square28 f11-0f)
(at_square square29 f13-1f)
(at_square square30 f0-2f)
 )
(:goal
(and
(clear f0-0f)
