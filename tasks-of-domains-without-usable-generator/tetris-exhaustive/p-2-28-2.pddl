(define (problem Tetris-28-2-2613362)
(:domain tetris)
(:objects  
...
(clear f27-2f)
(clear f27-3f)
(at_two straight0 f13-0f f12-0f)
(at_two straight1 f1-2f f1-3f)
(at_two straight2 f11-2f f12-2f)
(at_two straight3 f9-1f f8-1f)
(at_two straight4 f6-3f f7-3f)
(at_two straight5 f8-3f f9-3f)
(at_two straight6 f14-3f f14-2f)
(at_two straight7 f3-1f f2-1f)
(at_two straight8 f2-2f f2-3f)
(at_two straight9 f12-3f f13-3f)
(at_two straight10 f5-3f f5-2f)
(at_two straight11 f7-2f f7-1f)
(at_two straight12 f5-1f f6-1f)
(at_two straight13 f4-2f f4-1f)
(at_two straight14 f14-0f f15-0f)
(at_two straight15 f11-0f f11-1f)
(at_two straight16 f0-0f f1-0f)
(at_two straight17 f10-0f f10-1f)
(at_two straight18 f13-1f f12-1f)
(at_two straight19 f6-0f f5-0f)
(at_two straight20 f7-0f f8-0f)
(at_two straight21 f0-3f f0-2f)
(at_two straight22 f11-3f f10-3f)
(at_two straight23 f9-2f f10-2f)
(at_two straight24 f3-0f f2-0f)
(at_two straight25 f1-1f f0-1f)
(at_two straight26 f3-3f f3-2f)
(at_two straight27 f14-1f f15-1f)
 )
(:goal
(and
(clear f0-0f)
