(define (problem Tetris-22-2-648297)
(:domain tetris)
(:objects  
...
(clear f21-2f)
(clear f21-3f)
(at_two straight0 f6-0f f7-0f)
(at_two straight1 f8-3f f8-2f)
(at_two straight2 f4-3f f5-3f)
...
(at_two straight8 f11-3f f10-3f)
(at_two straight9 f3-2f f2-2f)
(at_two straight10 f11-0f f12-0f)
(at_two straight11 f0-2f f0-1f)
(at_two straight12 f10-1f f10-2f)
 )
(:goal
(and
(clear f0-0f)
