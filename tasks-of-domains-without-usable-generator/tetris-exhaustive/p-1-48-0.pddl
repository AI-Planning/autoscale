(define (problem Tetris-48-1-3704900)
(:domain tetris)
(:objects  
...
(at_square square26 f2-0f)
(at_square square27 f10-3f)
(at_square square28 f3-2f)
(at_square square29 f17-2f)
(at_square square30 f14-0f)
(at_square square31 f2-1f)
(at_square square32 f4-0f)
(at_square square33 f22-2f)
(at_square square34 f6-3f)
(at_square square35 f18-2f)
(at_square square36 f14-3f)
(at_square square37 f2-2f)
(at_square square38 f19-0f)
(at_square square39 f0-2f)
(at_square square40 f3-1f)
(at_square square41 f11-1f)
(at_square square42 f4-1f)
(at_square square43 f0-0f)
(at_square square44 f20-1f)
(at_square square45 f12-0f)
(at_square square46 f11-0f)
(at_square square47 f15-1f)
(at_square square48 f21-0f)
(at_square square49 f8-0f)
 )
(:goal
(and
(clear f0-0f)
