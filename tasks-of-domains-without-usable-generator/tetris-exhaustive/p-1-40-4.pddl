(define (problem Tetris-40-1-1033648)
(:domain tetris)
(:objects  
...
(at_square square14 f12-1f)
(at_square square15 f5-1f)
(at_square square16 f15-2f)
(at_square square17 f0-2f)
(at_square square18 f18-2f)
(at_square square19 f16-1f)
...
(at_square square27 f20-3f)
(at_square square28 f11-3f)
(at_square square29 f20-1f)
(at_square square30 f10-0f)
 )
(:goal
(and
(clear f0-0f)
