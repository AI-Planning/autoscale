(define (problem Tetris-50-1-610557)
(:domain tetris)
(:objects  
...
(clear f49-2f)
(clear f49-3f)
(at_square square0 f24-3f)
(at_square square1 f1-2f)
(at_square square2 f16-3f)
(at_square square3 f12-2f)
(at_square square4 f15-2f)
(at_square square5 f18-1f)
(at_square square6 f16-1f)
(at_square square7 f9-1f)
(at_square square8 f24-0f)
(at_square square9 f19-2f)
(at_square square10 f17-1f)
(at_square square11 f9-0f)
(at_square square12 f23-0f)
(at_square square13 f21-2f)
(at_square square14 f15-0f)
(at_square square15 f11-3f)
(at_square square16 f10-1f)
(at_square square17 f17-3f)
(at_square square18 f14-2f)
(at_square square19 f1-0f)
(at_square square20 f2-3f)
(at_square square21 f22-0f)
(at_square square22 f19-3f)
(at_square square23 f23-2f)
(at_square square24 f6-1f)
(at_square square25 f7-1f)
(at_square square26 f25-3f)
(at_square square27 f2-0f)
(at_square square28 f10-3f)
(at_square square29 f3-2f)
(at_square square30 f17-2f)
(at_square square31 f25-2f)
(at_square square32 f14-0f)
(at_square square33 f2-1f)
(at_square square34 f4-0f)
(at_square square35 f22-2f)
(at_square square36 f6-3f)
(at_square square37 f18-2f)
(at_square square38 f14-3f)
(at_square square39 f2-2f)
(at_square square40 f19-0f)
(at_square square41 f0-2f)
(at_square square42 f3-1f)
(at_square square43 f11-1f)
(at_square square44 f25-1f)
(at_square square45 f22-1f)
(at_square square46 f0-0f)
(at_square square47 f20-1f)
(at_square square48 f12-0f)
(at_square square49 f11-0f)
 )
(:goal
(and
(clear f0-0f)
