(define (problem Tetris-50-1-7710866)
(:domain tetris)
(:objects  
...
(at_square square3 f25-1f)
(at_square square4 f3-3f)
(at_square square5 f0-3f)
...
(at_square square14 f24-3f)
(at_square square15 f15-1f)
(at_square square16 f11-1f)
(at_square square17 f21-1f)
 )
(:goal
(and
(clear f0-0f)
