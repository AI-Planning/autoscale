(define (problem Tetris-48-1-4635625)
(:domain tetris)
(:objects  
...
(at_square square21 f24-1f)
(at_square square22 f13-3f)
(at_square square23 f19-2f)
(at_square square24 f1-0f)
(at_square square25 f1-3f)
