(define (problem Tetris-36-1-604195)
(:domain tetris)
(:objects  
...
(at_square square2 f18-0f)
(at_square square3 f0-3f)
(at_square square4 f8-1f)
(at_square square5 f6-3f)
(at_square square6 f17-3f)
(at_square square7 f12-1f)
(at_square square8 f7-1f)
(at_square square9 f16-3f)
(at_square square10 f0-0f)
(at_square square11 f5-0f)
(at_square square12 f9-0f)
(at_square square13 f8-3f)
(at_square square14 f12-3f)
(at_square square15 f4-2f)
(at_square square16 f3-0f)
(at_square square17 f4-3f)
(at_square square18 f6-2f)
(at_square square19 f13-2f)
(at_square square20 f13-3f)
(at_square square21 f18-2f)
(at_square square22 f10-0f)
(at_square square23 f2-3f)
(at_square square24 f15-0f)
(at_square square25 f11-0f)
(at_square square26 f13-1f)
(at_square square27 f0-2f)
(at_square square28 f1-3f)
(at_square square29 f17-2f)
(at_square square30 f16-1f)
 )
(:goal
(and
(clear f0-0f)
