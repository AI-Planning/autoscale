(define (problem Tetris-44-4-5231879)
(:domain tetris)
(:objects  
...
(at_square square5 f10-0f)
(at_square square6 f11-2f)
(at_square square7 f12-2f)
...
(at_square square14 f21-0f)
(at_square square15 f21-1f)
(at_square square16 f21-2f)
 )
(:goal
(and
(clear f0-0f)
