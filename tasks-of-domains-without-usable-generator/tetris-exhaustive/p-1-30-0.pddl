(define (problem Tetris-30-1-4697330)
(:domain tetris)
(:objects  
...
square0 square1 square2 square3 square4 square5 square6 square7 square8 square9 square10 square11 square12 square13 square14 square15 square16 square17 square18 square19 square20 square21 square22 square23 square24 square25 square26 square27 square28 square29 square30 square31 square32 square33 square34 square35 square36 square37 square38 square39 square40 square41 square42 square43 square44 square45 square46 square47 square48 square49 square50 square51 square52 square53 square54 - one_square
nada- two_straight
nisba- right_l
)
(:init
...
(clear f29-2f)
(clear f29-3f)
(at_square square0 f12-3f)
(at_square square1 f1-2f)
(at_square square2 f15-3f)
(at_square square3 f9-3f)
(at_square square4 f11-1f)
(at_square square5 f4-2f)
(at_square square6 f4-0f)
(at_square square7 f8-1f)
(at_square square8 f9-0f)
(at_square square9 f2-2f)
(at_square square10 f15-0f)
(at_square square11 f11-3f)
(at_square square12 f10-1f)
(at_square square13 f8-0f)
(at_square square14 f0-0f)
(at_square square15 f12-0f)
(at_square square16 f15-2f)
(at_square square17 f7-2f)
(at_square square18 f2-1f)
(at_square square19 f7-1f)
(at_square square20 f4-3f)
(at_square square21 f2-0f)
(at_square square22 f10-3f)
(at_square square23 f3-2f)
(at_square square24 f2-3f)
(at_square square25 f9-1f)
(at_square square26 f6-1f)
(at_square square27 f6-3f)
(at_square square28 f8-3f)
(at_square square29 f3-3f)
(at_square square30 f7-0f)
(at_square square31 f5-2f)
(at_square square32 f13-0f)
(at_square square33 f3-1f)
(at_square square34 f3-0f)
(at_square square35 f0-1f)
(at_square square36 f5-0f)
(at_square square37 f15-1f)
(at_square square38 f1-0f)
(at_square square39 f9-2f)
(at_square square40 f13-1f)
(at_square square41 f1-3f)
(at_square square42 f12-1f)
(at_square square43 f8-2f)
(at_square square44 f6-0f)
(at_square square45 f5-1f)
(at_square square46 f10-2f)
(at_square square47 f12-2f)
(at_square square48 f14-0f)
(at_square square49 f10-0f)
(at_square square50 f7-3f)
(at_square square51 f11-2f)
(at_square square52 f14-3f)
(at_square square53 f1-1f)
(at_square square54 f6-2f)
 )
(:goal
(and
(clear f0-0f)
