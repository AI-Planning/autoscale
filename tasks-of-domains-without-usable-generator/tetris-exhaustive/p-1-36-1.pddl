(define (problem Tetris-36-1-4861728)
(:domain tetris)
(:objects  
...
(at_square square10 f17-0f)
(at_square square11 f12-1f)
(at_square square12 f13-0f)
(at_square square13 f16-1f)
(at_square square14 f14-3f)
(at_square square15 f17-1f)
(at_square square16 f11-1f)
(at_square square17 f7-3f)
 )
(:goal
(and
(clear f0-0f)
