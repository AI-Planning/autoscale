(define (problem Tetris-32-2-8985510)
(:domain tetris)
(:objects  
...
(clear f31-2f)
(clear f31-3f)
(at_two straight0 f4-2f f4-1f)
(at_two straight1 f8-1f f8-2f)
(at_two straight2 f15-3f f15-2f)
(at_two straight3 f4-3f f3-3f)
(at_two straight4 f2-1f f1-1f)
(at_two straight5 f9-0f f10-0f)
(at_two straight6 f13-3f f13-2f)
(at_two straight7 f3-0f f3-1f)
(at_two straight8 f15-1f f16-1f)
(at_two straight9 f11-3f f11-2f)
(at_two straight10 f6-2f f7-2f)
(at_two straight11 f2-2f f1-2f)
(at_two straight12 f13-1f f12-1f)
(at_two straight13 f9-3f f9-2f)
(at_two straight14 f1-3f f2-3f)
(at_two straight15 f0-0f f0-1f)
 )
(:goal
(and
(clear f0-0f)
