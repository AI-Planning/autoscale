(define (problem Tetris-46-4-2509038)
(:domain tetris)
(:objects  
...
(at_right_l rightl9 f2-2f f3-2f f3-3f)
(at_right_l rightl10 f17-0f f18-0f f18-1f)
(at_right_l rightl11 f20-0f f21-0f f21-1f)
(at_right_l rightl12 f14-2f f15-2f f15-3f)
