(define (problem Tetris-32-1-121345)
(:domain tetris)
(:objects  
...
(at_square square1 f15-0f)
(at_square square2 f0-3f)
(at_square square3 f8-1f)
(at_square square4 f6-3f)
(at_square square5 f15-3f)
(at_square square6 f4-1f)
(at_square square7 f4-3f)
(at_square square8 f0-0f)
(at_square square9 f5-0f)
(at_square square10 f9-0f)
(at_square square11 f8-3f)
(at_square square12 f12-3f)
(at_square square13 f3-0f)
(at_square square14 f6-2f)
(at_square square15 f13-2f)
(at_square square16 f13-3f)
(at_square square17 f11-3f)
(at_square square18 f7-2f)
(at_square square19 f0-2f)
(at_square square20 f5-2f)
(at_square square21 f3-1f)
(at_square square22 f8-2f)
(at_square square23 f2-2f)
(at_square square24 f2-3f)
(at_square square25 f4-0f)
(at_square square26 f9-3f)
(at_square square27 f13-0f)
(at_square square28 f1-0f)
(at_square square29 f12-2f)
(at_square square30 f1-2f)
 )
(:goal
(and
(clear f0-0f)
