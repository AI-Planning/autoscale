(define (problem Tetris-46-1-5050974)
(:domain tetris)
(:objects  
...
(at_square square10 f23-0f)
(at_square square11 f21-2f)
(at_square square12 f15-0f)
(at_square square13 f11-3f)
(at_square square14 f10-1f)
(at_square square15 f17-3f)
(at_square square16 f14-2f)
(at_square square17 f1-0f)
(at_square square18 f2-3f)
(at_square square19 f22-0f)
(at_square square20 f19-3f)
(at_square square21 f23-2f)
(at_square square22 f6-1f)
(at_square square23 f7-1f)
(at_square square24 f2-0f)
(at_square square25 f10-3f)
(at_square square26 f17-2f)
(at_square square27 f19-2f)
(at_square square28 f14-0f)
(at_square square29 f1-2f)
(at_square square30 f2-1f)
(at_square square31 f4-0f)
(at_square square32 f22-2f)
(at_square square33 f6-3f)
(at_square square34 f18-2f)
(at_square square35 f14-3f)
(at_square square36 f2-2f)
(at_square square37 f19-0f)
(at_square square38 f0-2f)
(at_square square39 f3-1f)
(at_square square40 f11-1f)
(at_square square41 f4-1f)
(at_square square42 f0-0f)
(at_square square43 f20-1f)
(at_square square44 f12-0f)
(at_square square45 f11-0f)
(at_square square46 f15-1f)
(at_square square47 f21-0f)
