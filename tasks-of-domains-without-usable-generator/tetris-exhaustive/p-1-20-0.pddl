(define (problem Tetris-20-1-1346343)
(:domain tetris)
(:objects  
...
(at_square square15 f10-0f)
(at_square square16 f9-3f)
(at_square square17 f5-0f)
(at_square square18 f3-1f)
(at_square square19 f1-0f)
(at_square square20 f8-2f)
(at_square square21 f9-2f)
