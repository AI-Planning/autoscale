(define (problem Tetris-30-2-2047392)
(:domain tetris)
(:objects  
...
(clear f29-2f)
(clear f29-3f)
(at_two straight0 f1-0f f0-0f)
(at_two straight1 f11-1f f12-1f)
(at_two straight2 f8-1f f7-1f)
(at_two straight3 f5-3f f5-2f)
(at_two straight4 f11-3f f12-3f)
(at_two straight5 f10-3f f10-2f)
(at_two straight6 f14-3f f15-3f)
(at_two straight7 f14-1f f14-0f)
(at_two straight8 f8-3f f9-3f)
(at_two straight9 f15-1f f16-1f)
(at_two straight10 f15-2f f16-2f)
(at_two straight11 f13-2f f13-3f)
(at_two straight12 f2-2f f1-2f)
(at_two straight13 f6-0f f5-0f)
(at_two straight14 f13-0f f12-0f)
(at_two straight15 f3-0f f2-0f)
(at_two straight16 f5-1f f4-1f)
(at_two straight17 f0-2f f0-1f)
(at_two straight18 f2-1f f1-1f)
(at_two straight19 f3-3f f4-3f)
(at_two straight20 f11-2f f12-2f)
(at_two straight21 f9-0f f10-0f)
(at_two straight22 f7-3f f7-2f)
(at_two straight23 f3-2f f3-1f)
(at_two straight24 f9-2f f9-1f)
(at_two straight25 f6-3f f6-2f)
(at_two straight26 f8-0f f7-0f)
(at_two straight27 f1-3f f2-3f)
 )
(:goal
(and
(clear f0-0f)
