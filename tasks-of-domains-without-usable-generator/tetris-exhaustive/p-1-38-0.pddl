(define (problem Tetris-38-1-660665)
(:domain tetris)
(:objects  
...
(at_square square25 f19-2f)
(at_square square26 f14-0f)
(at_square square27 f19-3f)
...
(at_square square35 f11-0f)
(at_square square36 f0-2f)
(at_square square37 f3-1f)
(at_square square38 f11-1f)
(at_square square39 f4-1f)
(at_square square40 f0-0f)
(at_square square41 f6-0f)
(at_square square42 f12-0f)
(at_square square43 f3-3f)
(at_square square44 f19-0f)
(at_square square45 f8-0f)
(at_square square46 f7-0f)
(at_square square47 f9-2f)
(at_square square48 f13-1f)
(at_square square49 f1-3f)
 )
(:goal
(and
(clear f0-0f)
