(define (problem Tetris-42-1-1117564)
(:domain tetris)
(:objects  
...
f41-0f f41-1f f41-2f f41-3f - position
square0 square1 square2 square3 square4 square5 square6 square7 square8 square9 square10 square11 square12 square13 square14 square15 square16 square17 square18 square19 square20 square21 square22 square23 square24 square25 square26 square27 square28 square29 square30 - one_square
nada- two_straight
nisba- right_l
)
(:init
...
(clear f41-2f)
(clear f41-3f)
(at_square square0 f18-1f)
(at_square square1 f11-3f)
(at_square square2 f20-0f)
(at_square square3 f19-0f)
(at_square square4 f15-2f)
(at_square square5 f17-1f)
(at_square square6 f6-3f)
(at_square square7 f17-3f)
(at_square square8 f12-1f)
(at_square square9 f7-1f)
(at_square square10 f16-3f)
(at_square square11 f0-0f)
(at_square square12 f5-0f)
(at_square square13 f9-0f)
(at_square square14 f8-3f)
(at_square square15 f19-3f)
(at_square square16 f13-3f)
(at_square square17 f18-3f)
(at_square square18 f4-2f)
(at_square square19 f3-0f)
(at_square square20 f4-3f)
(at_square square21 f6-2f)
(at_square square22 f21-3f)
(at_square square23 f20-2f)
(at_square square24 f18-2f)
(at_square square25 f10-0f)
(at_square square26 f8-1f)
(at_square square27 f20-1f)
(at_square square28 f2-3f)
(at_square square29 f20-3f)
(at_square square30 f2-2f)
 )
(:goal
(and
(clear f0-0f)
