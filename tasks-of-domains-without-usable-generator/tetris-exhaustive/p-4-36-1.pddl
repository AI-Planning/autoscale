(define (problem Tetris-36-4-1450685)
(:domain tetris)
(:objects  
...
(at_square square8 f11-0f)
(at_square square9 f12-2f)
(at_square square10 f14-0f)
(at_square square11 f17-0f)
(at_square square12 f17-2f)
 )
(:goal
(and
(clear f0-0f)
