(define (problem Tetris-14-1-7042329)
(:domain tetris)
(:objects  
...
square0 square1 square2 square3 square4 square5 square6 square7 square8 square9 square10 square11 square12 square13 square14 square15 square16 square17 square18 square19 square20 square21 square22 square23 square24 square25 square26 square27 - one_square
nada- two_straight
nisba- right_l
)
(:init
...
(at_square square4 f0-1f)
(at_square square5 f6-3f)
(at_square square6 f5-3f)
(at_square square7 f4-0f)
(at_square square8 f0-2f)
(at_square square9 f7-2f)
(at_square square10 f2-1f)
(at_square square11 f3-1f)
(at_square square12 f5-1f)
(at_square square13 f2-3f)
(at_square square14 f6-2f)
(at_square square15 f5-2f)
(at_square square16 f7-1f)
(at_square square17 f3-3f)
(at_square square18 f4-3f)
(at_square square19 f7-3f)
(at_square square20 f3-2f)
(at_square square21 f1-0f)
(at_square square22 f3-0f)
(at_square square23 f0-3f)
(at_square square24 f2-0f)
(at_square square25 f7-0f)
