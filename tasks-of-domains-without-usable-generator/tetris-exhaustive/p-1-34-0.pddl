(define (problem Tetris-34-1-2220368)
(:domain tetris)
(:objects  
...
(at_square square6 f3-2f)
(at_square square7 f17-1f)
...
(at_square square13 f17-3f)
(at_square square14 f14-2f)
(at_square square15 f1-0f)
(at_square square16 f2-3f)
(at_square square17 f0-3f)
(at_square square18 f10-0f)
(at_square square19 f7-1f)
(at_square square20 f2-0f)
(at_square square21 f10-3f)
(at_square square22 f17-2f)
(at_square square23 f14-0f)
(at_square square24 f7-2f)
(at_square square25 f5-1f)
(at_square square26 f5-0f)
(at_square square27 f4-1f)
(at_square square28 f16-2f)
(at_square square29 f16-1f)
(at_square square30 f6-3f)
(at_square square31 f3-3f)
(at_square square32 f7-0f)
(at_square square33 f8-0f)
(at_square square34 f5-2f)
(at_square square35 f3-1f)
(at_square square36 f17-0f)
(at_square square37 f0-0f)
(at_square square38 f6-0f)
(at_square square39 f12-0f)
(at_square square40 f11-0f)
(at_square square41 f2-1f)
(at_square square42 f16-3f)
(at_square square43 f12-1f)
(at_square square44 f8-2f)
(at_square square45 f15-1f)
(at_square square46 f10-2f)
(at_square square47 f15-3f)
(at_square square48 f8-1f)
(at_square square49 f9-2f)
 )
(:goal
(and
(clear f0-0f)
