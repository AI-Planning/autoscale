(define (problem Tetris-28-1-7162778)
(:domain tetris)
(:objects  
...
(at_square square2 f10-0f)
(at_square square3 f9-0f)
(at_square square4 f14-3f)
(at_square square5 f4-1f)
(at_square square6 f3-3f)
(at_square square7 f8-3f)
(at_square square8 f6-1f)
(at_square square9 f3-1f)
(at_square square10 f13-3f)
(at_square square11 f11-0f)
(at_square square12 f2-0f)
(at_square square13 f4-0f)
(at_square square14 f13-2f)
(at_square square15 f7-3f)
 )
(:goal
(and
(clear f0-0f)
