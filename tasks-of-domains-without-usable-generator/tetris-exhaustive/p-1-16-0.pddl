(define (problem Tetris-16-1-7149294)
(:domain tetris)
(:objects  
...
(at_square square4 f3-1f)
(at_square square5 f4-1f)
(at_square square6 f1-2f)
...
(at_square square18 f8-2f)
(at_square square19 f3-2f)
(at_square square20 f2-1f)
(at_square square21 f2-0f)
(at_square square22 f3-3f)
(at_square square23 f3-0f)
(at_square square24 f2-2f)
 )
(:goal
(and
(clear f0-0f)
