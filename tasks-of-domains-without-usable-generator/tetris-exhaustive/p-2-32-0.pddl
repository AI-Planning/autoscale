(define (problem Tetris-32-2-1994876)
(:domain tetris)
(:objects  
...
(at_two straight5 f4-2f f3-2f)
(at_two straight6 f2-2f f2-1f)
(at_two straight7 f13-2f f13-3f)
(at_two straight8 f1-0f f0-0f)
(at_two straight9 f10-1f f11-1f)
(at_two straight10 f4-3f f3-3f)
(at_two straight11 f9-0f f10-0f)
(at_two straight12 f7-2f f7-3f)
(at_two straight13 f1-2f f1-1f)
(at_two straight14 f14-3f f15-3f)
(at_two straight15 f7-0f f8-0f)
(at_two straight16 f3-1f f4-1f)
(at_two straight17 f5-2f f5-1f)
(at_two straight18 f3-0f f2-0f)
(at_two straight19 f9-2f f9-1f)
(at_two straight20 f12-1f f13-1f)
(at_two straight21 f11-3f f11-2f)
(at_two straight22 f8-1f f8-2f)
(at_two straight23 f0-3f f0-2f)
(at_two straight24 f16-0f f16-1f)
 )
(:goal
(and
(clear f0-0f)
