(define (problem Tetris-44-1-8449618)
(:domain tetris)
(:objects  
...
(at_square square46 f8-0f)
(at_square square47 f7-0f)
(at_square square48 f20-2f)
(at_square square49 f5-0f)
 )
(:goal
(and
(clear f0-0f)
