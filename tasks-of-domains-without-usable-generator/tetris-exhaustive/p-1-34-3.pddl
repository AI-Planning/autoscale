(define (problem Tetris-34-1-604195)
(:domain tetris)
(:objects  
...
(clear f33-2f)
(clear f33-3f)
(at_square square0 f17-1f)
(at_square square1 f11-3f)
(at_square square2 f2-0f)
(at_square square3 f15-2f)
(at_square square4 f6-3f)
(at_square square5 f17-3f)
(at_square square6 f12-1f)
(at_square square7 f7-1f)
(at_square square8 f16-3f)
(at_square square9 f0-0f)
(at_square square10 f5-0f)
(at_square square11 f9-0f)
(at_square square12 f8-3f)
(at_square square13 f12-3f)
(at_square square14 f4-2f)
(at_square square15 f3-0f)
(at_square square16 f4-3f)
(at_square square17 f6-2f)
(at_square square18 f13-2f)
(at_square square19 f13-3f)
(at_square square20 f7-2f)
(at_square square21 f0-2f)
(at_square square22 f5-2f)
(at_square square23 f17-0f)
(at_square square24 f2-3f)
(at_square square25 f15-0f)
(at_square square26 f11-0f)
(at_square square27 f13-1f)
(at_square square28 f1-3f)
(at_square square29 f10-2f)
