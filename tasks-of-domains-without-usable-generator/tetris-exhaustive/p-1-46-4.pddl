(define (problem Tetris-46-1-5379931)
(:domain tetris)
(:objects  
...
(at_square square6 f1-1f)
(at_square square7 f16-2f)
(at_square square8 f8-1f)
(at_square square9 f3-2f)
(at_square square10 f6-0f)
(at_square square11 f20-2f)
(at_square square12 f5-2f)
(at_square square13 f9-2f)
(at_square square14 f2-2f)
(at_square square15 f21-3f)
(at_square square16 f16-1f)
(at_square square17 f5-1f)
(at_square square18 f15-2f)
(at_square square19 f0-2f)
(at_square square20 f18-2f)
(at_square square21 f13-3f)
(at_square square22 f19-2f)
(at_square square23 f1-0f)
(at_square square24 f1-3f)
(at_square square25 f16-3f)
(at_square square26 f22-2f)
(at_square square27 f4-1f)
(at_square square28 f2-3f)
(at_square square29 f6-3f)
(at_square square30 f11-3f)
 )
(:goal
(and
(clear f0-0f)
