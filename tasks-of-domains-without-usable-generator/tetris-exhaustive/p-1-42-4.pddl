(define (problem Tetris-42-1-5428003)
(:domain tetris)
(:objects  
...
(clear f41-2f)
(clear f41-3f)
(at_square square0 f9-0f)
(at_square square1 f12-3f)
(at_square square2 f4-0f)
(at_square square3 f2-0f)
(at_square square4 f12-2f)
(at_square square5 f1-1f)
(at_square square6 f16-2f)
(at_square square7 f8-1f)
(at_square square8 f3-2f)
(at_square square9 f6-0f)
(at_square square10 f20-2f)
(at_square square11 f5-2f)
(at_square square12 f9-2f)
(at_square square13 f2-2f)
(at_square square14 f21-3f)
(at_square square15 f16-1f)
(at_square square16 f5-1f)
(at_square square17 f15-2f)
(at_square square18 f0-2f)
(at_square square19 f18-2f)
(at_square square20 f13-3f)
(at_square square21 f19-2f)
(at_square square22 f1-0f)
(at_square square23 f1-3f)
(at_square square24 f16-3f)
(at_square square25 f10-1f)
(at_square square26 f21-1f)
(at_square square27 f2-3f)
(at_square square28 f6-3f)
(at_square square29 f11-3f)
(at_square square30 f20-1f)
 )
(:goal
(and
(clear f0-0f)
