(define (problem Tetris-38-1-9370561)
(:domain tetris)
(:objects  
...
(at_square square14 f19-2f)
(at_square square15 f12-1f)
...
(at_square square21 f16-1f)
(at_square square22 f13-3f)
(at_square square23 f1-0f)
(at_square square24 f1-3f)
(at_square square25 f8-3f)
(at_square square26 f10-1f)
(at_square square27 f13-1f)
(at_square square28 f14-2f)
(at_square square29 f5-2f)
(at_square square30 f13-2f)
 )
(:goal
(and
(clear f0-0f)
