(define (problem Tetris-36-1-7313596)
(:domain tetris)
(:objects  
...
(at_square square11 f6-1f)
(at_square square12 f9-2f)
(at_square square13 f11-0f)
(at_square square14 f10-3f)
(at_square square15 f16-1f)
(at_square square16 f5-1f)
(at_square square17 f15-2f)
(at_square square18 f2-2f)
(at_square square19 f0-2f)
(at_square square20 f18-2f)
(at_square square21 f13-3f)
(at_square square22 f9-3f)
(at_square square23 f14-1f)
(at_square square24 f7-2f)
(at_square square25 f8-0f)
(at_square square26 f14-2f)
(at_square square27 f16-3f)
(at_square square28 f10-1f)
(at_square square29 f13-1f)
(at_square square30 f5-2f)
 )
(:goal
(and
(clear f0-0f)
