(define (problem Tetris-22-1-2509038)
(:domain tetris)
(:objects  
...
(clear f21-2f)
(clear f21-3f)
(at_square square0 f6-0f)
(at_square square1 f4-3f)
(at_square square2 f6-2f)
(at_square square3 f7-2f)
(at_square square4 f9-1f)
(at_square square5 f8-1f)
(at_square square6 f4-1f)
(at_square square7 f1-2f)
(at_square square8 f4-0f)
(at_square square9 f11-0f)
(at_square square10 f10-2f)
(at_square square11 f7-0f)
(at_square square12 f5-3f)
(at_square square13 f5-1f)
(at_square square14 f8-3f)
(at_square square15 f0-0f)
(at_square square16 f1-3f)
(at_square square17 f9-3f)
(at_square square18 f11-2f)
(at_square square19 f3-1f)
(at_square square20 f1-0f)
(at_square square21 f8-2f)
(at_square square22 f9-2f)
(at_square square23 f0-2f)
(at_square square24 f1-1f)
 )
(:goal
(and
(clear f0-0f)
