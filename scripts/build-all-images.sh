...
./build-image.sh ../planners/ipc2018-opt-decstar/Singularity-fork ${OUTDIR}/ipc2018-opt-decstar-fork.img || true # this does *not* run any fallback search
./build-image.sh ../planners/ipc2018-opt-decstar/Singularity-star ${OUTDIR}/ipc2018-opt-decstar-star.img || true # this does *not* run any fallback search
...
# Evaluation SAT/AGL
./build-image.sh ../planners/ipc2018-agl-decstar/Singularity-fork ${OUTDIR}/ipc2018-agl-decstar-fork.img || true # this does *not* run any fallback search
...
./build-image.sh ../planners/ipc2018-agl-saarplan/Singularity-fork ${OUTDIR}/ipc2018-agl-saarplan-fork.img || true # this does *not* run any fallback search
